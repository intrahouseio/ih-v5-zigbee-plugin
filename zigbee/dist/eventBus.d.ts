...
export default class EventBus {
    ...
    emitDeviceRenamed(data: eventdata.DeviceRenamed): void;
    onDeviceRenamed(key: ListenerKey, callback: (data: eventdata.DeviceRenamed) => void): void;
    ...
    emitReportingDisabled(data: eventdata.ReportingDisabled): void;
    onReportingDisabled(key: ListenerKey, callback: (data: eventdata.ReportingDisabled) => void): void;
