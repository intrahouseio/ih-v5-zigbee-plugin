...
exports.elko_thermostat = {
    ...
    convert: (model, msg, publish, options, meta) => {
        ...
        if (data.localTemp !== undefined) {
            let value = (0, utils_1.precisionRound)(msg.data.localTemp, 2) / 100;
...
// biome-ignore lint/style/useNamingConvention: ignored using `--suppress`
exports._8840100H_water_leak_alarm = {
...
exports.smartthings_acceleration = {
...
exports.hue_smart_button_event = {
...
exports.legrand_scenes = {
    ...
    type: "commandRecall",
    convert: (model, msg, publish, options, meta) => {
        const lookup = { 65527: "enter", 65526: "leave", 65524: "sleep", 65525: "wakeup" };
        return { action: lookup[msg.data.groupid] ? lookup[msg.data.groupid] : "default" };
    },
};
exports.legrand_master_switch_center = {
...
exports.legrand_pilot_wire_mode = {
...
exports.sihas_people_cnt = {
    ...
    convert: (model, msg, publish, options, meta) => {
        ...
        const value = (0, utils_1.precisionRound)(Number.parseFloat(msg.data.presentValue), 1);
...
exports.ignore_zclversion_read = {
    cluster: "genBasic",
    type: "read",
    convert: (model, msg, publish, options, meta) => { },
};
exports.ignore_time_read = {
    cluster: "genTime",
    type: "read",
    convert: (model, msg, publish, options, meta) => { },
};
...
exports.command_on_presence = {
    ...
    type: "commandOn",
    convert: (model, msg, publish, options, meta) => {
        const payload1 = exports.checkin_presence.convert(model, msg, publish, options, meta);
...
exports.ias_ace_occupancy_with_timeout = {
    ...
    convert: (model, msg, publish, options, meta) => {
        ...
        return exports.occupancy_with_timeout.convert(model, msg, publish, options, meta);
    },
};
// biome-ignore lint/style/useNamingConvention: ignored using `--suppress`
exports.SP600_power = {
...
exports.terncy_raw = {
    ...
    convert: (model, msg, publish, options, meta) => {
        ...
        if (msg.data[4] === 0) {
            ...
            if (sidelookup[value]) {
                msg.data.occupancy = 1;
                const payload = exports.occupancy_with_timeout.convert(model, msg, publish, options, meta);
                if (payload) {
