...
exports.valueConverter = {
    ...
    PO_BOCO_ELEC_holiday: {
        to: (v) => {
            ...
            const startDate = new Date(Number.parseInt(startYear), Number.parseInt(startMonth) - 1, Number.parseInt(startDay), Number.parseInt(startHours), Number.parseInt(startMinutes));
            const endDate = new Date(Number.parseInt(endYear), Number.parseInt(endMonth) - 1, Number.parseInt(endDay), Number.parseInt(endHours), Number.parseInt(startMinutes));
            ...
            payload.push(Number.parseInt(startYear.slice(2)), Number.parseInt(startMonth), Number.parseInt(startDay), Number.parseInt(startHours), Number.parseInt(startMinutes), modeMapping[mode], 0, diffHours);
            return payload;
        },
        from: (v) => {
            ...
            const endDate = new Date(Number.parseInt(startYear), Number.parseInt(startMonth) - 1, Number.parseInt(startDay), Number.parseInt(startHours), Number.parseInt(startMinutes));
