...
const philipsModernExtend = {
    addCustomClusterManuSpecificPhilipsContact: () => modernExtend.deviceAddCustomCluster("manuSpecificPhilipsContact", {
        ...
        attributes: {
            contact: { ID: 0x0100, type: zigbee_herdsman_1.Zcl.DataType.ENUM8 },
            contactLastChange: { ID: 0x0101, type: zigbee_herdsman_1.Zcl.DataType.UINT32 },
            tamper: { ID: 0x0102, type: zigbee_herdsman_1.Zcl.DataType.ENUM8 },
            tamperLastChange: { ID: 0x0103, type: zigbee_herdsman_1.Zcl.DataType.UINT32 },
        },
        commands: {},
        commandsResponse: {},
    }),
...
const philipsTz = {
    ...
    effect: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            if (Object.keys(exports.hueEffects).includes(value.toLowerCase())) {
                await entity.command("manuSpecificPhilips2", "multiColor", { data: Buffer.from(utils.getFromLookup(value, exports.hueEffects), "hex") });
            }
            else {
