...
exports.definitions = [
    ...
    },
    {
        ...
        exposes: [
            ...
            e
                ...
                .withDescription('Most recent region event. Event template is "region_<REGION_ID>_<EVENT_TYPE>", ' +
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint) => {
            ...
            try {
                ...
                logger_1.logger.warning(`SP-EUC01 failed to setup electricity measurements (${e.message})`, NS);
                logger_1.logger.debug(`${e.stack}`, NS);
            }
            try {
                ...
                logger_1.logger.warning(`SP-EUC01 failed to setup metering (${e.message})`, NS);
                logger_1.logger.debug(`${e.stack}`, NS);
            }
        },
    ...
    },
    {
        ...
        exposes: [
            ...
            e
                ...
                .withDescription("The buzzer can be muted and alarmed manually. " +
            ...
            e
                ...
                .withDescription("When this option is enabled and a gas " +
            ...
            e
                ...
                .withDescription('"Preparation" or "work" ' +
    ...
    },
    {
        ...
        exposes: [
            ...
            e
                .enum("click_mode", ea.ALL, ["fast", "multi"])
                .withDescription("Click mode, fast: only supports single click which will be send immediately after clicking, multi: supports more events like double and hold"),
        ],
        fromZigbee: [lumi.fromZigbee.lumi_action_multistate, lumi.fromZigbee.lumi_specific],
        toZigbee: [lumi.toZigbee.lumi_switch_click_mode],
        configure: async (device, coordinatorEndpoint) => {
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint) => {
            ...
            device.save();
            const endpoint = device.getEndpoint(1);
            await endpoint.write("manuSpecificLumi", { mode: 1 }, { manufacturerCode: manufacturerCode, disableDefaultResponse: true, disableResponse: true });
    ...
    },
    {
        ...
        extend: [
            ...
            m.numeric({
                ...
                unit: "sec",
                cluster: "manuSpecificLumi",
                attribute: { ID: 0x0162, type: zigbee_herdsman_1.Zcl.DataType.UINT32 },
