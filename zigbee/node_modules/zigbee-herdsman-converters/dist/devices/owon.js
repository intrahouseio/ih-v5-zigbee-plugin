    ...
    },
    {
        ...
        extend: [
            m.deviceAddCustomCluster("fallDetectionOwon", {
                ...
                attributes: {
                    status: { ID: 0x0000, type: zigbee_herdsman_1.Zcl.DataType.ENUM8 },
                    breathing_rate: { ID: 0x0002, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                    location_x: { ID: 0x0003, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                    location_y: { ID: 0x0004, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                    bedUpperLeftX: { ID: 0x0100, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                    bedUpperLeftY: { ID: 0x0101, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                    bedLowerRightX: { ID: 0x0102, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                    bedLowerRightY: { ID: 0x0103, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                    doorCenterX: { ID: 0x0108, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                    doorCenterY: { ID: 0x0109, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
                    leftFallDetectionRange: { ID: 0x010c, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
                    rightFallDetectionRange: { ID: 0x010d, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
                    frontFallDetectionRange: { ID: 0x010e, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
                },
                commands: {},
                commandsResponse: {},
            }),
