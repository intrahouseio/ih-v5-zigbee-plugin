    ...
    },
    {
        ...
        extend: [
            m.deviceAddCustomCluster("RadarSensorHeiman", {
                ...
                attributes: {
                    enable_indicator: { ID: 0xf001, type: zigbee_herdsman_1.Zcl.DataType.UINT8 }, // 0: off, 1: enable
                    sensitivity: { ID: 0xf002, type: zigbee_herdsman_1.Zcl.DataType.UINT8 }, // 0: Off, 1: Low sensitivity, 2: High sensitivity
                    enable_sub_region_isolation: { ID: 0xf006, type: zigbee_herdsman_1.Zcl.DataType.UINT8 }, // 0: Disable, 1: Enable
                    installation_method: { ID: 0xf007, type: zigbee_herdsman_1.Zcl.DataType.UINT8 }, // 0: Wall-mounted, 1: Ceiling, 2: Rotate ceiling 45°
                    cell_mounted_table: {
                        ID: 0xf008,
