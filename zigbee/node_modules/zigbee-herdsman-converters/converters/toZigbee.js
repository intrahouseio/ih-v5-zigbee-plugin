...
const manufacturerOptions = {
    sunricher: { manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.SHENZHEN_SUNRICH },
    xiaomi: { manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.LUMI_UNITED_TECH, disableDefaultResponse: true },
    osram: { manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.OSRAM },
    eurotronic: { manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.JENNIC },
    danfoss: { manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.DANFOSS },
    hue: { manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.PHILIPS },
    ikea: { manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.IKEA_OF_SWEDEN },
    sinope: { manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.SINOPE_TECH },
    tint: { manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.MUELLER_LICHT_INT },
    legrand: { manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.VANTAGE, disableDefaultResponse: true },
    viessmann: { manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.VIESSMAN_ELEKTRO },
...
const converters2 = {
    ...
    LS21001_alert_behaviour: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            await entity.write('genBasic', { 0x400a: { value: utils.getFromLookup(value, lookup), type: 32 } }, { manufacturerCode: 0x1168, disableDefaultResponse: true, sendWhen: 'active' });
    ...
    xiaomi_switch_operation_mode_opple: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            await entity.write('aqaraOpple', { 0x0200: { value: utils.getFromLookup(targetValue, lookupState), type: 0x20 } }, manufacturerOptions.xiaomi);
        },
        convertGet: async (entity, key, meta) => {
            await entity.read('aqaraOpple', [0x0200], manufacturerOptions.xiaomi);
        },
    ...
    EMIZB_132_mode: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            await endpoint.write('seMetering', { 0x0302: { value: utils.getFromLookup(value, lookup).value, type: 49 } }, { manufacturerCode: 0x1015 });
    ...
    ZM35HQ_attr: {
        ...
        convertSet: async (entity, key, value, meta) => {
            switch (key) {
                case 'sensitivity':
                    await entity.write('ssIasZone', { currentZoneSensitivityLevel: utils.getFromLookup(value, { 'low': 0, 'medium': 1, 'high': 2 }) }, { sendWhen: 'active' });
                    break;
                case 'keep_time':
                    await entity.write('ssIasZone', { 61441: { value: utils.getFromLookup(value, { 30: 0, 60: 1, 120: 2 }), type: 0x20 } }, { sendWhen: 'active' });
                    break;
                default: // Unknown key
                    throw new Error(`Unhandled key ${key}`);
            }
    ...
    idlock_service_mode: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            await entity.write('closuresDoorLock', { 0x4003: { value: utils.getFromLookup(value, lookup), type: 0x20 } }, { manufacturerCode: 4919 });
    ...
    idlock_lock_mode: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            await entity.write('closuresDoorLock', { 0x4004: { value: utils.getFromLookup(value, lookup), type: 0x20 } }, { manufacturerCode: 4919 });
    ...
    wiser_dimmer_mode: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            await entity.write('lightingBallastCfg', { 'wiserControlMode': controlMode }, { manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.SCHNEIDER });
            return { state: { dimmer_mode: value } };
        },
        convertGet: async (entity, key, meta) => {
            await entity.read('lightingBallastCfg', ['wiserControlMode'], { manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.SCHNEIDER });
        },
    },
    ...
    xiaomi_switch_click_mode: {
        key: ['click_mode'],
        convertSet: async (entity, key, value, meta) => {
            await entity.write('aqaraOpple', { 0x0125: { value: utils.getFromLookup(value, { 'fast': 0x1, 'multi': 0x02 }), type: 0x20 } }, manufacturerOptions.xiaomi);
