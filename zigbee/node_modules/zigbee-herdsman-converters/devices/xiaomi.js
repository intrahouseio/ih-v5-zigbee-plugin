...
const xiaomi = __importStar(require("../lib/xiaomi"));
...
const xiaomiExtend = {
    light_onoff_brightness_colortemp: (options = {}) => {
        ...
        const fromZigbee = [
            ...extend_1.default.light_onoff_brightness_colortemp(options).fromZigbee,
            fromZigbee_1.default.xiaomi_bulb_interval, fromZigbee_1.default.ignore_occupancy_report, fromZigbee_1.default.ignore_humidity_report,
            fromZigbee_1.default.ignore_pressure_report, fromZigbee_1.default.ignore_temperature_report, ...options.fromZigbee
        ];
        const toZigbee = [
            ...extend_1.default.light_onoff_brightness_colortemp(options).toZigbee, ...options.toZigbee
        ];
        const exposes = [
            ...extend_1.default.light_onoff_brightness_colortemp(options).exposes, ...options.exposes
        ];
        if (!options.disableSwitchPowerOutageMemory) {
            toZigbee.push(toZigbee_1.default.xiaomi_switch_power_outage_memory);
...
const tzLocal = {
    ...
    aqara_trv: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            switch (key) {
                case 'system_mode':
                    await entity.write('aqaraOpple', { 0x0271: { value: utils.getFromLookup(value, { 'off': 0, 'heat': 1 }), type: 0x20 } }, { manufacturerCode: 0x115f });
                    break;
                case 'preset':
                    await entity.write('aqaraOpple', { 0x0272: { value: utils.getFromLookup(value, { 'manual': 0, 'auto': 1, 'away': 2 }), type: 0x20 } }, { manufacturerCode: 0x115f });
                    break;
                case 'window_detection':
                    await entity.write('aqaraOpple', { 0x0273: { value: utils.getFromLookup(value, { 'OFF': 0, 'ON': 1 }), type: 0x20 } }, { manufacturerCode: 0x115f });
                    break;
                case 'valve_detection':
                    await entity.write('aqaraOpple', { 0x0274: { value: utils.getFromLookup(value, { 'OFF': 0, 'ON': 1 }), type: 0x20 } }, { manufacturerCode: 0x115f });
                    break;
                case 'child_lock':
                    await entity.write('aqaraOpple', { 0x0277: { value: utils.getFromLookup(value, { 'UNLOCK': 0, 'LOCK': 1 }), type: 0x20 } }, { manufacturerCode: 0x115f });
                    break;
                case 'away_preset_temperature':
                    await entity.write('aqaraOpple', { 0x0279: { value: Math.round(utils.toNumber(value, 'away_preset_temperature') * 100), type: 0x23 } }, { manufacturerCode: 0x115f });
                    break;
                case 'sensor': {
                ...
                case 'identify':
                    ...
                    break;
                case 'schedule':
                    await entity.write('aqaraOpple', { 0x027d: { value: utils.getFromLookup(value, { 'OFF': 0, 'ON': 1 }), type: 0x20 } }, { manufacturerCode: 0x115f });
                    break;
    ...
    VOCKQJK11LM_display_unit: {
        key: ['display_unit'],
        convertSet: async (entity, key, value, meta) => {
            await entity.write('aqaraOpple', { 0x0114: { value: utils.getFromLookup(value, xiaomi.VOCKQJK11LMDisplayUnit), type: 0x20 } }, { manufacturerCode: 0x115F });
    ...
    aqara_fp1_region_delete: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            deviceConfig[4] = 0;
            deviceConfig[5] = 0;
            log('info', `delete region ${command.region_id} ` +
    ...
    CTPR01_operation_mode: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            const callback = async () => {
                await entity.write('aqaraOpple', { 0x0148: { value: utils.getFromLookup(value, lookup), type: 0x20 } }, { manufacturerCode: 0x115f, disableDefaultResponse: true });
...
const definitions = [
    {
        ...
        fromZigbee: [fromZigbee_1.default.ias_water_leak_alarm_1, xiaomi.fromZigbee.aqara_opple, fromZigbee_1.default.battery],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.temperature, fromZigbee_1.default.humidity, fzLocal.aqara_s1_pm25, fzLocal.aqara_s1_co2],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.ias_contact_alarm_1, xiaomi.fromZigbee.aqara_opple, fromZigbee_1.default.battery],
        toZigbee: [],
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.xiaomi_contact, fromZigbee_1.default.ias_contact_alarm_1, xiaomi.fromZigbee.aqara_opple],
    ...
    },
    {
        ...
        fromZigbee: extend_1.default.light_onoff_brightness_colortemp_color().fromZigbee.concat([
            fromZigbee_1.default.xiaomi_power, xiaomi.fromZigbee.aqara_opple
        ]),
        toZigbee: extend_1.default.light_onoff_brightness_colortemp_color().toZigbee.concat([
            toZigbee_1.default.xiaomi_dimmer_mode, toZigbee_1.default.xiaomi_switch_power_outage_memory
        ]),
    ...
    },
    {
        ...
        toZigbee: xiaomiExtend.light_onoff_brightness_colortemp({ disableSwitchPowerOutageMemory: true })
            .toZigbee.concat([toZigbee_1.default.xiaomi_light_power_outage_memory]),
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [xiaomi.fromZigbee.xiaomi_basic, fromZigbee_1.default.xiaomi_WXKG01LM_action, legacy.fz.WXKG01LM_click],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.xiaomi_multistate_action, fromZigbee_1.default.xiaomi_WXKG11LM_action, xiaomi.fromZigbee.xiaomi_basic,
    ...
    },
    {
        ...
        fromZigbee: [xiaomi.fromZigbee.xiaomi_basic, fromZigbee_1.default.xiaomi_multistate_action, legacy.fz.WXKG12LM_action_click_multistate],
        toZigbee: [],
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.xiaomi_on_off_action, xiaomi.fromZigbee.xiaomi_basic, legacy.fz.WXKG03LM_click],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.xiaomi_on_off_action, fromZigbee_1.default.xiaomi_multistate_action, xiaomi.fromZigbee.xiaomi_basic,
    ...
    },
    {
        ...
        fromZigbee: [xiaomi.fromZigbee.xiaomi_basic, fromZigbee_1.default.xiaomi_on_off_action, fromZigbee_1.default.xiaomi_multistate_action],
        toZigbee: [],
        exposes: [e.battery(),
    ...
    },
    {
        ...
        extend: [
            (0, modernExtend_1.light)({ effect: false, powerOnBehaviour: false, colorTemp: { startup: false, range: [153, 370] } }),
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.xiaomi_on_off_action, xiaomi.fromZigbee.xiaomi_basic, legacy.fz.WXKG02LM_click],
        toZigbee: [],
        onEvent: preventReset,
    },
    {
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.xiaomi_multistate_action, xiaomi.fromZigbee.aqara_opple],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_switch_operation_mode_opple,
            toZigbee_1.default.xiaomi_flip_indicator_light, toZigbee_1.default.aqara_switch_mode_switch],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.xiaomi_multistate_action, xiaomi.fromZigbee.aqara_opple],
        toZigbee: [
            toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_switch_operation_mode_opple, toZigbee_1.default.xiaomi_flip_indicator_light,
            toZigbee_1.default.xiaomi_switch_power_outage_memory, toZigbee_1.default.aqara_switch_mode_switch
        ],
        exposes: [
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.xiaomi_power, fromZigbee_1.default.xiaomi_multistate_action, xiaomi.fromZigbee.aqara_opple],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_power, toZigbee_1.default.xiaomi_switch_operation_mode_opple, toZigbee_1.default.xiaomi_switch_power_outage_memory,
            toZigbee_1.default.xiaomi_flip_indicator_light],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.xiaomi_power, fromZigbee_1.default.xiaomi_multistate_action, xiaomi.fromZigbee.aqara_opple],
        toZigbee: [
            toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_power, toZigbee_1.default.xiaomi_switch_operation_mode_opple, toZigbee_1.default.xiaomi_switch_power_outage_memory,
            toZigbee_1.default.xiaomi_flip_indicator_light
        ],
        exposes: [
            e.switch().withEndpoint('top'),
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.xiaomi_multistate_action, xiaomi.fromZigbee.aqara_opple],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_switch_operation_mode_opple, toZigbee_1.default.xiaomi_switch_power_outage_memory,
            toZigbee_1.default.xiaomi_flip_indicator_light, toZigbee_1.default.xiaomi_led_disabled_night],
        meta: { multiEndpoint: true },
        endpoint: (device) => {
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.xiaomi_power, xiaomi.fromZigbee.aqara_opple, fromZigbee_1.default.xiaomi_multistate_action],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_switch_operation_mode_opple, toZigbee_1.default.xiaomi_switch_power_outage_memory,
            toZigbee_1.default.xiaomi_led_disabled_night, toZigbee_1.default.xiaomi_flip_indicator_light],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.xiaomi_multistate_action, xiaomi.fromZigbee.aqara_opple],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_switch_operation_mode_opple, toZigbee_1.default.xiaomi_switch_power_outage_memory,
            toZigbee_1.default.xiaomi_flip_indicator_light, toZigbee_1.default.xiaomi_led_disabled_night, toZigbee_1.default.aqara_switch_mode_switch],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.xiaomi_on_off_ignore_endpoint_4_5_6, fromZigbee_1.default.xiaomi_on_off_action, legacy.fz.QBKG04LM_QBKG11LM_click,
            fromZigbee_1.default.xiaomi_operation_mode_basic],
        exposes: [
            e.switch(), e.action(['release', 'hold', 'double', 'single', 'hold_release']),
            e.enum('operation_mode', ea.STATE_SET, ['control_relay', 'decoupled'])
                .withDescription('Decoupled mode'),
        ],
        toZigbee: [toZigbee_1.default.on_off, { ...toZigbee_1.default.xiaomi_switch_operation_mode_basic, convertGet: null }],
        endpoint: (device) => {
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.xiaomi_on_off_action, fromZigbee_1.default.xiaomi_multistate_action, fromZigbee_1.default.xiaomi_on_off_ignore_endpoint_4_5_6,
            legacy.fz.QBKG04LM_QBKG11LM_click, xiaomi.fromZigbee.xiaomi_basic, fromZigbee_1.default.xiaomi_operation_mode_basic,
            legacy.fz.QBKG11LM_click, fromZigbee_1.default.ignore_multistate_report, fromZigbee_1.default.xiaomi_power],
        exposes: [
        ...
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_switch_operation_mode_basic, toZigbee_1.default.xiaomi_power],
        endpoint: (device) => {
            return { 'system': 1 };
        },
        onEvent: preventReset,
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.xiaomi_on_off_action, fromZigbee_1.default.xiaomi_on_off_ignore_endpoint_4_5_6, legacy.fz.QBKG03LM_QBKG12LM_click,
            legacy.fz.QBKG03LM_buttons, fromZigbee_1.default.xiaomi_operation_mode_basic, xiaomi.fromZigbee.xiaomi_basic],
        exposes: [
        ...
        toZigbee: [toZigbee_1.default.on_off, { ...toZigbee_1.default.xiaomi_switch_operation_mode_basic, convertGet: null }, toZigbee_1.default.xiaomi_power],
        meta: { multiEndpoint: true },
        endpoint: (device) => {
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.xiaomi_on_off_action, fromZigbee_1.default.xiaomi_multistate_action, fromZigbee_1.default.xiaomi_on_off_ignore_endpoint_4_5_6,
            legacy.fz.QBKG03LM_QBKG12LM_click, xiaomi.fromZigbee.xiaomi_basic, fromZigbee_1.default.xiaomi_operation_mode_basic, legacy.fz.QBKG12LM_click,
            fromZigbee_1.default.xiaomi_power],
        exposes: [
            e.switch().withEndpoint('left'),
            e.switch().withEndpoint('right'),
    ...
    },
    {
        ...
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_switch_operation_mode_basic],
        endpoint: (device) => {
            return { 'system': 1, 'default': 2 };
        },
        onEvent: preventReset,
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.xiaomi_on_off_ignore_endpoint_4_5_6, fromZigbee_1.default.xiaomi_on_off_action, legacy.fz.QBKG03LM_QBKG12LM_click,
            legacy.fz.QBKG03LM_buttons, fromZigbee_1.default.xiaomi_operation_mode_basic],
        exposes: [
            e.switch().withEndpoint('left'),
            e.switch().withEndpoint('right'),
            e.action(['release_left', 'release_right', 'release_both', 'double_left', 'double_right',
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.xiaomi_multistate_action, xiaomi.fromZigbee.aqara_opple],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_switch_operation_mode_opple, toZigbee_1.default.xiaomi_switch_power_outage_memory, toZigbee_1.default.xiaomi_led_disabled_night,
            toZigbee_1.default.aqara_switch_mode_switch, toZigbee_1.default.xiaomi_flip_indicator_light],
        meta: { multiEndpoint: true },
        endpoint: (device) => {
            return { 'left': 1, 'center': 2, 'right': 3 };
        },
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.xiaomi_power, xiaomi.fromZigbee.xiaomi_basic, fromZigbee_1.default.xiaomi_multistate_action],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_power, toZigbee_1.default.xiaomi_switch_operation_mode_basic],
        endpoint: (device) => {
            return { 'system': 1 };
        },
        onEvent: preventReset,
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.xiaomi_power, fromZigbee_1.default.xiaomi_multistate_action, fromZigbee_1.default.xiaomi_operation_mode_basic],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_power, toZigbee_1.default.xiaomi_switch_operation_mode_basic],
        meta: { multiEndpoint: true },
        endpoint: (device) => {
            return { 'left': 1, 'right': 2, 'system': 1 };
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [xiaomi.fromZigbee.xiaomi_basic, fromZigbee_1.default.xiaomi_temperature, fromZigbee_1.default.humidity],
        toZigbee: [],
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [xiaomi.fromZigbee.xiaomi_basic, fromZigbee_1.default.xiaomi_temperature, fromZigbee_1.default.humidity, fromZigbee_1.default.pressure],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [xiaomi.fromZigbee.aqara_opple, fromZigbee_1.default.temperature, fromZigbee_1.default.humidity, fromZigbee_1.default.pressure, fromZigbee_1.default.battery],
        toZigbee: [],
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [xiaomi.fromZigbee.xiaomi_basic, fromZigbee_1.default.occupancy_with_timeout],
        toZigbee: [],
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [xiaomi.fromZigbee.xiaomi_basic, fromZigbee_1.default.occupancy_with_timeout, fromZigbee_1.default.RTCGQ11LM_illuminance],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.aqara_occupancy_illuminance, xiaomi.fromZigbee.aqara_opple, fromZigbee_1.default.battery],
        toZigbee: [toZigbee_1.default.aqara_detection_interval],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.RTCGQ13LM_occupancy, xiaomi.fromZigbee.aqara_opple, fromZigbee_1.default.battery],
        toZigbee: [toZigbee_1.default.aqara_detection_interval, toZigbee_1.default.aqara_motion_sensitivity],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.aqara_occupancy_illuminance, xiaomi.fromZigbee.aqara_opple, fromZigbee_1.default.battery],
        toZigbee: [toZigbee_1.default.aqara_detection_interval, toZigbee_1.default.aqara_motion_sensitivity, toZigbee_1.default.RTCGQ14LM_trigger_indicator],
        exposes: [e.occupancy(), e.illuminance_lux().withProperty('illuminance'),
            e.illuminance().withUnit('lx').withDescription('Measured illuminance in lux'),
    ...
    },
    {
        ...
        toZigbee: [
            toZigbee_1.default.RTCZCGQ11LM_presence, toZigbee_1.default.RTCZCGQ11LM_monitoring_mode, toZigbee_1.default.RTCZCGQ11LM_approach_distance, toZigbee_1.default.aqara_motion_sensitivity,
            toZigbee_1.default.RTCZCGQ11LM_reset_nopresence_status, tzLocal.aqara_fp1_region_upsert, tzLocal.aqara_fp1_region_delete,
        ],
        exposes: [
            ...
            e.composite('region_upsert', 'region_upsert', ea.SET)
                .withDescription('Definition of a new region to be added (or replace existing one). ' +
                ...
                .withFeature(e.list('zones', ea.SET, e.composite('Zone position', 'zone_position', ea.SET)
                ...
                .withValueMax(fp1.constants.region_config_zoneY_max))).withDescription('list of dictionaries in the format {"x": 1, "y": 1}, {"x": 2, "y": 1}')),
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [xiaomi.fromZigbee.xiaomi_basic, fromZigbee_1.default.xiaomi_contact],
        toZigbee: [],
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [xiaomi.fromZigbee.xiaomi_basic, fromZigbee_1.default.ias_water_leak_alarm_1],
        toZigbee: [],
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [xiaomi.fromZigbee.xiaomi_basic, fromZigbee_1.default.MFKZQ01LM_action_multistate, fromZigbee_1.default.MFKZQ01LM_action_analog],
    ...
    },
    {
        ...
        vendor: 'Xiaomi',
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.xiaomi_power, xiaomi.fromZigbee.xiaomi_basic, fromZigbee_1.default.ignore_occupancy_report, fromZigbee_1.default.ignore_illuminance_report],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_switch_power_outage_memory, toZigbee_1.default.xiaomi_power],
    ...
    },
    {
        ...
        vendor: 'Xiaomi',
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.xiaomi_power, xiaomi.fromZigbee.xiaomi_basic, fromZigbee_1.default.ignore_occupancy_report, fromZigbee_1.default.ignore_illuminance_report],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_power],
    ...
    },
    {
        ...
        vendor: 'Xiaomi',
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.xiaomi_power, xiaomi.fromZigbee.aqara_opple, fromZigbee_1.default.ignore_occupancy_report, fromZigbee_1.default.ignore_illuminance_report,
            fromZigbee_1.default.ignore_time_read],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_power, toZigbee_1.default.xiaomi_switch_power_outage_memory, toZigbee_1.default.xiaomi_auto_off, toZigbee_1.default.xiaomi_led_disabled_night,
            toZigbee_1.default.xiaomi_overload_protection],
        exposes: [
    ...
    },
    {
        ...
        vendor: 'Xiaomi',
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.xiaomi_power, xiaomi.fromZigbee.aqara_opple, xiaomi.fromZigbee.xiaomi_basic,
            fromZigbee_1.default.ignore_occupancy_report, fromZigbee_1.default.ignore_illuminance_report],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_power, toZigbee_1.default.xiaomi_switch_power_outage_memory, toZigbee_1.default.xiaomi_auto_off, toZigbee_1.default.xiaomi_led_disabled_night,
            toZigbee_1.default.xiaomi_overload_protection],
        exposes: [
            e.switch(), e.power().withAccess(ea.STATE_GET), e.energy(), e.device_temperature().withAccess(ea.STATE),
    ...
    },
    {
        ...
        vendor: 'Xiaomi',
        fromZigbee: [fromZigbee_1.default.on_off, xiaomi.fromZigbee.xiaomi_basic, fromZigbee_1.default.electrical_measurement, fromZigbee_1.default.metering,
            xiaomi.fromZigbee.aqara_opple, fromZigbee_1.default.xiaomi_power, fromZigbee_1.default.device_temperature],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_switch_power_outage_memory, toZigbee_1.default.xiaomi_led_disabled_night,
            toZigbee_1.default.xiaomi_overload_protection, toZigbee_1.default.xiaomi_auto_off, toZigbee_1.default.xiaomi_socket_button_lock],
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.xiaomi_power, fromZigbee_1.default.ignore_occupancy_report, xiaomi.fromZigbee.xiaomi_basic],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_power, toZigbee_1.default.xiaomi_led_disabled_night,
            toZigbee_1.default.xiaomi_switch_power_outage_memory, toZigbee_1.default.xiaomi_auto_off],
    ...
    },
    {
        ...
        vendor: 'Xiaomi',
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.xiaomi_power, xiaomi.fromZigbee.xiaomi_basic],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_switch_power_outage_memory, toZigbee_1.default.xiaomi_power],
        exposes: [e.switch(), e.power().withAccess(ea.STATE_GET), e.energy(), e.device_temperature().withAccess(ea.STATE),
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [xiaomi.fromZigbee.xiaomi_basic, fromZigbee_1.default.JTYJGD01LMBW_smoke],
        toZigbee: [toZigbee_1.default.JTQJBF01LMBW_JTYJGD01LMBW_sensitivity, toZigbee_1.default.JTQJBF01LMBW_JTYJGD01LMBW_selfest],
        exposes: [
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.ias_gas_alarm_1, fromZigbee_1.default.JTQJBF01LMBW_sensitivity, fromZigbee_1.default.JTQJBF01LMBW_gas_density],
        toZigbee: [toZigbee_1.default.JTQJBF01LMBW_JTYJGD01LMBW_sensitivity, toZigbee_1.default.JTQJBF01LMBW_JTYJGD01LMBW_selfest],
        exposes: [
    ...
    },
    {
        ...
        toZigbee: [toZigbee_1.default.aqara_alarm, toZigbee_1.default.aqara_density, toZigbee_1.default.JTBZ01AQA_gas_sensitivity, toZigbee_1.default.aqara_selftest, toZigbee_1.default.aqara_buzzer,
            toZigbee_1.default.aqara_buzzer_manual, toZigbee_1.default.aqara_linkage_alarm, toZigbee_1.default.JTBZ01AQA_state, toZigbee_1.default.aqara_power_outage_count],
    ...
    },
    {
        ...
        fromZigbee: [xiaomi.fromZigbee.aqara_opple, fromZigbee_1.default.battery],
        toZigbee: [toZigbee_1.default.aqara_alarm, toZigbee_1.default.aqara_density, toZigbee_1.default.aqara_selftest, toZigbee_1.default.aqara_buzzer, toZigbee_1.default.aqara_buzzer_manual,
            toZigbee_1.default.JYGZ01AQ_heartbeat_indicator, toZigbee_1.default.aqara_linkage_alarm],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.xiaomi_lock_report],
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [xiaomi.fromZigbee.xiaomi_basic, fromZigbee_1.default.DJT11LM_vibration],
        toZigbee: [toZigbee_1.default.DJT11LM_vibration_sensitivity],
        exposes: [
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.DJT12LM_vibration],
    ...
    },
    {
        ...
        vendor: 'Xiaomi',
        fromZigbee: [xiaomi.fromZigbee.xiaomi_basic, fromZigbee_1.default.xiaomi_curtain_position, fromZigbee_1.default.xiaomi_curtain_position_tilt],
        toZigbee: [toZigbee_1.default.xiaomi_curtain_position_state, toZigbee_1.default.xiaomi_curtain_options],
        onEvent: async (type, data, device) => {
    ...
    },
    {
        ...
        fromZigbee: [xiaomi.fromZigbee.xiaomi_basic, fromZigbee_1.default.xiaomi_curtain_position, fromZigbee_1.default.xiaomi_curtain_position_tilt, fromZigbee_1.default.xiaomi_curtain_hagl04_status],
        toZigbee: [toZigbee_1.default.xiaomi_curtain_position_state, toZigbee_1.default.xiaomi_curtain_options],
        onEvent: async (type, data, device) => {
    ...
    },
    {
        ...
        fromZigbee: [xiaomi.fromZigbee.xiaomi_basic, fromZigbee_1.default.xiaomi_curtain_position, fromZigbee_1.default.xiaomi_curtain_position_tilt, fromZigbee_1.default.xiaomi_curtain_hagl07_status],
        toZigbee: [toZigbee_1.default.xiaomi_curtain_position_state, toZigbee_1.default.xiaomi_curtain_options],
        onEvent: async (type, data, device) => {
            // The position (genAnalogOutput.presentValue) reported via an attribute contains an invalid value
            // however when reading it will provide the correct value.
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.xiaomi_curtain_position, fromZigbee_1.default.xiaomi_curtain_acn002_status, fromZigbee_1.default.ignore_basic_report, xiaomi.fromZigbee.aqara_opple],
        toZigbee: [toZigbee_1.default.xiaomi_curtain_position_state, toZigbee_1.default.xiaomi_curtain_acn002_battery, toZigbee_1.default.xiaomi_curtain_acn002_charging_status],
        onEvent: async (type, data, device) => {
    ...
    },
    {
        ...
        fromZigbee: [
            ...
            fromZigbee_1.default.xiaomi_curtain_position_tilt,
            xiaomi.fromZigbee.aqara_opple,
            fromZigbee_1.default.power_source,
        ],
        toZigbee: [
            toZigbee_1.default.xiaomi_curtain_position_state,
            toZigbee_1.default.xiaomi_curtain_battery_voltage,
            toZigbee_1.default.ZNCLBL01LM_hooks_lock,
            toZigbee_1.default.ZNCLBL01LM_hooks_state,
            toZigbee_1.default.ZNCLBL01LM_hand_open,
            toZigbee_1.default.ZNCLBL01LM_limits_calibration,
            toZigbee_1.default.power_source,
    ...
    },
    {
        ...
        fromZigbee: [xiaomi.fromZigbee.xiaomi_basic, fromZigbee_1.default.xiaomi_power, fromZigbee_1.default.ignore_multistate_report, fromZigbee_1.default.on_off, xiaomi.fromZigbee.xiaomi_basic_raw],
        meta: { multiEndpoint: true },
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.LLKZMK11LM_interlock, toZigbee_1.default.xiaomi_power, toZigbee_1.default.xiaomi_switch_power_outage_memory],
        endpoint: (device) => {
            return { 'l1': 1, 'l2': 2 };
        },
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, xiaomi.fromZigbee.aqara_opple, fromZigbee_1.default.xiaomi_power],
    ...
    },
    {
        ...
        vendor: 'Xiaomi',
        fromZigbee: [xiaomi.fromZigbee.xiaomi_basic, fromZigbee_1.default.ZNMS12LM_ZNMS13LM_closuresDoorLock_report, fromZigbee_1.default.ZNMS12LM_low_battery],
        toZigbee: [],
        exposes: [
    ...
    },
    {
        ...
        vendor: 'Xiaomi',
        fromZigbee: [fromZigbee_1.default.ZNMS12LM_ZNMS13LM_closuresDoorLock_report, fromZigbee_1.default.ignore_basic_report],
        toZigbee: [],
        exposes: [
    ...
    },
    {
        ...
        vendor: 'Xiaomi',
        fromZigbee: [fromZigbee_1.default.ZNMS11LM_closuresDoorLock_report, fromZigbee_1.default.ignore_basic_report],
        toZigbee: [],
        exposes: [
            e.binary('state', ea.STATE, 'UNLOCK', 'LOCK'),
            e.binary('reverse', ea.STATE, 'UNLOCK', 'LOCK'),
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.aqara_opple_on, fromZigbee_1.default.aqara_opple_off, fromZigbee_1.default.battery, fromZigbee_1.default.aqara_opple_multistate, xiaomi.fromZigbee.aqara_opple],
        exposes: [e.battery(), e.battery_voltage(), e.action([
        ...
        toZigbee: [toZigbee_1.default.aqara_opple_operation_mode],
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.aqara_opple_on, fromZigbee_1.default.aqara_opple_off, fromZigbee_1.default.aqara_opple_step, fromZigbee_1.default.aqara_opple_step_color_temp, fromZigbee_1.default.battery,
            fromZigbee_1.default.aqara_opple_multistate, xiaomi.fromZigbee.aqara_opple],
        exposes: [e.battery(), e.battery_voltage(), e.action([
                'button_1_hold', 'button_1_release', 'button_1_single', 'button_1_double', 'button_1_triple',
                'button_2_hold', 'button_2_release', 'button_2_single', 'button_2_double', 'button_2_triple',
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.aqara_opple_on, fromZigbee_1.default.aqara_opple_off, fromZigbee_1.default.aqara_opple_step, fromZigbee_1.default.aqara_opple_move, fromZigbee_1.default.aqara_opple_stop,
            fromZigbee_1.default.aqara_opple_step_color_temp, fromZigbee_1.default.aqara_opple_move_color_temp, fromZigbee_1.default.battery, fromZigbee_1.default.aqara_opple_multistate, xiaomi.fromZigbee.aqara_opple],
        exposes: [e.battery(), e.battery_voltage(), e.action([
                'button_1_hold', 'button_1_release', 'button_1_single', 'button_1_double', 'button_1_triple',
                'button_2_hold', 'button_2_release', 'button_2_single', 'button_2_double', 'button_2_triple',
                'button_3_hold', 'button_3_release', 'button_3_single', 'button_3_double', 'button_3_triple',
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.illuminance, xiaomi.fromZigbee.aqara_opple],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.device_temperature, xiaomi.fromZigbee.aqara_opple, fromZigbee_1.default.ignore_metering, fromZigbee_1.default.ignore_electrical_measurement,
            fromZigbee_1.default.xiaomi_power],
        ...
        toZigbee: [toZigbee_1.default.xiaomi_switch_type, toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_switch_power_outage_memory, toZigbee_1.default.xiaomi_led_disabled_night],
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
    ...
    },
    {
        ...
        vendor: 'Xiaomi',
        description: 'Aqara single switch module T1 (with neutral)',
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.xiaomi_power, xiaomi.fromZigbee.aqara_opple],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_power, toZigbee_1.default.xiaomi_switch_type, toZigbee_1.default.xiaomi_switch_power_outage_memory, toZigbee_1.default.xiaomi_led_disabled_night],
        exposes: [e.switch(), e.power().withAccess(ea.STATE_GET), e.energy(), e.device_temperature().withAccess(ea.STATE),
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, xiaomi.fromZigbee.aqara_opple],
        exposes: [e.switch(), e.power_outage_memory(), e.switch_type(), e.power_outage_count(), e.device_temperature()],
        toZigbee: [toZigbee_1.default.xiaomi_switch_type, toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_switch_power_outage_memory],
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
            await reporting.bind(endpoint, coordinatorEndpoint, ['genOnOff']);
            await reporting.onOff(endpoint);
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.ZNCJMB14LM],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.ZNCJMB14LM],
        meta: { multiEndpoint: true },
        endpoint: (device) => {
            return { 'left': 1, 'center': 2, 'right': 3 };
        },
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [fromZigbee_1.default.xiaomi_on_off_action, fromZigbee_1.default.xiaomi_multistate_action, fromZigbee_1.default.battery, xiaomi.fromZigbee.aqara_opple],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.xiaomi_multistate_action, xiaomi.fromZigbee.aqara_opple, fromZigbee_1.default.command_toggle],
        toZigbee: [toZigbee_1.default.xiaomi_switch_click_mode, toZigbee_1.default.aqara_opple_operation_mode],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.xiaomi_tvoc, fromZigbee_1.default.battery, fromZigbee_1.default.temperature, fromZigbee_1.default.humidity, xiaomi.fromZigbee.aqara_opple],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.xiaomi_power, xiaomi.fromZigbee.aqara_opple],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_switch_power_outage_memory, toZigbee_1.default.xiaomi_led_disabled_night,
            toZigbee_1.default.xiaomi_overload_protection, toZigbee_1.default.xiaomi_socket_button_lock],
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.aqara_opple_multistate, xiaomi.fromZigbee.aqara_opple],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.illuminance, xiaomi.fromZigbee.aqara_opple],
        toZigbee: [toZigbee_1.default.GZCGQ11LM_detection_period],
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.xiaomi_power, xiaomi.fromZigbee.aqara_opple],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_switch_power_outage_memory, toZigbee_1.default.xiaomi_led_disabled_night,
            toZigbee_1.default.xiaomi_button_switch_mode, toZigbee_1.default.xiaomi_overload_protection, toZigbee_1.default.xiaomi_socket_button_lock],
        meta: { multiEndpoint: true },
        endpoint: () => {
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.xiaomi_contact, xiaomi.fromZigbee.aqara_opple, fromZigbee_1.default.ias_contact_alarm_1],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.xiaomi_on_off_action, fromZigbee_1.default.xiaomi_multistate_action, xiaomi.fromZigbee.xiaomi_basic,
            xiaomi.fromZigbee.aqara_opple, fromZigbee_1.default.aqara_knob_rotation],
        toZigbee: [toZigbee_1.default.aqara_opple_operation_mode],
        onEvent: preventReset,
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint1 = device.getEndpoint(1);
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [fromZigbee_1.default.xiaomi_multistate_action, xiaomi.fromZigbee.aqara_opple],
        toZigbee: [toZigbee_1.default.xiaomi_switch_click_mode],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.xiaomi_multistate_action, xiaomi.fromZigbee.aqara_opple, fromZigbee_1.default.command_toggle],
        toZigbee: [toZigbee_1.default.xiaomi_switch_click_mode, toZigbee_1.default.aqara_opple_operation_mode],
    ...
    },
    {
        ...
        fromZigbee: [fzLocal.aqara_trv, fromZigbee_1.default.thermostat, fromZigbee_1.default.battery],
        toZigbee: [tzLocal.aqara_trv, toZigbee_1.default.thermostat_occupied_heating_setpoint],
        exposes: [
            ...
            e.power_outage_count(),
            e.device_temperature(),
            e.switch_().withState('schedule', true, 'When being ON, the thermostat will change its state based on your settings', ea.ALL, 'ON', 'OFF'),
    ...
    },
    {
        ...
        exposes: [
            ...
            e.list('schedule', ea.STATE_SET, e.composite('dayTime', 'dayTime', exposes.access.STATE_SET)
                ...
                .withFeature(e.numeric('size', exposes.access.STATE_SET))).withDescription('Feeding schedule'),
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        fromZigbee: [xiaomi.fromZigbee.xiaomi_basic, fromZigbee_1.default.aqara_opple_multistate, xiaomi.fromZigbee.aqara_opple],
        toZigbee: [],
        endpoint: (device) => {
            return { left: 1, right: 2, both: 3 };
        },
    ...
    },
    {
        ...
        meta: { battery: { voltageToPercentage: '3V_2850_3000' } },
        ota: ota.zigbeeOTA,
        fromZigbee: [xiaomi.fromZigbee.aqara_opple, fzLocal.CTPR01_action_multistate, fzLocal.CTPR01_action_analog, fromZigbee_1.default.ignore_onoff_report],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.xiaomi_multistate_action, xiaomi.fromZigbee.aqara_opple],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_switch_operation_mode_opple, toZigbee_1.default.xiaomi_switch_power_outage_memory, toZigbee_1.default.aqara_switch_mode_switch,
            toZigbee_1.default.xiaomi_flip_indicator_light],
        endpoint: (device) => {
            return { 'left': 1, 'center': 2, 'right': 3 };
        },
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.xiaomi_power, fromZigbee_1.default.xiaomi_multistate_action, xiaomi.fromZigbee.aqara_opple],
        toZigbee: [
            toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_switch_operation_mode_opple, toZigbee_1.default.xiaomi_switch_power_outage_memory,
            toZigbee_1.default.xiaomi_led_disabled_night, toZigbee_1.default.xiaomi_flip_indicator_light,
        ],
        exposes: [
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.xiaomi_multistate_action, xiaomi.fromZigbee.aqara_opple, fromZigbee_1.default.xiaomi_power],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.xiaomi_switch_operation_mode_opple, toZigbee_1.default.xiaomi_flip_indicator_light],
        endpoint: (device) => {
            return { 'left': 1, 'right': 2 };
        },
        meta: { multiEndpoint: true },
