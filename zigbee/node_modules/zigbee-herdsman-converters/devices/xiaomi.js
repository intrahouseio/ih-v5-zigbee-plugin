...
const tzLocal = {
    ...
    aqara_trv: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            switch (key) {
                case 'system_mode':
                    await entity.write('aqaraOpple', { 0x0271: { value: { 'off': 0, 'heat': 1 }[value], type: 0x20 } }, { manufacturerCode: 0x115f });
                    break;
                case 'preset':
                ...
                case 'identify':
                    ...
                    break;
                case 'schedule':
                    await entity.write('aqaraOpple', { 0x027d: { value: { 'OFF': 0, 'ON': 1 }[value], type: 0x20 } }, { manufacturerCode: 0x115f });
                    break;
    ...
    VOCKQJK11LM_display_unit: {
        key: ['display_unit'],
        convertSet: async (entity, key, value, meta) => {
            await entity.write('aqaraOpple', { 0x0114: { value: xiaomi.VOCKQJK11LMDisplayUnit[value], type: 0x20 } }, { manufacturerCode: 0x115F });
    ...
    aqara_fp1_region_upsert: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            if (!commandWrapper.isSuccess) {
                log('warn', `encountered an error (${commandWrapper.error.reason}) ` +
    ...
    CTPR01_operation_mode: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            const callback = async () => {
                await entity.write('aqaraOpple', { 0x0148: { value: lookup[value], type: 0x20 } }, { manufacturerCode: 0x115f, disableDefaultResponse: true });
...
module.exports = [
    ...
    },
    {
        ...
        exposes: [
            ...
            exposes.composite('region_upsert', 'region_upsert', ea.SET)
                ...
                .withFeature(exposes.list('zones', ea.SET, exposes.composite('zone_position', ea.SET)
    ...
    },
    {
        ...
        exposes: [
            ...
            e.power_outage_count(),
            e.device_temperature(),
            exposes.switch().withState('schedule', true, 'When being ON, the thermostat will change its state based on your settings', ea.ALL, 'ON', 'OFF'),
    ...
    },
    {
        ...
        exposes: [
            ...
            exposes.list('schedule', ea.STATE_SET, exposes.composite('dayTime', 'dayTime', exposes.access.STATE_SET)
                ...
                .withFeature(exposes.numeric('size', exposes.access.STATE_SET))).withDescription('Feeding schedule'),
