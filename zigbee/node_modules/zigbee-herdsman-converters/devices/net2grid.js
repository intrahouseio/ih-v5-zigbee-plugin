...
const definitions = [
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.bind(endpoint10, coordinatorEndpoint, ['seMetering']);
            await reporting_1.default.readMeteringMultiplierDivisor(endpoint10);
            await reporting_1.default.instantaneousDemand(endpoint10);
            await reporting_1.default.currentSummDelivered(endpoint10);
            await reporting_1.default.currentSummReceived(endpoint10);
        },
    },
];
