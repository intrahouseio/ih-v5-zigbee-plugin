...
const definitions = [
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.brightness(endpoint1);
            await reporting_1.default.readEletricalMeasurementMultiplierDivisors(endpoint1);
            await reporting_1.default.activePower(endpoint1, { min: 5, max: 3600, change: 1000 });
            await reporting_1.default.rmsCurrent(endpoint1, { min: 5, max: 3600, change: 100 });
            await reporting_1.default.rmsVoltage(endpoint1, { min: 5, max: 3600, change: 100 });
            // read switch state
