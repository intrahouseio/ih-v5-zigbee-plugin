...
const definitions = [
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            if (endpoint18 != null) {
                await reporting_1.default.bind(endpoint18, coordinatorEndpoint, ['genOnOff', 'genLevelCtrl']);
            }
            else {
                ...
                if (endpoint10 != null) {
                    await reporting_1.default.bind(endpoint10, coordinatorEndpoint, ['genLevelCtrl']);
                }
            }
            ...
            if (endpoint11 != null) {
                ...
                await reporting_1.default.bind(endpoint11, coordinatorEndpoint, ['genLevelCtrl']);
            }
            ...
            if (endpoint12 != null) {
                ...
                await reporting_1.default.bind(endpoint12, coordinatorEndpoint, ['genLevelCtrl']);
            }
            ...
            if (endpoint13 != null) {
                ...
                await reporting_1.default.bind(endpoint13, coordinatorEndpoint, ['genLevelCtrl']);
            }
        },
        fromZigbee: [fromZigbee_1.default.ignore_basic_report, fromZigbee_1.default.on_off, fromZigbee_1.default.brightness, legacy.fz.RM01_on_click, legacy.fz.RM01_off_click,
...
//# sourceMappingURL=busch-jaeger.js.map