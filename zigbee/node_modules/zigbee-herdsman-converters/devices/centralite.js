...
const definitions = [
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genOnOff', 'genLevelCtrl', 'haElectricalMeasurement']);
            await reporting_1.default.onOff(endpoint);
            // 4256050-ZHAC doesn't support reading 'acVoltageMultiplier' or 'acVoltageDivisor'
            await endpoint.read('haElectricalMeasurement', ['acCurrentMultiplier', 'acCurrentDivisor']);
            await endpoint.read('haElectricalMeasurement', ['acPowerMultiplier', 'acPowerDivisor']);
            await reporting_1.default.rmsVoltage(endpoint, { change: 2 }); // Voltage reports in V
            await reporting_1.default.rmsCurrent(endpoint, { change: 10 }); // Current reports in mA
            await reporting_1.default.activePower(endpoint, { change: 2 }); // Power reports in 0.1W
        },
    },
    {
    ...
    },
    {
        ...
        onEvent: async (type, data, device) => {
            if (type === 'message' && data.type === 'commandGetPanelStatus' && data.cluster === 'ssIasAce' &&
                store_1.default.hasValue(device.getEndpoint(1), 'panelStatus')) {
                const payload = {
                    panelstatus: store_1.default.getValue(device.getEndpoint(1), 'panelStatus'),
    ...
    },
    {
        ...
        toZigbee: [toZigbee_1.default.thermostat_local_temperature, toZigbee_1.default.thermostat_local_temperature_calibration,
            toZigbee_1.default.thermostat_occupied_heating_setpoint, toZigbee_1.default.thermostat_occupied_cooling_setpoint,
            toZigbee_1.default.thermostat_setpoint_raise_lower, toZigbee_1.default.thermostat_remote_sensing,
            toZigbee_1.default.thermostat_control_sequence_of_operation, toZigbee_1.default.thermostat_system_mode,
            toZigbee_1.default.thermostat_relay_status_log, toZigbee_1.default.fan_mode, toZigbee_1.default.thermostat_running_state, toZigbee_1.default.thermostat_temperature_setpoint_hold],
        exposes: [e.battery(),
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genPowerCfg', 'hvacThermostat', 'hvacFanCtrl']);
            await reporting_1.default.batteryVoltage(endpoint);
            await reporting_1.default.thermostatRunningState(endpoint);
            await reporting_1.default.thermostatTemperature(endpoint);
            await reporting_1.default.fanMode(endpoint);
            await reporting_1.default.thermostatTemperatureSetpointHold(endpoint);
        },
    },
    {
        zigbeeModel: ['3156105'],
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await endpoint.read('haElectricalMeasurement', ['acCurrentMultiplier', 'acCurrentDivisor']);
            await endpoint.read('haElectricalMeasurement', ['acPowerMultiplier', 'acPowerDivisor']);
            await reporting_1.default.rmsVoltage(endpoint, { change: 2 });
            await reporting_1.default.rmsCurrent(endpoint, { change: 10 });
            await reporting_1.default.activePower(endpoint, { change: 2 });
        },
    },
    {
        zigbeeModel: ['3200-de'],
