    ...
    wateringScheduleSlot: (timeSlotNumber) => ({
        from: (buffer) => {
            return {
                ...
                start_hour: utils.numberWithinRange(buffer.readUInt8(1), 0, 23),
                start_minute: utils.numberWithinRange(buffer.readUInt8(2), 0, 59),
                timer: utils.numberWithinRange(buffer.readUInt8(3) * 60 + buffer.readUInt8(4), 1, 599),
        ...
        to: (value, meta) => {
            ...
            return [
                ...
                startHour,
                startMinute,
                Math.floor(duratonInMin / 60),
                duratonInMin % 60,
                0,
                Math.floor(pauseInMin / 60),
                pauseInMin % 60,
                0,
...
module.exports = [
    {
        fingerprint: [
            ...
            { modelID: 'TS011F', manufacturerName: '_TZ3000_plyvnuf5' },
            { modelID: 'TS011F', manufacturerName: '_TZ3000_wamqdr3f' },
            { modelID: 'TS011F', manufacturerName: '_TZ3000_00mk2xzy' },
            { modelID: 'TS011F', manufacturerName: '_TZ3000_upjrsxh1' },
    ...
    {
        fingerprint: [
            { modelID: 'TS011F', manufacturerName: '_TZ3000_j1v25l17' },
    ...
    },
    {
        fingerprint: [
            ...
            { modelID: 'TS011F', manufacturerName: '_TZ3000_4uf3d0ax' },
            { modelID: 'TS011F', manufacturerName: '_TZ3000_vzopcetz' },
    ...
    },
    {
        ...
        exposes: [
            ...
            ...[1, 2, 3, 4, 5, 6].map((timeSlotNumber) => exposes.composite(`schedule_slot_${timeSlotNumber}`, `schedule_slot_${timeSlotNumber}`, ea.STATE_SET)
        ...
        exposes: [
            ...
            ...['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'].map((day) => {
                ...
                [1, 2, 3, 4, 5, 6, 7, 8, 9].forEach((i) => {
                    ...
                    expose.withFeature(exposes.enum(`${day}_hour_${i}`, ea.STATE_SET, ['00', '01', '02', '03', '04', '05', '06', '07', '08', '09',
