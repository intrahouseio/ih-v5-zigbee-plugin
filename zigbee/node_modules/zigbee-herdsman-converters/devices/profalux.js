...
const definitions = [
    ...
    },
    {
        ...
        vendor: 'Profalux',
        description: 'Cover',
        fromZigbee: [fromZigbee_1.default.command_cover_close, fromZigbee_1.default.command_cover_open, fromZigbee_1.default.cover_position_tilt],
        toZigbee: [toZigbee_1.default.cover_state, toZigbee_1.default.cover_position_tilt],
        options: [],
        exposes: (device, options) => {
            const endpoint = device === null || device === void 0 ? void 0 : device.getEndpoint(2);
