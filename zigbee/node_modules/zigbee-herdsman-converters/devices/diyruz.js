...
const definitions = [
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            device.endpoints.forEach(async (ep) => {
                if (ep.outputClusters.includes(18)) {
                    await reporting_1.default.bind(ep, coordinatorEndpoint, ['genMultistateInput']);
                }
            });
        },
        endpoint: (device) => {
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['msIlluminanceMeasurement', 'genOnOff']);
            const payload = [
                { attribute: { ID: 0xF001, type: 0x21 }, minimumReportInterval: 0, maximumReportInterval: constants_1.default.repInterval.MINUTE,
                    reportableChange: 0 },
                { attribute: { ID: 0xF002, type: 0x23 }, minimumReportInterval: 0, maximumReportInterval: constants_1.default.repInterval.MINUTE,
                    reportableChange: 0 }
            ];
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.ptvo_multistate_action, legacy.fz.ptvo_switch_buttons, fromZigbee_1.default.ignore_basic_report],
        extend: extend_1.default.switch(),
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.bind(firstEndpoint, coordinatorEndpoint, [
                'genPowerCfg', 'msTemperatureMeasurement', 'msRelativeHumidity', 'msPressureMeasurement',
                'msIlluminanceMeasurement', 'msSoilMoisture'
            ]);
            await reporting_1.default.bind(secondEndpoint, coordinatorEndpoint, ['msTemperatureMeasurement']);
            const overides = { min: 0, max: 3600, change: 0 };
            await reporting_1.default.batteryVoltage(firstEndpoint, overides);
            await reporting_1.default.batteryPercentageRemaining(firstEndpoint, overides);
            await reporting_1.default.temperature(firstEndpoint, overides);
            await reporting_1.default.humidity(firstEndpoint, overides);
            await reporting_1.default.pressureExtended(firstEndpoint, overides);
            await reporting_1.default.illuminance(firstEndpoint, overides);
            await reporting_1.default.soil_moisture(firstEndpoint, overides);
            await reporting_1.default.temperature(secondEndpoint, overides);
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.temperature, fromZigbee_1.default.humidity, fromZigbee_1.default.co2, fromZigbee_1.default.pressure, fromZigbee_1.default.diyruz_airsense_config_co2,
            fromZigbee_1.default.diyruz_airsense_config_temp, fromZigbee_1.default.diyruz_airsense_config_pres, fromZigbee_1.default.diyruz_airsense_config_hum],
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, clusters);
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            const firstEndpoint = device.getEndpoint(1);
            await reporting_1.default.bind(firstEndpoint, coordinatorEndpoint, ['closuresDoorLock', 'genPowerCfg']);
            const payload1 = [
                { attribute: 'batteryPercentageRemaining', minimumReportInterval: 0, maximumReportInterval: 3600, reportableChange: 0 },
                { attribute: 'batteryVoltage', minimumReportInterval: 0, maximumReportInterval: 3600, reportableChange: 0 }
            ];
