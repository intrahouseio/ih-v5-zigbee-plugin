...
const definitions = [
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, fzLocal.philips_contact],
        toZigbee: [],
    ...
    },
    {
        ...
        extend: extend_1.default.light_onoff_brightness_colortemp_color({ colorTempRange: [154, 455] }),
    },
    {
        zigbeeModel: ['LWA023'],
        model: '9290030516',
    ...
    },
    {
        ...
        extend: philips.extend.light_onoff_brightness_color(),
    },
    {
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.hue_wall_switch_device_mode, fromZigbee_1.default.hue_wall_switch, fromZigbee_1.default.command_toggle],
        exposes: [
        ...
        toZigbee: [toZigbee_1.default.hue_wall_switch_device_mode],
        configure: async (device, coordinatorEndpoint, logger) => {
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.ignore_command_on, fromZigbee_1.default.ignore_command_off, fromZigbee_1.default.ignore_command_step, fromZigbee_1.default.ignore_command_stop,
            legacy.fz.hue_dimmer_switch, fromZigbee_1.default.battery],
    ...
    },
    {
        ...
        description: 'Hue dimmer switch',
        fromZigbee: [fromZigbee_1.default.ignore_command_on, fromZigbee_1.default.ignore_command_off, fromZigbee_1.default.ignore_command_step, fromZigbee_1.default.ignore_command_stop,
            fromZigbee_1.default.hue_dimmer_switch, fromZigbee_1.default.battery, fromZigbee_1.default.command_recall],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.command_on, fromZigbee_1.default.command_off_with_effect, legacy.fz.SmartButton_skip, fromZigbee_1.default.hue_smart_button_event, fromZigbee_1.default.battery],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.occupancy, fromZigbee_1.default.temperature, fromZigbee_1.default.occupancy_timeout, fromZigbee_1.default.illuminance,
            fromZigbee_1.default.hue_motion_sensitivity, fromZigbee_1.default.hue_motion_led_indication],
        ...
        toZigbee: [toZigbee_1.default.occupancy_timeout, philips.tz.hue_motion_sensitivity, philips.tz.hue_motion_led_indication],
        endpoint: (device) => {
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.occupancy, fromZigbee_1.default.temperature, fromZigbee_1.default.illuminance, fromZigbee_1.default.occupancy_timeout,
            fromZigbee_1.default.hue_motion_sensitivity, fromZigbee_1.default.hue_motion_led_indication],
        exposes: [e.temperature(), e.occupancy(), e.battery(), e.illuminance_lux(), e.illuminance(),
            e.enum('motion_sensitivity', ea.ALL, ['low', 'medium', 'high']),
            e.binary('led_indication', ea.ALL, true, false).withDescription('Blink green LED on motion detection'),
    ...
    },
    {
        ...
        toZigbee: [toZigbee_1.default.on_off, philips.tz.hue_power_on_behavior, philips.tz.hue_power_on_error],
        configure: async (device, coordinatorEndpoint, logger) => {
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.ignore_command_step, philips.philipsFz.hue_tap_dial, fromZigbee_1.default.battery],
        toZigbee: [],
        exposes: [e.battery(),
    ...
    },
    {
        ...
        vendor: 'Philips',
        description: 'Hue tap',
        fromZigbee: [fromZigbee_1.default.hue_tap],
        toZigbee: [],
