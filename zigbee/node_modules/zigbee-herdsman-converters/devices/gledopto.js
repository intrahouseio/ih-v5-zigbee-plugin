...
const tzLocal1 = {
    gledopto_light_onoff_brightness: {
        ...
        convertSet: async (entity, key, value, meta) => {
            var _a;
            if (utils.isNumber((_a = meta.message) === null || _a === void 0 ? void 0 : _a.transition)) {
            ...
            if (meta.mapped.model === 'GL-S-007ZS' || meta.mapped.model === 'GL-C-009') {
                ...
                if (typeof meta.message.state === 'string' && meta.message.state.toLowerCase() === 'on') {
                    await toZigbee_1.default.on_off.convertSet(entity, key, 'ON', meta);
        ...
        convertGet: async (entity, key, meta) => {
            return await toZigbee_1.default.light_onoff_brightness.convertGet(entity, key, meta);
        },
    },
    gledopto_light_colortemp: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            const result = await toZigbee_1.default.light_colortemp.convertSet(entity, key, value, meta);
            if (result) {
        ...
        convertGet: async (entity, key, meta) => {
            return await toZigbee_1.default.light_colortemp.convertGet(entity, key, meta);
        },
    },
    gledopto_light_color: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            // https://github.com/Koenkk/zigbee2mqtt/issues/3509
            const state = { state: 'ON' };
            const result = await toZigbee_1.default.light_color.convertSet(entity, key, value, meta);
            if (result) {
                result.state = { ...result.state, ...state };
            }
            return result;
        ...
        convertGet: async (entity, key, meta) => {
            return await toZigbee_1.default.light_color.convertGet(entity, key, meta);
        },
    },
};
const tzLocal = {
    ...
    gledopto_light_color_colortemp: {
        ...
        convertGet: async (entity, key, meta) => {
            return await toZigbee_1.default.light_color_colortemp.convertGet(entity, key, meta);
        },
    },
};
const gledoptoExtend = {
    light_onoff_brightness: (options = {}) => ({
        ...extend_1.default.light_onoff_brightness({ disablePowerOnBehavior: true, ...options }),
        toZigbee: utils.replaceInArray(extend_1.default.light_onoff_brightness(options).toZigbee, [toZigbee_1.default.light_onoff_brightness], [tzLocal.gledopto_light_onoff_brightness]),
    }),
    light_onoff_brightness_colortemp: (options = {}) => ({
        ...extend_1.default.light_onoff_brightness_colortemp({ disablePowerOnBehavior: true, ...options }),
        toZigbee: utils.replaceInArray(extend_1.default.light_onoff_brightness_colortemp(options).toZigbee, [toZigbee_1.default.light_onoff_brightness, toZigbee_1.default.light_colortemp], [tzLocal.gledopto_light_onoff_brightness, tzLocal.gledopto_light_colortemp]),
    }),
    light_onoff_brightness_color: (options = {}) => ({
        ...extend_1.default.light_onoff_brightness_color({ disablePowerOnBehavior: true, supportsHueAndSaturation: true, ...options }),
        toZigbee: utils.replaceInArray(extend_1.default.light_onoff_brightness_color(options).toZigbee, [toZigbee_1.default.light_onoff_brightness, toZigbee_1.default.light_color], [tzLocal.gledopto_light_onoff_brightness, tzLocal.gledopto_light_color]),
    }),
    light_onoff_brightness_colortemp_color: (options = {}) => ({
        ...extend_1.default.light_onoff_brightness_colortemp_color({ disablePowerOnBehavior: true, supportsHueAndSaturation: true, ...options }),
        toZigbee: utils.replaceInArray(extend_1.default.light_onoff_brightness_colortemp_color(options).toZigbee, [toZigbee_1.default.light_onoff_brightness, toZigbee_1.default.light_color_colortemp], [tzLocal.gledopto_light_onoff_brightness, tzLocal.gledopto_light_color_colortemp]),
    }),
    switch: (options = {}) => ({
        ...extend_1.default.switch({ disablePowerOnBehavior: true, ...options }),
...
const definitions = [
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            await extend_1.default.light_onoff_brightness_color().configure(device, coordinatorEndpoint, logger);
            await configureReadModelID(device, coordinatorEndpoint, logger);
        },
    },
    {
    ...
    },
    {
        ...
        extend: extend_1.default.light_onoff_brightness_colortemp_color({ colorTempRange: [158, 495] }),
    },
    {
...
//# sourceMappingURL=gledopto.js.map