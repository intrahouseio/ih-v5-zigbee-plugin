...
const definitions = [
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.thermostat, fromZigbee_1.default.thermostat_weekly_schedule, fromZigbee_1.default.hvac_user_interface,
            fromZigbee_1.default.danfoss_thermostat, fromZigbee_1.default.danfoss_thermostat_setpoint_scheduled],
        toZigbee: [toZigbee_1.default.danfoss_thermostat_occupied_heating_setpoint, toZigbee_1.default.thermostat_local_temperature, toZigbee_1.default.danfoss_mounted_mode_active,
            toZigbee_1.default.danfoss_mounted_mode_control, toZigbee_1.default.danfoss_thermostat_vertical_orientation, toZigbee_1.default.danfoss_algorithm_scale_factor,
            toZigbee_1.default.danfoss_heat_available, toZigbee_1.default.danfoss_heat_required, toZigbee_1.default.danfoss_day_of_week, toZigbee_1.default.danfoss_trigger_time,
            toZigbee_1.default.danfoss_window_open_internal, toZigbee_1.default.danfoss_window_open_external, toZigbee_1.default.danfoss_load_estimate,
            toZigbee_1.default.danfoss_viewing_direction, toZigbee_1.default.danfoss_external_measured_room_sensor, toZigbee_1.default.danfoss_radiator_covered,
            toZigbee_1.default.thermostat_keypad_lockout, toZigbee_1.default.thermostat_system_mode, toZigbee_1.default.danfoss_load_balancing_enable, toZigbee_1.default.danfoss_load_room_mean,
            toZigbee_1.default.thermostat_weekly_schedule, toZigbee_1.default.thermostat_clear_weekly_schedule, toZigbee_1.default.thermostat_programming_operation_mode,
            toZigbee_1.default.danfoss_window_open_feature, toZigbee_1.default.danfoss_preheat_status, toZigbee_1.default.danfoss_adaptation_status, toZigbee_1.default.danfoss_adaptation_settings,
            toZigbee_1.default.danfoss_adaptation_control, toZigbee_1.default.danfoss_regulation_setpoint_offset,
        ...
        exposes: [e.battery(), e.keypad_lockout(), e.programming_operation_mode(),
            ...
            e.enum('window_open_internal', ea.STATE_GET, ['quarantine', 'closed', 'hold', 'open', 'external_open'])
            ...
            e.enum('day_of_week', ea.ALL, ['sunday', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'away_or_vacation'])
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genPowerCfg', 'hvacThermostat']);
            ...
            await reporting_1.default.thermostatPIHeatingDemand(endpoint);
            await reporting_1.default.thermostatOccupiedHeatingSetpoint(endpoint);
            // danfoss attributes
            await endpoint.configureReporting('hvacThermostat', [{
                    attribute: 'danfossMountedModeActive',
                    minimumReportInterval: constants_1.default.repInterval.MINUTE,
                    maximumReportInterval: constants_1.default.repInterval.MAX,
                    reportableChange: 1,
                }], options);
            await endpoint.configureReporting('hvacThermostat', [{
            ...
            const time = Math.round(((new Date()).getTime() - constants_1.default.OneJanuary2000) / 1000);
    ...
    {
        fingerprint: [
            { modelID: '0x8020', manufacturerName: 'Danfoss' },
            { modelID: '0x8021', manufacturerName: 'Danfoss' },
            { modelID: '0x8030', manufacturerName: 'Danfoss' },
            { modelID: '0x8031', manufacturerName: 'Danfoss' },
            { modelID: '0x8034', manufacturerName: 'Danfoss' },
            { modelID: '0x8035', manufacturerName: 'Danfoss' }
        ],
        model: 'Icon',
        vendor: 'Danfoss',
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            for (let i = 1; i <= 15; i++) {
                ...
                if (typeof endpoint !== 'undefined') {
                    ...
                    await reporting_1.default.batteryPercentageRemaining(endpoint, { min: constants_1.default.repInterval.HOUR, max: 43200, change: 1 });
                    await reporting_1.default.thermostatTemperature(endpoint, { min: 0, max: constants_1.default.repInterval.MINUTES_10, change: 10 });
                    await reporting_1.default.thermostatOccupiedHeatingSetpoint(endpoint, { min: 0, max: constants_1.default.repInterval.MINUTES_10, change: 10 });
                    await endpoint.configureReporting('hvacThermostat', [{
                            attribute: 'danfossOutputStatus',
                            minimumReportInterval: constants_1.default.repInterval.MINUTE,
                            maximumReportInterval: constants_1.default.repInterval.MINUTES_10,
                            reportableChange: 1,
                        }], options);
            ...
            await reporting_1.default.bind(endpoint232, coordinatorEndpoint, ['haDiagnostic']);
