...
const intToFanMode = (value) => {
    ...
    Object.values(fanModes).forEach((mode) => {
        if (value >= mode) {
            selectedMode = Object.keys(fanModes).find((key) => fanModes[key] === mode) || 'Low';
        }
    });
    return selectedMode;
};
    ...
    light_onoff_brightness_inovelli: {
        ...
        convertSet: async (entity, key, value, meta) => {
             ...
             */
                        ...
                        const defaultTransitionTime = await entity.read('manuSpecificInovelli', ['rampRateOffToOnRemote']);
                        return {
                            state: { state: 'ON' },
