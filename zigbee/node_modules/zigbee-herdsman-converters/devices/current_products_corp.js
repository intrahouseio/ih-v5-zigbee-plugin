...
const definitions = [
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genPowerCfg', 'closuresWindowCovering']);
            await reporting_1.default.batteryPercentageRemaining(endpoint);
            await reporting_1.default.currentPositionTiltPercentage(endpoint);
        },
