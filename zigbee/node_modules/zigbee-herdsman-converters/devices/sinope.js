...
const definitions = [
    ...
    },
    {
        ...
        toZigbee: [toZigbee_1.default.thermostat_local_temperature, toZigbee_1.default.thermostat_occupied_heating_setpoint, toZigbee_1.default.thermostat_unoccupied_heating_setpoint,
            ...
            tzLocal.floor_max_heat_setpoint, tzLocal.temperature_sensor, toZigbee_1.default.electrical_measurement_power],
        exposes: [
            e.climate()
    ...
    },
    {
        ...
        toZigbee: [toZigbee_1.default.thermostat_local_temperature, toZigbee_1.default.thermostat_occupied_heating_setpoint, toZigbee_1.default.thermostat_unoccupied_heating_setpoint,
            ...
            tzLocal.thermostat_outdoor_temperature, tzLocal.outdoor_temperature_timeout, tzLocal.thermostat_occupancy,
            tzLocal.floor_control_mode, tzLocal.ambiant_max_heat_setpoint, tzLocal.floor_min_heat_setpoint,
            tzLocal.floor_max_heat_setpoint, tzLocal.temperature_sensor, toZigbee_1.default.thermostat_min_heat_setpoint_limit,
            toZigbee_1.default.thermostat_max_heat_setpoint_limit, tzLocal.connected_load, tzLocal.aux_connected_load, tzLocal.main_cycle_output,
    ...
    },
    {
        ...
        toZigbee: [toZigbee_1.default.on_off, tzLocal.timer_seconds, tzLocal.led_intensity_on, tzLocal.led_intensity_off,
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.brightness, fromZigbee_1.default.electrical_measurement, fzLocal.sinope],
        toZigbee: [toZigbee_1.default.light_onoff_brightness, tzLocal.timer_seconds, tzLocal.led_intensity_on, tzLocal.led_intensity_off,
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.ignore_iaszone_statuschange, fromZigbee_1.default.cover_position_via_brightness, fromZigbee_1.default.cover_state_via_onoff,
            fromZigbee_1.default.battery, fromZigbee_1.default.metering],
        toZigbee: [toZigbee_1.default.cover_via_brightness],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.electrical_measurement, fromZigbee_1.default.metering, fzLocal.ias_water_leak_alarm,
            fzLocal.sinope, fromZigbee_1.default.temperature],
        toZigbee: [toZigbee_1.default.on_off, tzLocal.low_water_temp_protection],
        exposes: [e.switch(),
