...
const definitions = [
    ...
    },
    {
        ...
        exposes: extend_1.default.light_onoff_brightness({ noConfigure: true }).exposes.concat([e.energy(), e.power()]),
        fromZigbee: extend_1.default.light_onoff_brightness({ noConfigure: true }).fromZigbee.concat([fromZigbee_1.default.metering]),
        extend: extend_1.default.light_onoff_brightness({ noConfigure: true }),
        configure: async (device, coordinatorEndpoint, logger) => {
            await extend_1.default.light_onoff_brightness().configure(device, coordinatorEndpoint, logger);
            const endpoint = device.getEndpoint(1);
