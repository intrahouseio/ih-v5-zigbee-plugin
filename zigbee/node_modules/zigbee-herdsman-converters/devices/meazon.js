...
const definitions = [
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.onOff(endpoint, { min: 1, max: 0xfffe });
            ...
            await endpoint.configureReporting('seMetering', [{ reportableChange: 1, attribute: { ID: 0x2000, type: 0x29 },
                    minimumReportInterval: 1, maximumReportInterval: constants_1.default.repInterval.MINUTES_5 }], options);
        },
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await endpoint.configureReporting('seMetering', [{ attribute: { ID: 0x2000, type: 0x29 },
                    minimumReportInterval: 1, maximumReportInterval: constants_1.default.repInterval.MINUTES_5, reportableChange: 1 }], options);
        },
    },
];
