...
const definitions = [
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.ignore_basic_report, fromZigbee_1.default.ignore_haDiagnostic, fromZigbee_1.default.ignore_genOta, fromZigbee_1.default.ignore_zclversion_read,
            legacy.fz.wiser_thermostat, legacy.fz.wiser_itrv_battery, fromZigbee_1.default.hvac_user_interface, fromZigbee_1.default.wiser_device_info],
        toZigbee: [toZigbee_1.default.thermostat_occupied_heating_setpoint, toZigbee_1.default.thermostat_keypad_lockout],
    ...
    },
    {
        ...
        fromZigbee: [...extend_1.default.light_onoff_brightness().fromZigbee, fromZigbee_1.default.wiser_lighting_ballast_configuration],
        toZigbee: [...extend_1.default.light_onoff_brightness().toZigbee, toZigbee_1.default.ballast_config, toZigbee_1.default.wiser_dimmer_mode],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.brightness, fromZigbee_1.default.level_config, fromZigbee_1.default.wiser_lighting_ballast_configuration],
        toZigbee: [toZigbee_1.default.light_onoff_brightness, toZigbee_1.default.level_config, toZigbee_1.default.ballast_config, toZigbee_1.default.wiser_dimmer_mode],
        exposes: [e.light_brightness().withLevelConfig(),
            e.numeric('ballast_minimum_level', ea.ALL).withValueMin(1).withValueMax(254)
                .withDescription('Specifies the minimum light output of the ballast'),
            e.numeric('ballast_maximum_level', ea.ALL).withValueMin(1).withValueMax(254)
    ...
    },
    {
        ...
        vendor: 'Schneider Electric',
        description: 'Push button dimmer',
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.brightness, fromZigbee_1.default.level_config, fromZigbee_1.default.lighting_ballast_configuration],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.brightness, fromZigbee_1.default.level_config, fromZigbee_1.default.lighting_ballast_configuration, fzLocal.indicator_mode],
        toZigbee: [toZigbee_1.default.light_onoff_brightness, toZigbee_1.default.level_config, toZigbee_1.default.ballast_config, tzLocal.indicator_mode],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.cover_position_tilt, fromZigbee_1.default.command_cover_close, fromZigbee_1.default.command_cover_open, fromZigbee_1.default.command_cover_stop],
        toZigbee: [toZigbee_1.default.cover_position_tilt, toZigbee_1.default.cover_state, tzLocal.lift_duration],
        exposes: [e.cover_position(), e.numeric('lift_duration', ea.STATE_SET).withUnit('s')
                .withValueMin(0).withValueMax(300).withDescription('Duration of lift')],
        meta: { coverInverted: true },
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.brightness, fromZigbee_1.default.level_config, fromZigbee_1.default.schneider_lighting_ballast_configuration, fromZigbee_1.default.command_recall,
            fromZigbee_1.default.command_on, fromZigbee_1.default.command_off, fromZigbee_1.default.command_move, fromZigbee_1.default.command_stop],
        toZigbee: [toZigbee_1.default.light_onoff_brightness, toZigbee_1.default.level_config, toZigbee_1.default.ballast_config, toZigbee_1.default.schneider_dimmer_mode],
        endpoint: (device) => {
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.thermostat, fromZigbee_1.default.metering, fromZigbee_1.default.schneider_pilot_mode],
        toZigbee: [toZigbee_1.default.schneider_temperature_measured_value, toZigbee_1.default.thermostat_system_mode, toZigbee_1.default.thermostat_running_state,
            toZigbee_1.default.thermostat_local_temperature, toZigbee_1.default.thermostat_occupied_heating_setpoint, toZigbee_1.default.thermostat_control_sequence_of_operation,
            toZigbee_1.default.schneider_pilot_mode, toZigbee_1.default.schneider_temperature_measured_value],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.schneider_temperature, fromZigbee_1.default.humidity, fromZigbee_1.default.thermostat, fromZigbee_1.default.schneider_ui_action],
        toZigbee: [toZigbee_1.default.schneider_thermostat_system_mode, toZigbee_1.default.schneider_thermostat_occupied_heating_setpoint,
            toZigbee_1.default.schneider_thermostat_control_sequence_of_operation, toZigbee_1.default.schneider_thermostat_pi_heating_demand,
            toZigbee_1.default.schneider_thermostat_keypad_lockout],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.ignore_basic_report, fromZigbee_1.default.ignore_genOta, fromZigbee_1.default.ignore_zclversion_read, fromZigbee_1.default.battery, fromZigbee_1.default.hvac_user_interface,
            fromZigbee_1.default.wiser_smart_thermostat, fromZigbee_1.default.wiser_smart_thermostat_client, fromZigbee_1.default.wiser_smart_setpoint_command_client],
        toZigbee: [toZigbee_1.default.wiser_sed_thermostat_local_temperature_calibration, toZigbee_1.default.wiser_sed_occupied_heating_setpoint,
            toZigbee_1.default.wiser_sed_thermostat_keypad_lockout, toZigbee_1.default.wiser_vact_calibrate_valve, toZigbee_1.default.wiser_sed_zone_mode],
        exposes: [e.battery(),
            ...
            e.enum('zone_mode', ea.STATE_SET, ['manual', 'schedule', 'energy_saver', 'holiday'])
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.ignore_basic_report, fromZigbee_1.default.ignore_genOta, fromZigbee_1.default.ignore_zclversion_read, fromZigbee_1.default.battery, fromZigbee_1.default.hvac_user_interface,
            fromZigbee_1.default.wiser_smart_thermostat_client, fromZigbee_1.default.wiser_smart_setpoint_command_client, fromZigbee_1.default.schneider_temperature],
        toZigbee: [toZigbee_1.default.wiser_sed_zone_mode, toZigbee_1.default.wiser_sed_occupied_heating_setpoint],
        exposes: [e.battery(),
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.ignore_basic_report, fromZigbee_1.default.ignore_genOta, fromZigbee_1.default.ignore_zclversion_read, fromZigbee_1.default.wiser_smart_thermostat, fromZigbee_1.default.metering,
            fromZigbee_1.default.identify],
        toZigbee: [toZigbee_1.default.thermostat_local_temperature, toZigbee_1.default.thermostat_occupied_heating_setpoint, toZigbee_1.default.wiser_fip_setting,
            toZigbee_1.default.wiser_hact_config, toZigbee_1.default.wiser_zone_mode, toZigbee_1.default.identify],
        exposes: [e.climate().withSetpoint('occupied_heating_setpoint', 7, 30, 0.5).withLocalTemperature(),
            ...
            e.enum('hact_config', ea.ALL, ['unconfigured', 'setpoint_switch', 'setpoint_fip', 'fip_fip'])
                .withDescription('Input (command) and output (control) behavior of actuator'),
            e.enum('fip_setting', ea.ALL, ['comfort', 'comfort_-1', 'comfort_-2', 'energy_saving', 'frost_protection', 'off'])
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.electrical_measurement, fromZigbee_1.default.EKO09738_metering, fromZigbee_1.default.power_on_behavior],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.illuminance, fromZigbee_1.default.occupancy, fromZigbee_1.default.occupancy_timeout],
        ...
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.occupancy_timeout],
        endpoint: (device) => {
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.ias_enroll, fromZigbee_1.default.ias_occupancy_only_alarm_2, fromZigbee_1.default.illuminance],
        toZigbee: [],
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.temperature, fromZigbee_1.default.battery, fromZigbee_1.default.ias_enroll, fromZigbee_1.default.ias_smoke_alarm_1],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.ias_contact_alarm_1, fromZigbee_1.default.ias_contact_alarm_1_report],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.stelpro_thermostat, fromZigbee_1.default.metering, fromZigbee_1.default.schneider_pilot_mode, fromZigbee_1.default.wiser_device_info, fromZigbee_1.default.hvac_user_interface],
        toZigbee: [toZigbee_1.default.thermostat_occupied_heating_setpoint, toZigbee_1.default.thermostat_system_mode, toZigbee_1.default.thermostat_running_state,
            toZigbee_1.default.thermostat_local_temperature, toZigbee_1.default.thermostat_control_sequence_of_operation, toZigbee_1.default.schneider_pilot_mode,
            toZigbee_1.default.schneider_thermostat_keypad_lockout, toZigbee_1.default.thermostat_temperature_display_mode],
