...
const definitions = [
    {
        ...
        fromZigbee: [...extend_1.default.light_onoff_brightness({ noConfigure: true }).fromZigbee,
            fromZigbee_1.default.command_on, fromZigbee_1.default.command_off, fromZigbee_1.default.command_move, fromZigbee_1.default.command_stop, legacy.fz.ZB006X_settings],
        toZigbee: [...extend_1.default.light_onoff_brightness({ noConfigure: true }).toZigbee, legacy.tz.ZB006X_settings],
