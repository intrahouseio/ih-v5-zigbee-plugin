...
const definitions = [
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.bind(ep, coordinatorEndpoint, ['genBasic', 'genOnOff', 'genLevelCtrl', 'lightingColorCtrl']);
        },
    },
    {
        zigbeeModel: ['RC 250'],
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            const ep = device.getEndpoint(1);
            await reporting_1.default.bind(ep, coordinatorEndpoint, ['genBasic', 'genGroups', 'genScenes',
    ...
    },
    {
        ...
        extend: extend_1.default.light_onoff_brightness_colortemp_color({ colorTempRange: [100, 1000], supportsHueAndSaturation: true }),
        meta: { applyRedFix: true, turnsOffAtBrightness1: true },
    },
    {
        ...
        extend: extend_1.default.light_onoff_brightness_colortemp_color({ colorTempRange: [153, 555], supportsHueAndSaturation: true, disableColorTempStartup: true }),
        meta: { applyRedFix: true, turnsOffAtBrightness1: true },
    },
    {
    ...
    },
    {
        ...
        extend: extend_1.default.light_onoff_brightness_colortemp_color({ colorTempRange: [100, 350], supportsHueAndSaturation: true }),
        meta: { applyRedFix: true, turnsOffAtBrightness1: true },
    },
    {
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            await reporting_1.default.bind(device.getEndpoint(1), coordinatorEndpoint, ['genBasic', 'genGroups', 'genScenes', 'genOnOff', 'genLevelCtrl']);
