...
const definitions = [
    {
        ...
        fromZigbee: [fromZigbee_1.default.lock, fromZigbee_1.default.battery],
        toZigbee: [toZigbee_1.default.lock, toZigbee_1.default.lock_auto_relock_time, toZigbee_1.default.lock_sound_volume],
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.rmsCurrent(endpoint, { change: 5 });
            await reporting_1.default.activePower(endpoint, { change: 2 });
            await reporting_1.default.currentSummDelivered(endpoint, 2);
