...
const sunricherManufacturer = { manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.SHENZHEN_SUNRICH };
const fzLocal = {
    namron_panelheater: {
    ...
    namron_panelheater: {
        ...
        convertSet: async (entity, key, value, meta) => {
            if (key === 'display_brightnesss') {
                const payload = { 0x1000: { value: value, type: zigbee_herdsman_1.Zcl.DataType.enum8 } };
                ...
                const payload = { 0x1009: { value: utils.getFromLookup(value, lookup), type: zigbee_herdsman_1.Zcl.DataType.enum8 } };
                await entity.write('hvacThermostat', payload, sunricherManufacturer);
            }
...
const definitions = [
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.metering, fromZigbee_1.default.electrical_measurement],
    ...
    },
    {
        ...
        extend: extend_1.default.light_onoff_brightness_colortemp({ noConfigure: true, disableEffect: true, colorTempRange: [250, 65279] }),
        meta: { disableDefaultResponse: true },
        configure: async (device, coordinatorEndpoint, logger) => {
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.command_on, fromZigbee_1.default.command_off, fromZigbee_1.default.battery, fromZigbee_1.default.command_move, fromZigbee_1.default.command_stop, fromZigbee_1.default.command_step],
        exposes: [e.battery(), e.action([
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.command_on, fromZigbee_1.default.command_off, fromZigbee_1.default.command_move_to_level, fromZigbee_1.default.command_move_to_color_temp,
            fromZigbee_1.default.command_move_to_hue, fromZigbee_1.default.ignore_genOta],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.command_on, fromZigbee_1.default.command_off, fromZigbee_1.default.command_step, fromZigbee_1.default.command_step_color_temperature, fromZigbee_1.default.command_recall,
            fromZigbee_1.default.command_move_to_color_temp, fromZigbee_1.default.battery, fromZigbee_1.default.command_move_to_hue],
        exposes: [e.battery(), e.action([
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.command_on, fromZigbee_1.default.command_off, fromZigbee_1.default.battery, fromZigbee_1.default.command_move, fromZigbee_1.default.command_stop, fromZigbee_1.default.command_recall],
        toZigbee: [],
        ota: ota.zigbeeOTA,
        exposes: [e.battery(), e.action([
                'on_l1', 'off_l1', 'brightness_move_up_l1', 'brightness_move_down_l1', 'brightness_stop_l1',
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.thermostat, fromZigbee_1.default.namron_thermostat, fromZigbee_1.default.metering, fromZigbee_1.default.electrical_measurement,
            fromZigbee_1.default.namron_hvac_user_interface],
        toZigbee: [toZigbee_1.default.thermostat_occupied_heating_setpoint, toZigbee_1.default.thermostat_unoccupied_heating_setpoint, toZigbee_1.default.thermostat_occupancy,
            toZigbee_1.default.thermostat_local_temperature_calibration, toZigbee_1.default.thermostat_local_temperature, toZigbee_1.default.thermostat_outdoor_temperature,
            toZigbee_1.default.thermostat_system_mode, toZigbee_1.default.thermostat_control_sequence_of_operation, toZigbee_1.default.thermostat_running_state,
            toZigbee_1.default.namron_thermostat_child_lock, toZigbee_1.default.namron_thermostat],
        exposes: [
            e.local_temperature(),
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.thermostat, fromZigbee_1.default.metering, fromZigbee_1.default.electrical_measurement, fzLocal.namron_panelheater, fromZigbee_1.default.namron_hvac_user_interface],
        toZigbee: [toZigbee_1.default.thermostat_occupied_heating_setpoint, toZigbee_1.default.thermostat_local_temperature_calibration, toZigbee_1.default.thermostat_system_mode,
            toZigbee_1.default.thermostat_running_state, toZigbee_1.default.thermostat_local_temperature, tzLocal.namron_panelheater, toZigbee_1.default.namron_thermostat_child_lock],
        exposes: [e.power(), e.current(), e.voltage(), e.energy(),
            e.climate()
    ...
    },
    {
        ...
        extend: extend_1.default.light_onoff_brightness_colortemp({ colorTempRange: [153, 555] }),
        meta: { turnsOffAtBrightness1: true },
    },
    {
        zigbeeModel: ['4512749'],
        ...
        fromZigbee: [fromZigbee_1.default.metering, fromZigbee_1.default.electrical_measurement, fromZigbee_1.default.on_off, fromZigbee_1.default.temperature],
