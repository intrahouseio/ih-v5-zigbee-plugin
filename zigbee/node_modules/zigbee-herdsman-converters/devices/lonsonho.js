...
const definitions = [
    ...
    },
    {
        ...
        extend: extend_1.default.light_onoff_brightness_colortemp_color({ disableColorTempStartup: true, colorTempRange: [153, 500], disableEffect: true, disablePowerOnBehavior: true }),
    },
    {
    ...
    },
    {
        ...
        toZigbee: [toZigbee_1.default.power_on_behavior, toZigbee_1.default.TYZB01_on_off],
        configure: async (device, coordinatorEndpoint, logger) => {
            await reporting.bind(device.getEndpoint(1), coordinatorEndpoint, ['genOnOff']);
        },
    },
