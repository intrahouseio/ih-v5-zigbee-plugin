...
const definitions = [
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genPowerCfg', 'genBinaryInput']);
            await reporting_1.default.batteryVoltage(endpoint);
            await reporting_1.default.presentValue(endpoint);
        },
    },
    {
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['msTemperatureMeasurement', 'genPowerCfg', 'manuSpecificSamsungAccelerometer']);
            await reporting_1.default.temperature(endpoint);
            await reporting_1.default.batteryVoltage(endpoint);
            const payloadA = reporting_1.default.payload('acceleration', 10, constants_1.default.repInterval.MINUTE, 1);
            await endpoint.configureReporting('manuSpecificSamsungAccelerometer', payloadA, options);
            const payloadX = reporting_1.default.payload('x_axis', 10, constants_1.default.repInterval.MINUTE, 1);
            await endpoint.configureReporting('manuSpecificSamsungAccelerometer', payloadX, options);
            const payloadY = reporting_1.default.payload('y_axis', 10, constants_1.default.repInterval.MINUTE, 1);
            await endpoint.configureReporting('manuSpecificSamsungAccelerometer', payloadY, options);
            const payloadZ = reporting_1.default.payload('z_axis', 10, constants_1.default.repInterval.MINUTE, 1);
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genOnOff', 'haElectricalMeasurement']);
            ...
            await reporting_1.default.rmsVoltage(endpoint, { max: 600, change: 3 });
            // Limit updates to 0.01A and max 600s (10m)
            await reporting_1.default.rmsCurrent(endpoint, { max: 600, change: 10 });
            // Limit updates to 4.0W and max 600s (10m)
            await reporting_1.default.activePower(endpoint, { max: 600, change: 40 });
        },
    ...
    },
    {
        ...
        extend: extend_1.default.switch({ fromZigbee: [fromZigbee_1.default.electrical_measurement, fromZigbee_1.default.metering], exposes: [e.power(), e.energy()] }),
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.activePower(endpoint);
            await reporting_1.default.rmsCurrent(endpoint);
            await reporting_1.default.rmsVoltage(endpoint, { change: 10 });
        },
        exposes: [e.switch(), e.power(), e.current(), e.voltage()],
    },
    {
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            const payloadA = reporting_1.default.payload('acceleration', 10, constants_1.default.repInterval.HOUR, 5);
            await endpoint.configureReporting('manuSpecificSamsungAccelerometer', payloadA, options);
            const payloadX = reporting_1.default.payload('x_axis', 10, constants_1.default.repInterval.HOUR, 5);
            await endpoint.configureReporting('manuSpecificSamsungAccelerometer', payloadX, options);
            const payloadY = reporting_1.default.payload('y_axis', 10, constants_1.default.repInterval.HOUR, 5);
            await endpoint.configureReporting('manuSpecificSamsungAccelerometer', payloadY, options);
            const payloadZ = reporting_1.default.payload('z_axis', 10, constants_1.default.repInterval.HOUR, 5);
            await endpoint.configureReporting('manuSpecificSamsungAccelerometer', payloadZ, options);
        },
        exposes: [
            e.temperature(), e.contact(), e.battery_low(), e.tamper(), e.battery(),
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genPowerCfg', 'msTemperatureMeasurement']);
            await reporting_1.default.batteryVoltage(endpoint);
            await reporting_1.default.temperature(endpoint);
            device.powerSource = 'Battery';
            device.save();
    ...
    },
    {
        ...
        vendor: 'SmartThings',
        description: 'Button',
        fromZigbee: [fromZigbee_1.default.command_status_change_notification_action, legacy.fz.st_button_state, fromZigbee_1.default.battery, fromZigbee_1.default.temperature,
