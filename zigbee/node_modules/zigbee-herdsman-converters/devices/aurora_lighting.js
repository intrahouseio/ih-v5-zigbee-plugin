...
const tzLocal = {
    aOneBacklight: {
        ...
        convertSet: async (entity, key, value, meta) => {
            (0, utils2_1.assertString)(value, 'backlight_led');
            const state = value.toLowerCase();
            utils_1.default.validateValue(state, ['toggle', 'off', 'on']);
    ...
    backlight_brightness: {
        ...
        convertSet: async (entity, key, value, meta) => {
            await entity.command('genLevelCtrl', 'moveToLevel', { level: value, transtime: 0 }, utils_1.default.getOptions(meta.mapped, entity));
...
const disableBatteryRotaryDimmerReporting = async (endpoint) => {
    ...
    await reporting_1.default.brightness(endpoint, { max: 0xFFFF });
    await reporting_1.default.onOff(endpoint, { max: 0xFFFF });
};
const batteryRotaryDimmer = (...endpointsIds) => ({
    ...
    configure: (async (device, coordinatorEndpoint, logger) => {
        ...
        await reporting_1.default.batteryVoltage(endpoints[0]);
        for await (const endpoint of endpoints) {
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genIdentify', 'genOnOff', 'genLevelCtrl', 'lightingColorCtrl']);
...
const definitions = [
    {
        ...
        extend: extend_1.default.light_onoff_brightness_colortemp({ colorTempRange: [200, 454] }),
    },
    {
        ...
        extend: extend_1.default.light_onoff_brightness_colortemp_color({ colorTempRange: [166, 400] }),
    },
    {
    ...
    },
    {
        ...
        extend: extend_1.default.light_onoff_brightness_colortemp({ colorTempRange: [200, 455] }),
    },
    {
    ...
    },
    {
        ...
        extend: extend_1.default.light_onoff_brightness({ disableEffect: true }),
    },
    {
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genOnOff', 'genLevelCtrl', 'genPowerCfg', 'genScenes']);
        },
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['msIlluminanceMeasurement']);
    ...
    },
    {
        ...
        exposes: [...extend_1.default.light_onoff_brightness({ noConfigure: true }).exposes,
            e.binary('backlight_led', ea.STATE_SET, 'ON', 'OFF').withDescription('Enable or disable the blue backlight LED')],
        toZigbee: [...extend_1.default.light_onoff_brightness({ noConfigure: true }).toZigbee, tzLocal.aOneBacklight],
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            const endpoint = device.getEndpoint(1);
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genLevelCtrl', 'genOnOff']);
        },
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.bind(endpoint1, coordinatorEndpoint, ['genIdentify', 'genOnOff', 'haElectricalMeasurement']);
            await reporting_1.default.onOff(endpoint1);
            const endpoint2 = device.getEndpoint(2);
            await reporting_1.default.bind(endpoint2, coordinatorEndpoint, ['genIdentify', 'genOnOff', 'haElectricalMeasurement']);
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genOnOff', 'genIdentify', 'haElectricalMeasurement', 'seMetering',
                'genDeviceTempCfg']);
            await reporting_1.default.onOff(endpoint);
            ...
            await reporting_1.default.rmsVoltage(endpoint, { change: 500 });
            await reporting_1.default.rmsCurrent(endpoint, { change: 500 });
            await reporting_1.default.activePower(endpoint, { change: 5 });
            await reporting_1.default.readMeteringMultiplierDivisor(endpoint);
            await reporting_1.default.instantaneousDemand(endpoint, { change: 500 });
        },
    },
    {
