...
const definitions = [
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            await reporting_1.default.bind(device.getEndpoint(16), coordinatorEndpoint, ['genOnOff']);
            await reporting_1.default.bind(device.getEndpoint(17), coordinatorEndpoint, ['genOnOff']);
        },
    },
    {
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            await reporting_1.default.bind(device.getEndpoint(16), coordinatorEndpoint, ['genOnOff']);
            await reporting_1.default.bind(device.getEndpoint(17), coordinatorEndpoint, ['genOnOff']);
            await reporting_1.default.bind(device.getEndpoint(18), coordinatorEndpoint, ['genOnOff']);
        },
    },
    {
