...
const definitions = [
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genPowerCfg', 'hvacThermostat']);
            await reporting_1.default.bind(endpoint2, coordinatorEndpoint, ['msOccupancySensing']);
            await reporting_1.default.thermostatTemperature(endpoint);
            await reporting_1.default.thermostatRunningState(endpoint);
            await reporting_1.default.thermostatOccupiedHeatingSetpoint(endpoint);
            await reporting_1.default.thermostatUnoccupiedHeatingSetpoint(endpoint);
            await reporting_1.default.thermostatTemperatureCalibration(endpoint);
            await reporting_1.default.occupancy(endpoint2);
        },
    },
];
