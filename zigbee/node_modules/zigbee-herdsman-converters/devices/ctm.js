...
const tzLocal = {
    ...
    ctm_relay_state: {
        key: ['state'],
        convertSet: async (entity, key, value, meta) => {
            await entity.write('genOnOff', { 0x5001: { value: utils.getFromLookup(value, { 'OFF': 0, 'ON': 1 }), type: dataType.boolean } }, { manufacturerCode: 0x1337 });
        },
        convertGet: async (entity, key, meta) => {
    ...
    ctm_temperature_offset: {
        ...
        convertSet: async (entity, key, value, meta) => {
            await entity.write('msTemperatureMeasurement', { 0x0400: { value: value, type: dataType.int8 } }, { manufacturerCode: 0x1337, sendWhen: 'active' });
        },
        convertGet: async (entity, key, meta) => {
...
const definitions = [
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.temperature, fromZigbee_1.default.battery, fromZigbee_1.default.command_on, fromZigbee_1.default.command_off, fromZigbee_1.default.ias_enroll, fromZigbee_1.default.ias_smoke_alarm_1,
