...
const definitions = [
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.rmsVoltage(endpoint, { change: 110 }); // Voltage reports in 0.00458V
            await reporting_1.default.rmsCurrent(endpoint, { change: 55 }); // Current reports in 0.00183A
            await reporting_1.default.activePower(endpoint, { change: 2 }); // Power reports in 0.261W
        },
