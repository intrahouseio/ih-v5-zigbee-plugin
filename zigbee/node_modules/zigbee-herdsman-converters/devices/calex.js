...
const definitions = [
    ...
    },
    {
        ...
        extend: extend_1.default.light_onoff_brightness_colortemp_color({ supportsHueAndSaturation: true, colorTempRange: [153, 370] }),
    },
    {
        ...
        toZigbee: [],
        fromZigbee: [fromZigbee_1.default.command_off, fromZigbee_1.default.command_on, fromZigbee_1.default.command_step, fromZigbee_1.default.command_move_to_color_temp,
            fromZigbee_1.default.command_move, fromZigbee_1.default.command_stop, fromZigbee_1.default.command_ehanced_move_to_hue_and_saturation,
        ],
        exposes: [e.action([
