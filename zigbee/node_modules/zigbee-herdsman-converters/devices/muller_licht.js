...
const definitions = [
    {
        ...
        toZigbee: extend_1.default.light_onoff_brightness_colortemp_color().toZigbee.concat([toZigbee_1.default.tint_scene]),
    },
    {
        ...
        toZigbee: extend_1.default.light_onoff_brightness_colortemp().toZigbee.concat([toZigbee_1.default.tint_scene]),
    },
    {
        ...
        toZigbee: extend_1.default.light_onoff_brightness().toZigbee.concat([toZigbee_1.default.tint_scene]),
    },
    {
    ...
    },
    {
        ...
        extend: extend_1.default.light_onoff_brightness_colortemp_color({ colorTempRange: [153, 556], supportsHueAndSaturation: true }),
        toZigbee: extend_1.default.light_onoff_brightness_colortemp_color({ colorTempRange: [153, 556], supportsHueAndSaturation: true }).toZigbee
            .concat([toZigbee_1.default.tint_scene]),
    ...
    },
    {
        ...
        extend: tuya.extend.light_onoff_brightness_colortemp_color({ colorTempRange: [153, 500], toZigbee: [toZigbee_1.default.tint_scene, tuya.tz.do_not_disturb, tuya.tz.color_power_on_behavior] }),
    },
    {
        ...
        vendor: 'Müller Licht',
        fromZigbee: [fromZigbee_1.default.command_on, fromZigbee_1.default.command_off, fromZigbee_1.default.command_toggle, legacy.fz.tint404011_brightness_updown_click,
            legacy.fz.tint404011_move_to_color_temp, legacy.fz.tint404011_move_to_color, fromZigbee_1.default.tint_scene,
    ...
    },
    {
        ...
        description: 'Tint dim remote control',
        vendor: 'Müller Licht',
        fromZigbee: [fromZigbee_1.default.command_on, fromZigbee_1.default.command_off, fromZigbee_1.default.command_step, fromZigbee_1.default.command_move, fromZigbee_1.default.command_stop, fromZigbee_1.default.command_move_to_color_temp,
            fromZigbee_1.default.command_move_to_color, fromZigbee_1.default.tint_scene],
        exposes: [e.action(['on', 'off', 'brightness_step_up', 'brightness_step_down', 'brightness_move_up', 'brightness_move_down',
                'brightness_stop', 'color_temperature_move', 'color_move', 'scene_1', 'scene_2', 'scene_3', 'scene_4', 'scene_5', 'scene_6'])],
        toZigbee: [],
        configure: async (device, coordinatorEndpoint, logger) => {
    ...
    },
    {
        ...
        extend: extend_1.default.light_onoff_brightness_colortemp_color({ colorTempRange: [153, 555], supportsHueAndSaturation: true }),
        toZigbee: extend_1.default.light_onoff_brightness_colortemp_color({ colorTempRange: [153, 555], supportsHueAndSaturation: true }).toZigbee
            .concat([toZigbee_1.default.tint_scene]),
...
//# sourceMappingURL=m%C3%BCller_licht.js.map