...
const definitions = [
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.bind(endpoint1, coordinatorEndpoint, ['genOnOff', 'genLevelCtrl']);
            await reporting_1.default.onOff(endpoint1);
            await reporting_1.default.brightness(endpoint1);
            await extend_1.default.light_onoff_brightness().configure(device, coordinatorEndpoint, logger);
            const endpoint2 = device.getEndpoint(2);
            await reporting_1.default.bind(endpoint2, coordinatorEndpoint, ['genOnOff', 'genLevelCtrl']);
            await reporting_1.default.onOff(endpoint2);
            await reporting_1.default.brightness(endpoint2);
        },
        endpoint: () => {
            return { l1: 1, l2: 2 };
        },
