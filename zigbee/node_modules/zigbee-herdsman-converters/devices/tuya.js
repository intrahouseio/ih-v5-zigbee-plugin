...
const color_1 = __importDefault(require("../lib/color"));
const utils_1 = __importDefault(require("../lib/utils"));
const zosung_1 = __importDefault(require("../lib/zosung"));
...
const fzZosung = zosung_1.default.fzZosung;
const tzZosung = zosung_1.default.tzZosung;
const ez = zosung_1.default.presetsZosung;
const tzLocal = {
    led_control: {
        ...
        convertSet: async (entity, _key, _value, meta) => {
            ...
            let colorMode = (_a = meta.state.color_mode) !== null && _a !== void 0 ? _a : constants_1.colorModeLookup[constants_1.ColorMode.ColorTemp];
            ...
            if (colorMode == constants_1.colorModeLookup[constants_1.ColorMode.ColorTemp]) {
                if ('brightness' in meta.message) {
                    ...
                    await entity.command('genLevelCtrl', 'moveToLevel', zclData, utils_1.default.getOptions(meta.mapped, entity));
                    newState.brightness = meta.message.brightness;
                }
                if ('color_temp' in meta.message) {
                    const zclData = { colortemp: meta.message.color_temp, transtime: transtime };
                    await entity.command('lightingColorCtrl', 'moveToColorTemp', zclData, utils_1.default.getOptions(meta.mapped, entity));
                ...
                if ('brightness' in meta.message || 'color' in meta.message) {
                    ...
                    const newSettings = {
                        brightness: (_b = meta.state.brightness) !== null && _b !== void 0 ? _b : 254,
                        // @ts-expect-error
                        hue: (_d = ((_c = meta.state.color) !== null && _c !== void 0 ? _c : {}).hue) !== null && _d !== void 0 ? _d : 0,
                        // @ts-expect-error
                        saturation: (_f = ((_e = meta.state.color) !== null && _e !== void 0 ? _e : {}).saturation) !== null && _f !== void 0 ? _f : 100, // full saturation
                    };
                    // Apply changes
                    if ('brightness' in meta.message) {
                    ...
                    if ('color' in meta.message) {
                        ...
                        const c = color_1.default.Color.fromConverterArg(meta.message.color);
                        if (c.isRGB()) {
                    ...
                    (0, utils2_1.assertNumber)(newSettings.brightness, 'brightness');
                    const zclData = {
                        brightness: utils_1.default.mapNumberRange(newSettings.brightness, 0, 254, 0, 1000),
                        hue: newSettings.hue,
                        saturation: utils_1.default.mapNumberRange(newSettings.saturation, 0, 100, 0, 1000),
                    };
                    // This command doesn't support a transition time
                    await entity.command('lightingColorCtrl', 'tuyaMoveToHueAndSaturationBrightness2', zclData, utils_1.default.getOptions(meta.mapped, entity));
                }
            }
            ...
            Object.assign(newState, color_1.default.syncColorState(newState, meta.state, entity, meta.options, meta.logger));
    ...
    TS110E_options: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            if (key === 'min_brightness' || key == 'max_brightness') {
                ...
                (0, utils2_1.assertNumber)(value, key);
                payload = { [id]: { value: utils_1.default.mapNumberRange(value, 1, 255, 0, 1000), type: 0x21 } };
            }
            else if (key === 'light_type' || key === 'switch_type') {
                (0, utils2_1.assertString)(value, 'light_type/switch_type');
            ...
            await entity.write('genLevelCtrl', payload, utils_1.default.getOptions(meta.mapped, entity));
    ...
    TS110E_onoff_brightness: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            if (message.state === 'OFF' || (message.hasOwnProperty('state') && !message.hasOwnProperty('brightness'))) {
                ...
                // set brightness
                if (state.state === 'OFF') {
                    await entity.command('genOnOff', 'on', {}, utils_1.default.getOptions(meta.mapped, entity));
                }
                (0, utils2_1.assertNumber)(message.brightness, 'brightness');
                const level = utils_1.default.mapNumberRange(message.brightness, 0, 254, 0, 1000);
                await entity.command('genLevelCtrl', 'moveToLevelTuya', { level, transtime: 100 }, utils_1.default.getOptions(meta.mapped, entity));
    ...
    TS0504B_color: {
        key: ['color'],
        convertSet: async (entity, key, value, meta) => {
            const color = color_1.default.Color.fromConverterArg(value);
            ...
            if (enableWhite) {
                ...
                // @ts-expect-error
                return { state: color_1.default.syncColorState(newState, meta.state, entity, meta.options, meta.logger) };
            }
            else {
    ...
    TS0224: {
        ...
        convertSet: async (entity, key, value, meta) => {
            if (key === 'light') {
                (0, utils2_1.assertString)(value, 'light');
                await entity.command('genOnOff', value.toLowerCase() === 'on' ? 'on' : 'off', {}, utils_1.default.getOptions(meta.mapped, entity));
            }
            else if (key === 'duration') {
                await entity.write('ssIasWd', { 'maxDuration': value }, utils_1.default.getOptions(meta.mapped, entity));
            }
            else if (key === 'volume') {
                const lookup = { 'mute': 0, 'low': 10, 'medium': 30, 'high': 50 };
                (0, utils2_1.assertString)(value, 'volume');
                const lookupValue = lookup[value];
                value = value.toLowerCase();
                utils_1.default.validateValue(value, Object.keys(lookup));
                await entity.write('ssIasWd', { 0x0002: { value: lookupValue, type: 0x0a } }, utils_1.default.getOptions(meta.mapped, entity));
            }
            return { state: { [key]: value } };
        },
    },
        ...
        convertSet: async (entity, key, value, meta) => {
            switch (key) {
                case 'temperature_unit': {
                    (0, utils2_1.assertString)(value, 'temperature_unit');
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            switch (key) {
                case 'temperature_threshold': {
                    (0, utils2_1.assertNumber)(value, 'temperature_threshold');
                    const state = meta.state['temperature_breaker'];
                    const buf = Buffer.from([5, (0, utils2_1.getFromLookup)(state, onOffLookup), 0, value]);
                ...
                case 'temperature_breaker': {
                    ...
                    (0, utils2_1.assertNumber)(threshold, 'temperature_threshold');
                    const buf = Buffer.from([5, (0, utils2_1.getFromLookup)(value, onOffLookup), 0, threshold]);
                    await entity.command('manuSpecificTuya_3', 'setOptions2', { data: buf });
                    break;
                }
                case 'power_threshold': {
                    const state = meta.state['power_breaker'];
                    (0, utils2_1.assertNumber)(value, 'power_breaker');
                    const buf = Buffer.from([7, (0, utils2_1.getFromLookup)(state, onOffLookup), 0, value]);
                    await entity.command('manuSpecificTuya_3', 'setOptions2', { data: buf });
                    break;
                }
                case 'power_breaker': {
                    const threshold = meta.state['power_threshold'];
                    (0, utils2_1.assertNumber)(threshold, 'power_breaker');
                    const buf = Buffer.from([7, (0, utils2_1.getFromLookup)(value, onOffLookup), 0, threshold]);
                    await entity.command('manuSpecificTuya_3', 'setOptions2', { data: buf });
                    break;
                }
                case 'over_current_threshold': {
                    const state = meta.state['over_current_breaker'];
                    (0, utils2_1.assertNumber)(value, 'over_current_threshold');
                    const buf = Buffer.from([1, (0, utils2_1.getFromLookup)(state, onOffLookup), 0, value]);
                ...
                case 'over_current_breaker': {
                    ...
                    (0, utils2_1.assertNumber)(threshold, 'over_current_threshold');
                    const buf = Buffer.from([1, (0, utils2_1.getFromLookup)(value, onOffLookup), 0, threshold]);
                    await entity.command('manuSpecificTuya_3', 'setOptions3', { data: buf });
                    break;
                }
                case 'over_voltage_threshold': {
                    const state = meta.state['over_voltage_breaker'];
                    (0, utils2_1.assertNumber)(value, 'over_voltage_breaker');
                    const buf = Buffer.from([3, (0, utils2_1.getFromLookup)(state, onOffLookup), 0, value]);
                    await entity.command('manuSpecificTuya_3', 'setOptions3', { data: buf });
                    break;
                }
                case 'over_voltage_breaker': {
                    const threshold = meta.state['over_voltage_threshold'];
                    (0, utils2_1.assertNumber)(threshold, 'over_voltage_threshold');
                    const buf = Buffer.from([3, (0, utils2_1.getFromLookup)(value, onOffLookup), 0, threshold]);
                    await entity.command('manuSpecificTuya_3', 'setOptions3', { data: buf });
                    break;
                }
                case 'under_voltage_threshold': {
                    const state = meta.state['under_voltage_breaker'];
                    (0, utils2_1.assertNumber)(value, 'under_voltage_threshold');
                    const buf = Buffer.from([4, (0, utils2_1.getFromLookup)(state, onOffLookup), 0, value]);
                    await entity.command('manuSpecificTuya_3', 'setOptions3', { data: buf });
                    break;
                }
                case 'under_voltage_breaker': {
                    const threshold = meta.state['under_voltage_threshold'];
                    (0, utils2_1.assertNumber)(threshold, 'under_voltage_breaker');
                    const buf = Buffer.from([4, (0, utils2_1.getFromLookup)(value, onOffLookup), 0, threshold]);
                    await entity.command('manuSpecificTuya_3', 'setOptions3', { data: buf });
                    break;
                }
                default: // Unknown key
...
const fzLocal = {
    TS0222_humidity: {
        ...
        convert: (model, msg, publish, options, meta) => {
            const result = fromZigbee_1.default.humidity.convert(model, msg, publish, options, meta);
            result.humidity *= 10;
            return result;
        },
    },
    TS110E: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            if (msg.data.hasOwnProperty('64515')) {
                result['min_brightness'] = utils_1.default.mapNumberRange(msg.data['64515'], 0, 1000, 1, 255);
            }
            if (msg.data.hasOwnProperty('64516')) {
                result['max_brightness'] = utils_1.default.mapNumberRange(msg.data['64516'], 0, 1000, 1, 255);
            }
            if (msg.data.hasOwnProperty('61440')) {
                result['brightness'] = utils_1.default.mapNumberRange(msg.data['61440'], 0, 1000, 0, 255);
            }
            return result;
        },
    },
    ...
    TS110E_switch_type: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            if (msg.data.hasOwnProperty('64514')) {
                ...
                const propertyName = utils_1.default.postfixWithEndpointName('switch_type', msg, model, meta);
    ...
    humidity10: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            if (humidity >= 0 && humidity <= 100) {
                return { humidity: utils_1.default.calibrateAndPrecisionRoundOptions(humidity, options, 'humidity') };
            }
        },
    },
    temperature_unit: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            if (msg.data.hasOwnProperty('57355')) {
                result.temperature_unit = (0, utils2_1.getFromLookup)(msg.data['57355'], { '0': 'celsius', '1': 'fahrenheit' });
            }
            return result;
        },
    },
    TS011F_electrical_measurement: {
        ...
        convert: (model, msg, publish, options, meta) => {
            const result = fromZigbee_1.default.electrical_measurement.convert(model, msg, publish, options, meta);
            ...
            if (result && ['_TZ3000_gvn91tmx', '_TZ3000_amdymr7l', '_TZ3000_typdpbpg', '_TZ3000_hdopuwv6'].includes(meta.device.manufacturerName)) {
                for (const key of ['power', 'current', 'voltage']) {
                    if (key in result) {
                        ...
                        clearTimeout(store_1.default.getValue(msg.endpoint, key));
                        if (value === 0) {
                            ...
                            store_1.default.putValue(msg.endpoint, key, setTimeout(() => publish({ [key]: value }), time * 1000));
                            delete result[key];
                        }
                    }
                }
...
const definitions = [
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.ias_smoke_alarm_1, fromZigbee_1.default.battery, fromZigbee_1.default.ignore_basic_report],
        toZigbee: [],
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            try {
                ...
                await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genPowerCfg']);
    ...
    },
    {
        ...
        toZigbee: [toZigbee_1.default.on_off, tzLocal.led_control],
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.tuya_led_controller, fromZigbee_1.default.brightness, fromZigbee_1.default.ignore_basic_report],
    ...
    },
    {
        ...
        toZigbee: utils_1.default.replaceInArray(tuya.extend.light_onoff_brightness_color().toZigbee, [toZigbee_1.default.light_color], [tzLocal.TS0504B_color]),
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.ias_occupancy_alarm_1, fromZigbee_1.default.battery, fromZigbee_1.default.ignore_basic_report, fromZigbee_1.default.ias_occupancy_alarm_1_report, fromZigbee_1.default.illuminance],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [tuya.fz.datapoints, fromZigbee_1.default.ias_occupancy_alarm_1, fromZigbee_1.default.battery],
        toZigbee: [tuya.tz.datapoints],
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
            await tuya.configureMagicPacket(device, coordinatorEndpoint, logger);
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.ias_occupancy_alarm_1_with_timeout, fromZigbee_1.default.battery, fromZigbee_1.default.ignore_basic_report],
        toZigbee: [],
    ...
    },
    {
        ...
        vendor: 'TuYa',
        description: 'Motion sensor',
        fromZigbee: [fromZigbee_1.default.ias_occupancy_alarm_1, fromZigbee_1.default.battery, fromZigbee_1.default.ignore_basic_report, fromZigbee_1.default.ZM35HQ_attr, legacy.fromZigbee.ZM35HQ_battery],
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            await tuya.configureMagicPacket(device, coordinatorEndpoint, logger);
            await reporting_1.default.bind(device.getEndpoint(1), coordinatorEndpoint, ['genOnOff']);
            await reporting_1.default.bind(device.getEndpoint(7), coordinatorEndpoint, ['genOnOff']);
        },
    },
    {
        fingerprint: [
        ...
        fromZigbee: [legacy.fromZigbee.tuya_dimmer, fromZigbee_1.default.ignore_basic_report],
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genBasic']);
        },
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.ignore_basic_report, legacy.fromZigbee.tuya_switch],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.command_emergency, fromZigbee_1.default.battery],
        exposes: [e.battery(), e.battery_voltage(), e.action(['emergency'])],
        toZigbee: [],
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genPowerCfg', 'genTime', 'genBasic', 'ssIasAce', 'ssIasZone']);
            await reporting_1.default.batteryPercentageRemaining(endpoint);
            await reporting_1.default.batteryVoltage(endpoint);
        },
    },
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.tuya_led_controller],
        toZigbee: [toZigbee_1.default.tuya_led_controller, toZigbee_1.default.ignore_transition, toZigbee_1.default.ignore_rate],
    },
    {
        zigbeeModel: ['TS0502A'],
        model: 'TS0502A',
    ...
    },
    {
        ...
        // @ts-expect-error
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.tuya_led_control],
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.tuya_led_controller, fromZigbee_1.default.brightness, fromZigbee_1.default.ignore_basic_report],
        exposes: [e.light_brightness_colortemp_colorhs([153, 500]).removeFeature('color_temp_startup')],
    },
    {
    ...
    },
    {
        ...
        fromZigbee: [fzLocal.TS0201_battery, fromZigbee_1.default.temperature, fzLocal.TS0201_humidity],
        toZigbee: [],
    ...
    },
    {
        ...
        exposes: [e.battery(), e.action(['1_single', '1_double', '1_hold', '2_single', '2_double', '2_hold',
                '3_single', '3_double', '3_hold', '4_single', '4_double', '4_hold'])],
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.tuya_on_off_action],
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            for (const ep of [1, 2, 3, 4]) {
                ...
                if (device.getEndpoint(ep)) {
                    await reporting_1.default.bind(device.getEndpoint(ep), coordinatorEndpoint, ['genOnOff']);
                }
            }
        },
    },
    {
        ...
        fromZigbee: [legacy.fromZigbee.tuya_water_leak, fromZigbee_1.default.ignore_basic_report],
    ...
    },
    {
        ...
        vendor: 'TuYa',
        description: 'Water leak sensor',
        fromZigbee: [fromZigbee_1.default.ignore_basic_report, fromZigbee_1.default.ignore_tuya_raw, legacy.fromZigbee.wls100z_water_leak],
        toZigbee: [],
        onEvent: tuya.onEventSetTime,
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
    ...
    },
    {
        ...
        toZigbee: [toZigbee_1.default.on_off, tuya.tz.power_on_behavior_1, tuya.tz.switch_type],
        configure: async (device, coordinatorEndpoint, logger) => {
            await tuya.configureMagicPacket(device, coordinatorEndpoint, logger);
            const endpoint = device.getEndpoint(1);
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genOnOff', 'haElectricalMeasurement', 'seMetering']);
            await reporting_1.default.rmsVoltage(endpoint, { change: 5 });
            await reporting_1.default.rmsCurrent(endpoint, { change: 50 });
            await reporting_1.default.activePower(endpoint, { change: 10 });
    ...
    },
    {
        ...
        description: 'Switch with power monitoring',
        vendor: 'TuYa',
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.electrical_measurement, fromZigbee_1.default.metering, fromZigbee_1.default.ignore_basic_report, tuya.fz.power_on_behavior_1,
            tuya.fz.switch_type],
        toZigbee: [toZigbee_1.default.on_off, tuya.tz.power_on_behavior_1, tuya.tz.switch_type],
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
    ...
    },
    {
        ...
        fingerprint: [
            ...
            { modelID: 'TS0601', manufacturerName: '_TZE200_9sfg7gm0' },
            { modelID: 'TS0601', manufacturerName: '_TZE200_2atgpdho' },
            { modelID: 'TS0601', manufacturerName: '_TZE200_cpmgn2cf' },
            { modelID: 'TS0601', manufacturerName: '_TZE200_8thwkzxl' },
            { modelID: 'TS0601', manufacturerName: '_TZE200_4eeyebrt' },
            { modelID: 'TS0601', manufacturerName: '_TZE200_8whxpsiw' },
        ...
        fromZigbee: [legacy.fromZigbee.tuya_thermostat, fromZigbee_1.default.ignore_basic_report, fromZigbee_1.default.ignore_tuya_set_time],
        ...
        exposes: [
            ...
            e.climate().withSetpoint('current_heating_setpoint', 5, 35, 0.5, ea.STATE_SET)
                .withLocalTemperature(ea.STATE).withSystemMode(['heat', 'auto', 'off'], ea.STATE_SET, 'Mode of this device, in the `heat` mode the TS0601 will remain continuously heating, i.e. it does not regulate ' +
    ...
    },
    {
        ...
        fromZigbee: [legacy.fromZigbee.tuya_thermostat_weekly_schedule_1, legacy.fromZigbee.etop_thermostat,
            fromZigbee_1.default.ignore_basic_report, fromZigbee_1.default.ignore_tuya_set_time],
    ...
    },
    {
        ...
        exposes: [
            ...
            e.climate()
                ...
                .withPreset(['auto', 'manual', 'off', 'on'], 'MANUAL MODE â - In this mode, the device executes manual temperature setting. ' +
        ...
        meta: {
            tuyaDatapoints: [
                [1, null,
                    {
                        from: (v) => {
                            (0, utils2_1.assertNumber)(v, 'system_mode');
    ...
    },
    {
        ...
        vendor: 'TuYa',
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.electrical_measurement, fromZigbee_1.default.metering, fromZigbee_1.default.ignore_basic_report, tuya.fz.power_outage_memory,
            tuya.fz.indicator_mode],
        toZigbee: [toZigbee_1.default.on_off, tuya.tz.power_on_behavior_1, tuya.tz.backlight_indicator_mode_1],
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genOnOff', 'haElectricalMeasurement', 'seMetering']);
            endpoint.saveClusterAttributeKeyValue('seMetering', { divisor: 100, multiplier: 1 });
    ...
    {
        fingerprint: tuya.fingerprint('TS011F', ['_TZ3000_hyfvrar3', '_TZ3000_v1pdxuqq', '_TZ3000_8a833yls', '_TZ3000_bfn1w0mm', '_TZ3000_nzkqcvvs', '_TZ3000_rtcrrvia']),
        model: 'TS011F_plug_2',
    ...
    },
    {
        ...
        options: [exposes.options.measurement_poll_interval()],
        onEvent: (type, data, device, options) => tuya.onEventMeasurementPoll(type, data, device, options, device.applicationVersion !== 66, // polling for voltage, current and power
        [66, 100, 160].includes(device.applicationVersion)),
    },
    {
    ...
    },
    {
        ...
        meta: {
            tuyaDatapoints: [
                ...
                [6, null, tuya.valueConverter.phaseVariant1],
    ...
    },
    {
        ...
        meta: {
            tuyaDatapoints: [
                ...
                [11, null, null],
                [16, 'state', tuya.valueConverter.onOff],
                [17, null, tuya.valueConverter.threshold],
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.bind(device.getEndpoint(1), coordinatorEndpoint, ['genOnOff', 'genLevelCtrl']);
            await reporting_1.default.bind(device.getEndpoint(2), coordinatorEndpoint, ['genOnOff', 'genLevelCtrl']);
        },
    },
    {
        zigbeeModel: ['RH3001'],
        ...
        fromZigbee: [fromZigbee_1.default.ias_contact_alarm_1, fromZigbee_1.default.battery, fromZigbee_1.default.ignore_basic_report, fromZigbee_1.default.ignore_time_read],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.ignore_basic_report, fromZigbee_1.default.ias_occupancy_alarm_1],
        toZigbee: [],
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.bind(device.getEndpoint(4), coordinatorEndpoint, ['genOnOff']);
            await reporting_1.default.bind(device.getEndpoint(5), coordinatorEndpoint, ['genOnOff']);
            await reporting_1.default.bind(device.getEndpoint(6), coordinatorEndpoint, ['genOnOff']);
        },
    },
    {
        zigbeeModel: ['HY0080'],
        ...
        fromZigbee: [legacy.fromZigbee.thermostat_att_report, fromZigbee_1.default.fan],
        toZigbee: [toZigbee_1.default.thermostat_local_temperature, toZigbee_1.default.thermostat_local_temperature_calibration,
            toZigbee_1.default.thermostat_occupancy, toZigbee_1.default.thermostat_occupied_heating_setpoint, toZigbee_1.default.thermostat_unoccupied_heating_setpoint,
            toZigbee_1.default.thermostat_occupied_cooling_setpoint, toZigbee_1.default.thermostat_unoccupied_cooling_setpoint,
            toZigbee_1.default.thermostat_setpoint_raise_lower, toZigbee_1.default.thermostat_remote_sensing,
            toZigbee_1.default.thermostat_control_sequence_of_operation, toZigbee_1.default.thermostat_system_mode, toZigbee_1.default.thermostat_weekly_schedule,
            toZigbee_1.default.thermostat_clear_weekly_schedule, toZigbee_1.default.thermostat_relay_status_log,
            toZigbee_1.default.thermostat_temperature_setpoint_hold, toZigbee_1.default.thermostat_temperature_setpoint_hold_duration, toZigbee_1.default.fan_mode],
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['hvacThermostat', 'hvacFanCtrl']);
            await reporting_1.default.thermostatTemperature(endpoint);
            await reporting_1.default.thermostatSystemMode(endpoint);
            await reporting_1.default.thermostatOccupiedHeatingSetpoint(endpoint);
            await reporting_1.default.thermostatUnoccupiedHeatingSetpoint(endpoint);
            await reporting_1.default.thermostatOccupiedCoolingSetpoint(endpoint);
            await reporting_1.default.thermostatUnoccupiedCoolingSetpoint(endpoint);
            await reporting_1.default.fanMode(endpoint);
        },
    },
    {
        zigbeeModel: ['6dfgetq'],
        ...
        exposes: [e.climate().withSetpoint('current_heating_setpoint', 5, 30, 0.5, ea.STATE_SET)
                ...
                .withRunningState(['idle', 'heat', 'cool'], ea.STATE)],
        fromZigbee: [legacy.fromZigbee.tuya_thermostat, fromZigbee_1.default.ignore_basic_report, legacy.fromZigbee.tuya_dimmer],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.ts0216_siren, fromZigbee_1.default.battery],
        ...
        toZigbee: [toZigbee_1.default.ts0216_alarm, toZigbee_1.default.ts0216_duration, toZigbee_1.default.ts0216_volume],
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genPowerCfg']);
    ...
    },
    {
        ...
        vendor: 'TuYa',
        description: 'Wall-mount thermostat',
        fromZigbee: [legacy.fromZigbee.hy_thermostat, fromZigbee_1.default.ignore_basic_report],
    ...
    },
    {
        ...
        vendor: 'TuYa',
        description: 'Wall-mount thermostat',
        fromZigbee: [fromZigbee_1.default.ignore_basic_report, legacy.fromZigbee.x5h_thermostat],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.illuminance, legacy.fromZigbee.TS0222],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.ias_vibration_alarm_1_with_timeout],
        toZigbee: [toZigbee_1.default.TS0210_sensitivity],
    ...
    },
    {
        ...
        vendor: 'TuYa',
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.ignore_basic_report, tuya.fz.power_outage_memory, fromZigbee_1.default.tuya_relay_din_led_indicator],
        toZigbee: [toZigbee_1.default.on_off, tuya.tz.power_on_behavior_1, toZigbee_1.default.tuya_relay_din_led_indicator],
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genOnOff']);
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.illuminance, fromZigbee_1.default.temperature, fromZigbee_1.default.humidity, fromZigbee_1.default.ts0201_temperature_humidity_alarm],
        toZigbee: [toZigbee_1.default.ts0201_temperature_humidity_alarm],
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
            // Enables reporting of measurement state changes
            await tuya.configureMagicPacket(device, coordinatorEndpoint, logger);
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genBasic', 'genPowerCfg',
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.command_on, fromZigbee_1.default.command_off, fromZigbee_1.default.command_step, fromZigbee_1.default.command_move, fromZigbee_1.default.command_stop,
            fromZigbee_1.default.command_step_color_temperature, fromZigbee_1.default.tuya_on_off_action, fromZigbee_1.default.tuya_operation_mode],
        toZigbee: [toZigbee_1.default.tuya_operation_mode],
        onEvent: tuya.onEventSetLocalTime,
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
    ...
    },
    {
        ...
        fromZigbee: [
            fromZigbee_1.default.command_step, fromZigbee_1.default.command_toggle, fromZigbee_1.default.command_move_hue, fromZigbee_1.default.command_step_color_temperature, fromZigbee_1.default.command_stop_move_raw,
            fromZigbee_1.default.tuya_multi_action, fromZigbee_1.default.tuya_operation_mode, fromZigbee_1.default.battery,
        ],
        toZigbee: [toZigbee_1.default.tuya_operation_mode],
        exposes: [
            e.action([
    ...
    },
    {
        ...
        fromZigbee: [
            fromZigbee_1.default.command_step, fromZigbee_1.default.command_on, fromZigbee_1.default.command_off, fromZigbee_1.default.command_move_to_color_temp, fromZigbee_1.default.command_move_to_level,
            fromZigbee_1.default.tuya_multi_action, fromZigbee_1.default.tuya_operation_mode, fromZigbee_1.default.battery,
        ],
        toZigbee: [toZigbee_1.default.tuya_operation_mode],
        exposes: [
    ...
    },
    {
        ...
        fromZigbee: [legacy.fromZigbee.zb_sm_cover, fromZigbee_1.default.ignore_basic_report],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.temperature, fzLocal.humidity10, fzLocal.temperature_unit, fromZigbee_1.default.battery, fromZigbee_1.default.ignore_tuya_set_time],
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genPowerCfg', 'msTemperatureMeasurement', 'msRelativeHumidity']);
            await endpoint.read('genPowerCfg', ['batteryVoltage', 'batteryPercentageRemaining']);
            await reporting_1.default.batteryPercentageRemaining(endpoint);
        },
    },
    ...
    },
    {
        ...
        fromZigbee: extend_1.default.light_onoff_brightness({ disablePowerOnBehavior: true, disableMoveStep: true, disableTransition: true })
            .fromZigbee.concat([tuya.fz.power_on_behavior_1, fzLocal.TS110E_switch_type, fzLocal.TS110E]),
        toZigbee: utils_1.default.replaceInArray(extend_1.default.light_onoff_brightness({ disablePowerOnBehavior: true, disableMoveStep: true, disableTransition: true })
            .toZigbee.concat([tuya.tz.power_on_behavior_1, tzLocal.TS110E_options]), [toZigbee_1.default.light_onoff_brightness], [tzLocal.TS110E_light_onoff_brightness]),
    ...
    },
    {
        ...
        fromZigbee: [fzLocal.TS110E, fzLocal.TS110E_light_type, tuya.fz.power_on_behavior_1, fromZigbee_1.default.on_off],
        toZigbee: [tzLocal.TS110E_onoff_brightness, tzLocal.TS110E_options, tuya.tz.power_on_behavior_1, toZigbee_1.default.light_brightness_move],
        exposes: [
    ...
    },
    {
        ...
        fromZigbee: [],
        toZigbee: [toZigbee_1.default.warning, tzLocal.TS0224],
        exposes: [e.warning(),
    ...
    },
    {
        ...
        extend: tuya.extend.switch({
            ...
            fromZigbee: [fromZigbee_1.default.temperature, fzLocal.TS011F_threshold],
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['msTemperatureMeasurement']);
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genOnOff', 'haElectricalMeasurement', 'seMetering']);
            await reporting_1.default.rmsVoltage(endpoint, { change: 5 });
            await reporting_1.default.rmsCurrent(endpoint, { change: 50 });
            await reporting_1.default.activePower(endpoint, { change: 10 });
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            for (const ID of [1, 2, 3, 4, 5]) {
                await reporting_1.default.bind(device.getEndpoint(ID), coordinatorEndpoint, ['genOnOff']);
            }
        },
        whiteLabel: [
