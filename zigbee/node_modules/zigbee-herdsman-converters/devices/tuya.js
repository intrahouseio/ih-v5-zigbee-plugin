        ...
        convertSet: async (entity, _key, _value, meta) => {
            ...
            if (colorMode == constants_1.colorModeLookup[constants_1.ColorMode.ColorTemp]) {
                ...
                if ('brightness' in meta.message || 'color' in meta.message) {
                    ...
                    const newSettings = {
                        brightness: (_b = meta.state.brightness) !== null && _b !== void 0 ? _b : 254, //      full brightness
                        // @ts-expect-error
                        hue: (_d = ((_c = meta.state.color) !== null && _c !== void 0 ? _c : {}).hue) !== null && _d !== void 0 ? _d : 0, //          red
                        // @ts-expect-error
...
const definitions = [
    ...
    {
        fingerprint: tuya.fingerprint('TS0601', ['_TZE200_yjjdcqsq', '_TZE200_9yapgbuv', '_TZE204_upagmta9', '_TZE200_cirvgep4', '_TZE200_upagmta9']),
    ...
    {
        fingerprint: tuya.fingerprint('TS0505B', ['_TZ3210_iystcadi', '_TZ3210_mja6r5ix', '_TZ3210_it1u8ahz', '_TZ3210_jd3z4yig', '_TZ3210_r5afgmkl']),
        model: 'TS0505B_2',
        vendor: 'TuYa',
        description: 'Zigbee RGB+CCT light',
        whiteLabel: [
            tuya.whitelabel('Lidl', '14149505L/14149506L_2', 'Livarno Lux light bar RGB+CCT (black/white)', ['_TZ3210_iystcadi']),
            tuya.whitelabel('Tuya', 'TS0505B_1_1', 'Zigbee 3.0 18W led light bulb E27 RGBCW', ['_TZ3210_mja6r5ix', '_TZ3210_jd3z4yig', '_TZ3210_r5afgmkl']),
    ...
    },
    {
        ...
        toZigbee: utils.replaceInArray(tuya.extend.light_onoff_brightness_color().toZigbee, [toZigbee_1.default.light_color], [tzLocal.TS0504B_color]),
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.ias_water_leak_alarm_1, fromZigbee_1.default.battery, fromZigbee_1.default.ignore_basic_report],
        whiteLabel: [
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.cover_position_tilt, tuya.fz.indicator_mode, fromZigbee_1.default.tuya_cover_options, tuya.fz.backlight_mode_off_on],
    ...
    },
    {
        ...
        whiteLabel: [
            ...
            tuya.whitelabel('MiBoxer', 'FUT035Z+', 'Dual white LED controller', ['_TZ3210_frm6149r', '_TZ3210_jtifm80b', '_TZ3210_xwqng7ol', '_TZB210_lmqquxus']),
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.tuya_on_off_action, fromZigbee_1.default.tuya_operation_mode,
            fromZigbee_1.default.command_on, fromZigbee_1.default.command_off, fromZigbee_1.default.command_step, fromZigbee_1.default.command_move],
    ...
    },
    {
        ...
        whiteLabel: [{ vendor: 'TuYa', model: 'RC-MCB' },
            ...
            tuya.whitelabel('Hiking', 'DDS238-2', 'Single phase DIN-rail energy meter with switch function', ['_TZE200_bkkmqmyo']),
        ],
    },
    {
    ...
    },
    {
        ...
        meta: {
            tuyaDatapoints: [
                ...
                [101, 'motion_state', tuya.valueConverterBasic.lookup({ 'none': tuya.enum(0), 'large': tuya.enum(1), 'medium': tuya.enum(2), 'small': tuya.enum(3) })],
    ...
    },
    {
        ...
        toZigbee: utils.replaceInArray(extend_1.default.light_onoff_brightness({ disablePowerOnBehavior: true, disableMoveStep: true, disableTransition: true })
    ...
    },
    {
        ...
        toZigbee: [tuya.tz.datapoints],
        configure: tuya.configureMagicPacket,
        whiteLabel: [{ vendor: 'MatSee Plus', model: 'PC321-Z-TY' }],
        exposes: [
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.cover_position_tilt, fromZigbee_1.default.tuya_cover_options_2],
        toZigbee: [toZigbee_1.default.cover_position_tilt, toZigbee_1.default.cover_state, tzLocal.TS030F_border, toZigbee_1.default.moes_cover_calibration, toZigbee_1.default.tuya_cover_reversal],
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, tuya.fz.datapoints],
        toZigbee: [toZigbee_1.default.on_off, tuya.tz.datapoints],
        exposes: [
            e.switch(), e.battery(),
    ...
    },
    {
        ...
        fromZigbee: [tuya.fz.datapoints, fromZigbee_1.default.ias_occupancy_only_alarm_2, tuya.fz.indicator_mode],
    ...
    },
    {
        ...
        exposes: [
            ...
            e.binary('presence_illuminance_switch', ea.STATE_SET, true, false).withDescription(`Whether to enable 'light_switch' illumination is between min/max threshold`),
            e.binary('light_switch', ea.STATE, 'ON', 'OFF').withDescription('This state will determine the light on/off based on the lighting threshold and presence sensing'),
            e.binary('light_linkage', ea.STATE_SET, true, false).withDescription('Light linkage'),
            e.enum('detection_method', ea.STATE_SET, ['only_move', 'exist_move']).withDescription(`When 'only_move' is used, presence will only be triggered when there is movement`),
    ...
    },
    {
        ...
        vendor: 'Loginovo',
        description: 'SOS button',
        fromZigbee: [tuya.fz.datapoints, fromZigbee_1.default.battery],
        toZigbee: [],
