...
const definitions = [
    ...
    },
    {
        ...
        extend: extend_1.default.light_onoff_brightness_colortemp({ colorTempRange: [250, 454] }),
    },
    {
        ...
        vendor: 'HORNBACH',
        description: 'FLAIR Viyu smart LED bulb CCT E27',
        extend: extend_1.default.light_onoff_brightness_colortemp({ colorTempRange: [220, 500] }),
    },
];
