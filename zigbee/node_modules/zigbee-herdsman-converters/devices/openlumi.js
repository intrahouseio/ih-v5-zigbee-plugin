...
const definitions = [
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genDeviceTempCfg']);
            await reporting_1.default.deviceTemperature(endpoint, { min: constants_1.default.repInterval.MINUTE, max: constants_1.default.repInterval.MINUTES_5 });
        },
