...
const definitions = [
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.bind(endpoint1, coordinatorEndpoint, ['genBasic', 'genOnOff', 'haElectricalMeasurement', 'seMetering']);
            await reporting_1.default.bind(endpoint2, coordinatorEndpoint, ['genOnOff']);
            await reporting_1.default.onOff(endpoint1);
            await reporting_1.default.onOff(endpoint1);
            await reporting_1.default.onOff(endpoint1);
            await reporting_1.default.rmsVoltage(endpoint1, { change: 5 });
            await reporting_1.default.rmsCurrent(endpoint1, { change: 50 });
            await reporting_1.default.activePower(endpoint1, { change: 1 });
            await reporting_1.default.onOff(endpoint1);
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genBasic', 'genOta', 'genTime', 'genGroups', 'genScenes']);
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genOnOff', 'genIdentify', 'manuSpecificTuya', 'hvacFanCtrl']);
