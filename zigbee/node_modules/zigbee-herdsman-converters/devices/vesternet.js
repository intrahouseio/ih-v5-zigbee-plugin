...
const definitions = [
    {
        ...
        fromZigbee: extend_1.default.light_onoff_brightness().fromZigbee
            .concat([fromZigbee_1.default.electrical_measurement, fromZigbee_1.default.metering, fromZigbee_1.default.ignore_genOta]),
        toZigbee: extend_1.default.light_onoff_brightness().toZigbee.concat([toZigbee_1.default.power_on_behavior]),
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.cover_position_tilt, fromZigbee_1.default.ignore_genOta],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.command_on, fromZigbee_1.default.command_off, fromZigbee_1.default.command_move, fromZigbee_1.default.command_stop, fromZigbee_1.default.command_recall, fromZigbee_1.default.battery, fromZigbee_1.default.ignore_genOta],
        exposes: [e.battery(),
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            await reporting_1.default.bind(device.getEndpoint(1), coordinatorEndpoint, ['genOnOff', 'genLevelCtrl', 'genScenes', 'genPowerCfg']);
            await reporting_1.default.bind(device.getEndpoint(2), coordinatorEndpoint, ['genOnOff', 'genLevelCtrl', 'genScenes']);
            await reporting_1.default.bind(device.getEndpoint(3), coordinatorEndpoint, ['genOnOff', 'genLevelCtrl', 'genScenes']);
            await reporting_1.default.bind(device.getEndpoint(4), coordinatorEndpoint, ['genOnOff', 'genLevelCtrl', 'genScenes']);
            await reporting_1.default.batteryPercentageRemaining(device.getEndpoint(1));
        },
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.power_on_behavior, fromZigbee_1.default.ignore_genOta],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.power_on_behavior],
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.bind(endpoint1, coordinatorEndpoint, ['genOnOff', 'haElectricalMeasurement', 'seMetering']);
            ...
            await reporting_1.default.readEletricalMeasurementMultiplierDivisors(endpoint1);
            await reporting_1.default.activePower(endpoint1);
            await reporting_1.default.rmsCurrent(endpoint1, { min: 10, change: 10 });
            await reporting_1.default.rmsVoltage(endpoint1, { min: 10 });
            await reporting_1.default.readMeteringMultiplierDivisor(endpoint1);
            await reporting_1.default.currentSummDelivered(endpoint1);
        },
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            await reporting_1.default.bind(device.getEndpoint(1), coordinatorEndpoint, ['genOnOff', 'genLevelCtrl', 'genPowerCfg']);
            await reporting_1.default.batteryPercentageRemaining(device.getEndpoint(1));
        },
    },
    {
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            await reporting_1.default.bind(device.getEndpoint(1), coordinatorEndpoint, ['genOnOff', 'genLevelCtrl', 'genPowerCfg']);
            await reporting_1.default.bind(device.getEndpoint(2), coordinatorEndpoint, ['genOnOff', 'genLevelCtrl']);
            await reporting_1.default.bind(device.getEndpoint(3), coordinatorEndpoint, ['genOnOff', 'genLevelCtrl']);
            await reporting_1.default.bind(device.getEndpoint(4), coordinatorEndpoint, ['genOnOff', 'genLevelCtrl']);
            await reporting_1.default.batteryPercentageRemaining(device.getEndpoint(1));
        },
    },
];
module.exports = definitions;
//# sourceMappingURL=vesternet.js.map