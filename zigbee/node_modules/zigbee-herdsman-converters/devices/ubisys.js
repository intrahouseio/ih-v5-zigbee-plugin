...
const manufacturerOptions = {
     ...
     */
    ubisys: { manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.UBISYS },
    // @ts-expect-error
        ...
        configure_device_setup: {
            ...
            convertSet: async (entity, key, value, meta) => {
                ...
                if (value.hasOwnProperty('input_configurations')) {
                    // example: [0, 0, 0, 0]
                    await devMgmtEp.write('manuSpecificUbisysDeviceSetup', { 'inputConfigurations': { elementType: 'data8', elements: value.input_configurations } }, manufacturerOptions.ubisysNull);
                }
                if (value.hasOwnProperty('input_actions')) {
                    // example (default for C4): [[0,13,1,6,0,2], [1,13,2,6,0,2], [2,13,3,6,0,2], [3,13,4,6,0,2]]
                    await devMgmtEp.write('manuSpecificUbisysDeviceSetup', { 'inputActions': { elementType: 'octetStr', elements: value.input_actions } }, manufacturerOptions.ubisysNull);
                }
                if (value.hasOwnProperty('input_action_templates')) {
                    ...
                    await devMgmtEp.write('manuSpecificUbisysDeviceSetup', { 'inputActions': { elementType: 'octetStr', elements: resultingInputActions } }, manufacturerOptions.ubisysNull);
                }
        ...
        thermostat_vacation_mode: {
            ...
            convertSet: async (entity, key, value, meta) => {
                ...
                if (typeof value === 'boolean') {
                    await entity.write('hvacThermostat', { 0x0005: { value: value, type: zigbee_herdsman_1.Zcl.DataType.boolean } }, manufacturerOptions.ubisys);
                }
                else {
...
const definitions = [
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.metering, fromZigbee_1.default.command_toggle, fromZigbee_1.default.command_on, fromZigbee_1.default.command_off, fromZigbee_1.default.command_recall, fromZigbee_1.default.command_move,
            fromZigbee_1.default.command_stop, fromZigbee_1.default.power_on_behavior, ubisys.fz.configure_device_setup],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.brightness, fromZigbee_1.default.metering, fromZigbee_1.default.command_toggle, fromZigbee_1.default.command_on, fromZigbee_1.default.command_off, fromZigbee_1.default.command_recall,
            fromZigbee_1.default.command_move, fromZigbee_1.default.command_stop, fromZigbee_1.default.lighting_ballast_configuration, fromZigbee_1.default.level_config, ubisys.fz.dimmer_setup,
            ubisys.fz.dimmer_setup_genLevelCtrl, ubisys.fz.configure_device_setup],
        toZigbee: [toZigbee_1.default.light_onoff_brightness, toZigbee_1.default.ballast_config, toZigbee_1.default.level_config, ubisys.tz.dimmer_setup,
            ubisys.tz.dimmer_setup_genLevelCtrl, ubisys.tz.configure_device_setup, toZigbee_1.default.ignore_transition, toZigbee_1.default.light_brightness_move,
            toZigbee_1.default.light_brightness_step, toZigbee_1.default.metering_power, toZigbee_1.default.currentsummdelivered],
        exposes: [
            e.action(['toggle_s1', 'toggle_s2', 'on_s1', 'on_s2', 'off_s1', 'off_s2', 'recall_*_s1', 'recal_*_s2', 'brightness_move_up_s1',
                'brightness_move_up_s2', 'brightness_move_down_s1', 'brightness_move_down_s2', 'brightness_stop_s1',
                'brightness_stop_s2']),
            ...
            e.numeric('minimum_on_level', ea.ALL).withValueMin(0).withValueMax(255)
    ...
    },
    {
        ...
        toZigbee: [toZigbee_1.default.cover_state, toZigbee_1.default.cover_position_tilt, toZigbee_1.default.metering_power,
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.thermostat, fromZigbee_1.default.thermostat_weekly_schedule, ubisys.fz.thermostat_vacation_mode],
        toZigbee: [
            toZigbee_1.default.thermostat_occupied_heating_setpoint, toZigbee_1.default.thermostat_unoccupied_heating_setpoint,
            toZigbee_1.default.thermostat_local_temperature, toZigbee_1.default.thermostat_system_mode,
            toZigbee_1.default.thermostat_weekly_schedule, toZigbee_1.default.thermostat_clear_weekly_schedule,
            toZigbee_1.default.thermostat_running_mode, ubisys.tz.thermostat_vacation_mode,
            toZigbee_1.default.thermostat_pi_heating_demand, toZigbee_1.default.battery_percentage_remaining,
        ],
        exposes: [
    ...
    },
    {
        ...
        toZigbee: [
            toZigbee_1.default.on_off, toZigbee_1.default.thermostat_occupied_heating_setpoint,
            toZigbee_1.default.thermostat_unoccupied_heating_setpoint, toZigbee_1.default.thermostat_local_temperature,
            toZigbee_1.default.thermostat_system_mode, toZigbee_1.default.thermostat_weekly_schedule,
            toZigbee_1.default.thermostat_clear_weekly_schedule, toZigbee_1.default.thermostat_running_mode,
