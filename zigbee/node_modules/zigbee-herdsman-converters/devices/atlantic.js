...
const tzLocal = {
    ...
    ac_louver_position: {
        ...
        convertSet: async (entity, key, value, meta) => {
            (0, utils2_1.assertString)(value, 'ac_louver_position');
            utils_1.default.validateValue(value, Object.keys(thermostatPositions));
    ...
    preset: {
        key: ['preset'],
        convertSet: async (entity, key, value, meta) => {
            (0, utils2_1.assertString)(value, 'preset');
            value = value.toLowerCase();
            utils_1.default.validateValue(value, ['activity', 'boost', 'eco', 'none']);
    ...
    swingMode: {
        key: ['swing_mode'],
        convertSet: async (entity, key, value, meta) => {
            (0, utils2_1.assertString)(value, 'swing_mode');
            value = value.toLowerCase();
            utils_1.default.validateValue(value, ['on', 'off']);
...
const definitions = [
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.bind(endpoint1, coordinatorEndpoint, binds1);
            await reporting_1.default.thermostatTemperature(endpoint1);
            await reporting_1.default.thermostatOccupiedCoolingSetpoint(endpoint1);
            await reporting_1.default.thermostatSystemMode(endpoint1);
