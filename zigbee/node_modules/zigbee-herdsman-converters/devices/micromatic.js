...
const definitions = [
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.rmsVoltage(endpoint, { min: 10, change: 20 }); // Voltage - Min change of 2V
            await reporting_1.default.rmsCurrent(endpoint, { min: 10, change: 10 }); // A - z2m displays only the first decimals, change of 10 / 0,01A
            await reporting_1.default.activePower(endpoint, { min: 10, change: 15 }); // W - Min change of 1,5W
            await reporting_1.default.currentSummDelivered(endpoint, { min: 300 }); // Report KWH every 5min
        },
