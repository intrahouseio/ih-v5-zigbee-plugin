...
const tzLocal = {
    ...
    bosch_thermostat: {
        ...
        convertSet: async (entity, key, value, meta) => {
            if (key === 'window_open') {
                const index = utils.getFromLookup(value, stateOffOn);
                await entity.write('hvacThermostat', { 0x4042: { value: index, type: zigbee_herdsman_1.Zcl.DataType.enum8 } }, boschManufacturer);
                return { state: { window_open: value } };
            }
            if (key === 'boost') {
                const index = utils.getFromLookup(value, stateOffOn);
                await entity.write('hvacThermostat', { 0x4043: { value: index, type: zigbee_herdsman_1.Zcl.DataType.enum8 } }, boschManufacturer);
            ...
            if (key === 'system_mode') {
                ...
                await entity.write('hvacThermostat', { 0x4007: { value: opMode, type: zigbee_herdsman_1.Zcl.DataType.enum8 } }, boschManufacturer);
                return { state: { system_mode: value } };
            }
            if (key === 'pi_heating_demand') {
                await entity.write('hvacThermostat', { 0x4020: { value: value, type: zigbee_herdsman_1.Zcl.DataType.enum8 } }, boschManufacturer);
            ...
            if (key === 'remote_temperature') {
                ...
                await entity.write('hvacThermostat', { 0x4040: { value: remoteTemperature, type: zigbee_herdsman_1.Zcl.DataType.int16 } }, boschManufacturer);
    ...
    bosch_userInterface: {
        ...
        convertSet: async (entity, key, value, meta) => {
            if (key === 'display_orientation') {
                ...
                await entity.write('hvacUserInterfaceCfg', { 0x400b: { value: index, type: zigbee_herdsman_1.Zcl.DataType.uint8 } }, boschManufacturer);
                return { state: { display_orientation: value } };
            }
            if (key === 'display_ontime') {
                await entity.write('hvacUserInterfaceCfg', { 0x403a: { value: value, type: zigbee_herdsman_1.Zcl.DataType.enum8 } }, boschManufacturer);
                return { state: { display_onTime: value } };
            }
            if (key === 'display_brightness') {
                await entity.write('hvacUserInterfaceCfg', { 0x403b: { value: value, type: zigbee_herdsman_1.Zcl.DataType.enum8 } }, boschManufacturer);
            ...
            if (key === 'displayed_temperature') {
                ...
                await entity.write('hvacUserInterfaceCfg', { 0x4039: { value: index, type: zigbee_herdsman_1.Zcl.DataType.enum8 } }, boschManufacturer);
    ...
    bosch_twinguard_measurements: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            if (msg.data.hasOwnProperty('illuminance_lux')) {
                result.illuminance_lux = utils.calibrateAndPrecisionRoundOptions(msg.data['illuminance_lux'] / 2.0, options, 'illuminance_lux');
            }
...
const definitions = [
    ...
    },
    {
        ...
        toZigbee: [toZigbee_1.default.thermostat_occupied_heating_setpoint, toZigbee_1.default.thermostat_local_temperature_calibration,
            toZigbee_1.default.thermostat_local_temperature, toZigbee_1.default.thermostat_keypad_lockout, tzLocal.bosch_thermostat, tzLocal.bosch_userInterface],
        exposes: [
            e.climate()
