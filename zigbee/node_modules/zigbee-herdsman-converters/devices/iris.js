...
const definitions = [
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.activePower(endpoint); // Power reports in 0.1W
        },
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.bind(endpoint1, coordinatorEndpoint, ['genOnOff', 'genPowerCfg', 'genPollCtrl']);
            await reporting_1.default.batteryVoltage(endpoint1);
            ...
            await reporting_1.default.bind(endpoint3, coordinatorEndpoint, ['genOnOff']);
            const endpoint4 = device.getEndpoint(4);
            await reporting_1.default.bind(endpoint4, coordinatorEndpoint, ['genOnOff']);
        },
    },
    {
        zigbeeModel: ['3460-L'],
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['msTemperatureMeasurement', 'msRelativeHumidity']);
            await reporting_1.default.temperature(endpoint);
            await reporting_1.default.humidity(endpoint);
        },
    },
    {
        zigbeeModel: ['HT8-ZB'],
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
            await reporting_1.default.bind(endpoint, coordinatorEndpoint, ['genOnOff', 'genPowerCfg']);
            await reporting_1.default.batteryVoltage(endpoint);
        },
