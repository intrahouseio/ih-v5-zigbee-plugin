...
const kmpcilOptions = {
    presence_timeout_dc: () => {
        return e.numeric('presence_timeout_dc', ea.STATE).withValueMin(60).withDescription('Time in seconds after which presence is cleared after detecting it (default 60 seconds) while in DC.');
    },
    presence_timeout_battery: () => {
        return e.numeric('presence_timeout_battery', ea.STATE).withValueMin(120).withDescription('Time in seconds after which presence is cleared after detecting it (default 420 seconds) while in Battery.');
    },
};
...
const definitions = [
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.temperature, fromZigbee_1.default.humidity, fromZigbee_1.default.pressure, fromZigbee_1.default.illuminance, fromZigbee_1.default.kmpcil_res005_occupancy,
            fromZigbee_1.default.kmpcil_res005_on_off],
