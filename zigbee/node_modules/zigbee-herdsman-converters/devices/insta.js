...
const definitions = [
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            await utils_1.default.sleep(10000); // https://github.com/Koenkk/zigbee-herdsman-converters/issues/2493
            await reporting_1.default.bind(device.getEndpoint(6), coordinatorEndpoint, ['closuresWindowCovering']);
            await reporting_1.default.bind(device.getEndpoint(7), coordinatorEndpoint, ['closuresWindowCovering']);
            await reporting_1.default.currentPositionLiftPercentage(device.getEndpoint(6));
            await reporting_1.default.currentPositionTiltPercentage(device.getEndpoint(6));
