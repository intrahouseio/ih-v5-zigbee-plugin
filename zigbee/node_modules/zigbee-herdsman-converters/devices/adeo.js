...
const definitions = [
    ...
    },
    {
        ...
        vendor: 'ADEO',
        extend: extend_1.default.switch({ exposes: [e.power(), e.energy()], fromZigbee: [fromZigbee_1.default.electrical_measurement, fromZigbee_1.default.metering] }),
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.metering, fromZigbee_1.default.nodon_fil_pilote_mode],
        toZigbee: [toZigbee_1.default.on_off, toZigbee_1.default.nodon_fil_pilote_mode],
        exposes: [
            e.switch(),
            e.power(),
            e.energy(),
