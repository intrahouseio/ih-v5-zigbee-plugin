...
const definitions = [
    {
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
            ...
            await reporting_1.default.instantaneousDemand(endpoint, { min: 5, change: 10 });
            await reporting_1.default.currentSummDelivered(endpoint, { min: 5, change: [0, 10] });
            await endpoint.read('seMetering', ['multiplier', 'divisor']);
        },
        ota: ota_1.default.salus,
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.SP600_power],
        exposes: [e.switch(), e.power(), e.energy()],
        toZigbee: [toZigbee_1.default.on_off],
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(9);
