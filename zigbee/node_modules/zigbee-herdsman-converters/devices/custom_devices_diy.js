...
const fzLocal = {
    ...
    co2: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (msg.data.hasOwnProperty('measuredValue')) {
                ...
                return { co2: (0, utils_1.calibrateAndPrecisionRoundOptions)(co2, options, 'co2') };
            }
        },
    },
    co2_config: {
    ...
    illuminance2: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            return {
                [property1]: (0, utils_1.calibrateAndPrecisionRoundOptions)(illuminance, options, 'illuminance'),
                [property2]: (0, utils_1.calibrateAndPrecisionRoundOptions)(illuminanceLux, options, 'illuminance_lux'),
            };
        },
    },
    pressure2: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            return { [property]: (0, utils_1.calibrateAndPrecisionRoundOptions)(pressure, options, 'pressure') };
        },
    },
    ...
    multi_zig_sw_switch_buttons: {
        ...
        convert: (model, msg, publish, options, meta) => {
            var _a, _b;
            const button = (0, utils_1.getKey)((_b = (_a = model.endpoint) === null || _a === void 0 ? void 0 : _a.call(model, msg.device)) !== null && _b !== void 0 ? _b : {}, msg.endpoint.ID);
    ...
    multi_zig_sw_switch_config: {
        ...
        convert: (model, msg, publish, options, meta) => {
            var _a, _b;
            const channel = (0, utils_1.getKey)((_b = (_a = model.endpoint) === null || _a === void 0 ? void 0 : _a.call(model, msg.device)) !== null && _b !== void 0 ? _b : {}, msg.endpoint.ID);
...
const definitions = [
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.ptvo_multistate_action, legacy.fz.ptvo_switch_buttons, fromZigbee_1.default.ptvo_switch_uart,
            fromZigbee_1.default.ptvo_switch_analog_input, fromZigbee_1.default.brightness, fromZigbee_1.default.ignore_basic_report, fromZigbee_1.default.temperature,
            fzLocal.humidity2, fzLocal.pressure2, fzLocal.illuminance2],
        toZigbee: [toZigbee_1.default.ptvo_switch_trigger, toZigbee_1.default.ptvo_switch_uart, toZigbee_1.default.ptvo_switch_analog_input, toZigbee_1.default.ptvo_switch_light_brightness, toZigbee_1.default.on_off],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.on_off, fromZigbee_1.default.DNCKAT_S00X_buttons],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.temperature, fromZigbee_1.default.humidity, fromZigbee_1.default.illuminance, fromZigbee_1.default.soil_moisture, fromZigbee_1.default.battery, fzLocal.node_config],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.temperature, fromZigbee_1.default.humidity, fromZigbee_1.default.pressure, fromZigbee_1.default.battery],
        toZigbee: [],
        configure: async (device, coordinatorEndpoint, logger) => {
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.temperature, fromZigbee_1.default.soil_moisture, fromZigbee_1.default.battery],
        toZigbee: [],
        configure: async (device, coordinatorEndpoint, logger) => {
            const firstEndpoint = device.getEndpoint(1);
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.soil_moisture, fromZigbee_1.default.battery, fzLocal.node_config],
        toZigbee: [tzLocal.node_config],
        configure: async (device, coordinatorEndpoint, logger) => {
            const firstEndpoint = device.getEndpoint(1);
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.temperature, fromZigbee_1.default.humidity, fromZigbee_1.default.illuminance, fromZigbee_1.default.soil_moisture, fromZigbee_1.default.battery],
        toZigbee: [],
        configure: async (device, coordinatorEndpoint, logger) => {
            const firstEndpoint = device.getEndpoint(1);
            await reporting.bind(firstEndpoint, coordinatorEndpoint, [
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.temperature, fromZigbee_1.default.humidity, fromZigbee_1.default.pressure, fromZigbee_1.default.illuminance, fromZigbee_1.default.battery],
        toZigbee: [],
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
            await reporting.bind(endpoint, coordinatorEndpoint, [
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.temperature, fromZigbee_1.default.humidity, fromZigbee_1.default.illuminance, fzLocal.co2, fzLocal.co2_config,
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.temperature, fromZigbee_1.default.humidity, fzLocal.co2, fzLocal.co2_config, fzLocal.temperature_config,
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.SNZB02_temperature, fromZigbee_1.default.SNZB02_humidity, fromZigbee_1.default.battery, fzLocal.thermostat_config,
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.temperature, fromZigbee_1.default.humidity, fromZigbee_1.default.battery, fromZigbee_1.default.hvac_user_interface],
        toZigbee: [toZigbee_1.default.thermostat_temperature_display_mode],
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
