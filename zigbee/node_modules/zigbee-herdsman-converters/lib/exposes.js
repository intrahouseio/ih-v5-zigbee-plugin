...
exports.options = {
    ...
    expose_pin: () => new Binary(`expose_pin`, exports.access.SET, true, false).withDescription(`Expose pin of this lock in the published payload (default false).`),
...
exports.presets = {
    ...
    // Specific
    ac_frequency: () => new Numeric('ac_frequency', exports.access.STATE).withUnit('Hz').withDescription('Measured electrical AC frequency'),
    ...
    auto_lock: () => new Switch().withState('auto_lock', false, 'Enable/disable auto lock', exports.access.STATE_SET, 'AUTO', 'MANUAL'),
    auto_off: (offTime) => new Binary('auto_off', exports.access.ALL, true, false).withDescription(`Turn the device automatically off when attached device consumes less than 2W for ${offTime} minutes`),
    ...
    away_mode: () => new Switch().withState('away_mode', false, 'Enable/disable away mode', exports.access.STATE_SET),
    ...
    child_lock: () => new Lock().withState('child_lock', 'LOCK', 'UNLOCK', 'Enables/disables physical input on the device', exports.access.STATE_SET),
    co2: () => new Numeric('co2', exports.access.STATE).withUnit('ppm').withDescription('The measured CO2 (carbon dioxide) value'),
    co: () => new Numeric('co', exports.access.STATE).withUnit('ppm').withDescription('The measured CO (carbon monoxide) value'),
    ...
    cpu_temperature: () => new Numeric('cpu_temperature', exports.access.STATE).withUnit('°C').withDescription('Temperature of the CPU'),
    ...
    current_phase_b: () => new Numeric('current_phase_b', exports.access.STATE).withUnit('A').withDescription('Instantaneous measured electrical current on phase B'),
    current_phase_c: () => new Numeric('current_phase_c', exports.access.STATE).withUnit('A').withDescription('Instantaneous measured electrical current on phase C'),
    ...
    eco2: () => new Numeric('eco2', exports.access.STATE).withUnit('ppm').withDescription('Measured eCO2 value'),
    ...
    hcho: () => new Numeric('hcho', exports.access.STATE).withUnit('mg/m³').withDescription('Measured Hcho value'),
    ...
    illuminance_lux: () => new Numeric('illuminance_lux', exports.access.STATE).withUnit('lx').withDescription('Measured illuminance in lux'),
    ...
    led_disabled_night: () => new Binary('led_disabled_night', exports.access.ALL, true, false).withDescription('Enable/disable the LED at night'),
    ...
    min_temperature_limit: () => new Numeric('min_temperature_limit', exports.access.STATE_SET).withUnit('°C').withDescription('Minimum temperature limit for frost protection. Turns the thermostat on regardless of setpoint if the tempreature drops below this.').withValueMin(1).withValueMax(5),
    ...
    pm10: () => new Numeric('pm10', exports.access.STATE).withUnit('µg/m³').withDescription('Measured PM10 (particulate matter) concentration'),
    pm25: () => new Numeric('pm25', exports.access.STATE).withUnit('µg/m³').withDescription('Measured PM2.5 (particulate matter) concentration'),
    ...
    power_on_behavior: (values = ['off', 'previous', 'on']) => new Enum('power_on_behavior', exports.access.ALL, values).withDescription('Controls the behavior when the device is powered on after power loss'),
    ...
    sos: () => new Binary('sos', exports.access.STATE, true, false).withDescription('SOS alarm'),
    ...
    valve_detection: () => new Switch().withState('valve_detection', true, 'Valve detection').setAccess('state', exports.access.STATE_SET),
    ...
    voc: () => new Numeric('voc', exports.access.STATE).withUnit('µg/m³').withDescription('Measured VOC value'),
    voc_index: () => new Numeric('voc_index', exports.access.STATE).withDescription('VOC index'),
    voltage: () => new Numeric('voltage', exports.access.STATE).withUnit('V').withDescription('Measured electrical potential value'),
    voltage_phase_b: () => new Numeric('voltage_phase_b', exports.access.STATE).withUnit('V').withDescription('Measured electrical potential value on phase B'),
    voltage_phase_c: () => new Numeric('voltage_phase_c', exports.access.STATE).withUnit('V').withDescription('Measured electrical potential value on phase C'),
    ...
    window_detection: () => new Switch().withState('window_detection', true, 'Enables/disables window detection on the device', exports.access.STATE_SET),
    ...
    pincode: () => new Composite('pin_code', 'pin_code', exports.access.ALL)
        ...
        .withFeature(new Numeric('pin_code', exports.access.SET).withDescription('Pincode to set, set pincode to null to clear')),
