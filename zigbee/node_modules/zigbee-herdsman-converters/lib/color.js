...
class ColorHSV {
     ...
     */
    rounded(precision) {
        return new ColorHSV(this.hue === null ? null : precisionRound(this.hue, precision), this.saturation === null ? null : precisionRound(this.saturation, precision), this.value === null ? null : precisionRound(this.value, precision));
    }
    /**
     * Convert to object
    ...
    switch (result.color_mode) {
        case 'hs':
            ...
            if (result.color.hasOwnProperty('hue') && result.color.hasOwnProperty('saturation')) {
                ...
                if (colorTargets.includes('color_temp')) {
                    result.color_temp = clampColorTemp(precisionRound(hsv.toMireds(), 0), colorTempMin, colorTempMax, logger);
                }
        ...
        case 'xy':
            ...
            if (result.color.hasOwnProperty('x') && result.color.hasOwnProperty('y')) {
                ...
                if (colorTargets.includes('color_temp')) {
                    result.color_temp = clampColorTemp(precisionRound(xy.toMireds(), 0), colorTempMin, colorTempMax, logger);
                }
