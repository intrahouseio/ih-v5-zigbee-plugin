...
function syncColorState(newState, oldState, endpoint, options, logger) {
    ...
    const result = {};
    const [colorTempMin, colorTempMax] = (0, light_1.findColorTempRange)(endpoint, logger);
    ...
    switch (result.color_mode) {
        case 'hs':
            ...
            if (result.color.hasOwnProperty('hue') && result.color.hasOwnProperty('saturation')) {
                ...
                if (colorTargets.includes('color_temp')) {
                    result.color_temp = (0, light_1.clampColorTemp)((0, utils_1.precisionRound)(hsv.toMireds(), 0), colorTempMin, colorTempMax, logger);
                }
        ...
        case 'xy':
            ...
            if (result.color.hasOwnProperty('x') && result.color.hasOwnProperty('y')) {
                ...
                if (colorTargets.includes('color_temp')) {
                    result.color_temp = (0, light_1.clampColorTemp)((0, utils_1.precisionRound)(xy.toMireds(), 0), colorTempMin, colorTempMax, logger);
                }
