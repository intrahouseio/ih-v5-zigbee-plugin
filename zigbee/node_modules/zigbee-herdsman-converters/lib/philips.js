...
exports.philipsFz = exports.tz = exports.extend = void 0;
...
exports.extend = {
    light_onoff_brightness: (options = {}) => {
        ...
        if (!options.disableHueEffects) {
            ...
            result.exposes = result.exposes.concat([e.enum('effect', ea.SET, ['blink', 'breathe', 'okay', 'channel_change', 'candle', 'finish_effect', 'stop_effect', 'stop_hue_effect'])]);
        }
        return result;
    },
    ...
    light_onoff_brightness_color: (options = {}) => {
        ...
        if (!options.disableHueEffects) {
            result.toZigbee = result.toZigbee.concat([philipsTz.effect]);
            result.exposes = result.exposes.concat([e.enum('effect', ea.SET, [
    ...
    light_onoff_brightness_colortemp_color: (options = {}) => {
        ...
        if (!options.disableHueEffects)
            options.disableEffect = true;
        const result = {
            ...extend_1.default.light_onoff_brightness_colortemp_color({ supportsHueAndSaturation: true, ...options }),
            ota: ota.zigbeeOTA,
            meta: { turnsOffAtBrightness1: true },
        };
        result.toZigbee = result.toZigbee.concat([philipsTz.hue_power_on_behavior, philipsTz.hue_power_on_error]);
    ...
    light_onoff_brightness_colortemp_color_gradient: (options = {}) => {
        ...
        const result = {
            ...extend_1.default.light_onoff_brightness_colortemp_color({ noConfigure: true, ...options }),
            ota: ota.zigbeeOTA,
            meta: { turnsOffAtBrightness1: true },
        };
        ...
        result['fromZigbee'] = result['fromZigbee'].concat([exports.philipsFz.gradient({ reverse: true })]);
        result['configure'] = async (device, coordinatorEndpoint, logger) => {
            await extend_1.default.light_onoff_brightness_colortemp_color(options)
    ...
    effect: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            if (Object.keys(hueEffects).includes(value.toLowerCase())) {
                ...
                return await toZigbee_1.default.effect.convertSet(entity, key, value, meta);
            }
        },
    },
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            if (value === 'off') {
                ...
                if (entity.supportsInputCluster('lightingColorCtrl')) {
                    if (meta.message.hasOwnProperty('hue_power_on_color_temperature') &&
...
const manufacturerOptions = { manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.PHILIPS };
