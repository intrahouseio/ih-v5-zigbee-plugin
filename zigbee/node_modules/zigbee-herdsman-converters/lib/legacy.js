...
exports.moesSwitch = exports.dpValueFromIntValue = exports.dpValueFromBool = exports.dataPoints = exports.dpValueFromEnum = exports.ZMLookups = exports.msLookups = exports.giexWaterValve = exports.thermostatPresets = exports.thermostatSystemModes4 = exports.thermostatSystemModes3 = exports.thermostatSystemModes2 = exports.tuyaHPSCheckingResult = exports.thermostatSystemModes = exports.thermostatControlSequenceOfOperations = exports.toZigbee = exports.tz = exports.fromZigbee = exports.fz = void 0;
...
function logUnexpectedDataPoint(where, msg, dpValue, meta) {
    meta.logger.warn(`zigbee-herdsman-converters:${where}: Received unexpected Tuya DataPoint #${dpValue.dp} from ${meta.device.ieeeAddr} with raw data '${JSON.stringify(dpValue)}': type='${msg.type}', datatype='${getTypeName(dpValue)}', value='${getDataValue(dpValue)}', known DP# usage: ${JSON.stringify(getDataPointNames(dpValue))}`);
}
function logUnexpectedDataType(where, msg, dpValue, meta, expectedDataType) {
    meta.logger.warn(`zigbee-herdsman-converters:${where}: Received Tuya DataPoint #${dpValue.dp} with unexpected datatype from ${meta.device.ieeeAddr} with raw data '${JSON.stringify(dpValue)}': type='${msg.type}', datatype='${getTypeName(dpValue)}' (instead of '${expectedDataType}'), value='${getDataValue(dpValue)}', known DP# usage: ${JSON.stringify(getDataPointNames(dpValue))}`);
}
...
function logDataPoint(where, msg, dpValue, meta) {
    meta.logger.info(`zigbee-herdsman-converters:${where}: Received Tuya DataPoint #${dpValue.dp} from ${meta.device.ieeeAddr} with raw data '${JSON.stringify(dpValue)}': type='${msg.type}', datatype='${getTypeName(dpValue)}', value='${getDataValue(dpValue)}', known DP# usage: ${JSON.stringify(getDataPointNames(dpValue))}`);
}
...
function logUnexpectedDataValue(where, msg, dpValue, meta, valueKind, expectedMinValue = null, expectedMaxValue = null) {
    if (expectedMinValue === null) {
        if (expectedMaxValue === null) {
            meta.logger.warn(`zigbee-herdsman-converters:${where}: Received Tuya DataPoint #${dpValue.dp} with invalid value ${getDataValue(dpValue)} for ${valueKind} from ${meta.device.ieeeAddr}`);
        }
        else {
            meta.logger.warn(`zigbee-herdsman-converters:${where}: Received Tuya DataPoint #${dpValue.dp} with invalid value ${getDataValue(dpValue)} for ${valueKind} from ${meta.device.ieeeAddr} which is higher than the expected maximum of ${expectedMaxValue}`);
        }
    }
    else {
        if (expectedMaxValue === null) {
            meta.logger.warn(`zigbee-herdsman-converters:${where}: Received Tuya DataPoint #${dpValue.dp} with invalid value ${getDataValue(dpValue)} for ${valueKind} from ${meta.device.ieeeAddr} which is lower than the expected minimum of ${expectedMinValue}`);
        }
        else {
            meta.logger.warn(`zigbee-herdsman-converters:${where}: Received Tuya DataPoint #${dpValue.dp} with invalid value ${getDataValue(dpValue)} for ${valueKind} from ${meta.device.ieeeAddr} which is outside the expected range from ${expectedMinValue} to ${expectedMaxValue}`);
        }
    }
}
...
function firstDpValue(msg, meta, converterName) {
    ...
    for (let index = 1; index < dpValues.length; index++) {
        meta.logger.debug(`zigbee-herdsman-converters:${converterName}: Additional DP #${dpValues[index].dp} with data ${JSON.stringify(dpValues[index])} will be ignored! ` +
...
const hasAlreadyProcessedMessage = (msg, model, transaction = null, key = null) => {
    ...
    if (transactionStore[key] === current)
        return true;
...
const fromZigbee1 = {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            for (const dpValue of msg.data.dpValues) {
                ...
                switch (dp) {
                    ...
                    default:
                        meta.logger.debug(`zigbee-herdsman-converters:SA12IZL: NOT RECOGNIZED DP #${dp} with data ${JSON.stringify(dpValue)}`);
                }
            }
            return result;
        },
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            for (const dpValue of msg.data.dpValues) {
                ...
                switch (dp) {
                    ...
                    default:
                        meta.logger.debug(`zigbee-herdsman-converters:Woox Smoke Detector: NOT RECOGNIZED DP #${dp} with data ${JSON.stringify(dpValue)}`);
                }
            }
            return result;
        },
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            switch (dp) {
                ...
                case 101:
                    return { battery: value };
                default:
                    meta.logger.warn(`zigbee-herdsman-converters:WooxR7060: Unrecognized DP #${dp} with data ${JSON.stringify(dpValue)}`);
            }
        },
    },
    hpsz: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            switch (dp) {
                ...
                case dataPoints.HPSZLEDState:
                    ...
                    break;
                default:
                    meta.logger.debug(`zigbee-herdsman-converters:hpsz: NOT RECOGNIZED DP #${dp} with data ${JSON.stringify(dpValue)}`);
            }
            return result;
        },
    },
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            switch (dp) {
                ...
                case dataPoints.x5hFactoryReset: {
                    if (value) {
                        clearTimeout(store_1.default.getValue(msg.endpoint, 'factoryResetTimer'));
                        const timer = setTimeout(() => publish({ factory_reset: 'OFF' }), 60 * 1000);
                        store_1.default.putValue(msg.endpoint, 'factoryResetTimer', timer);
                ...
                case dataPoints.x5hBackplaneBrightness: {
                    ...
                    if (value >= 0 && value <= 3) {
                        store_1.default.putValue(msg.endpoint, 'brightnessState', value);
                    ...
                    const lastValue = store_1.default.getValue(msg.endpoint, 'brightnessState') || 1;
                ...
                case dataPoints.x5hSetTemp: {
                    ...
                    store_1.default.putValue(msg.endpoint, 'currentHeatingSetpoint', setpoint);
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            switch (dp) {
                ...
                case dataPoints.zsHeatingSetpoint:
                    ...
                    if (value > 0 && value < 60)
                        store_1.default.putValue(msg.endpoint, 'current_heating_setpoint', ret.current_heating_setpoint);
                    return ret;
            ...
            for (const dpValue of msg.data.dpValues) {
                ...
                switch (dp) {
                    ...
                    case dataPoints.giexWaterValve.irrigationStartTime:
                        return { [giexWaterValve.irrigationStartTime]: ((_a = modelConverters.time) === null || _a === void 0 ? void 0 : _a.call(modelConverters, value)) || value };
                    case dataPoints.giexWaterValve.irrigationEndTime:
                        return { [giexWaterValve.irrigationEndTime]: ((_b = modelConverters.time) === null || _b === void 0 ? void 0 : _b.call(modelConverters, value)) || value };
    ...
    SmartButton_skip: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (utils.isLegacyEnabled(options)) {
                ...
                return fromZigbee_1.default.command_step.convert(model, msg, publish, options, meta);
            }
        },
    },
    konke_click: {
    ...
    TS0218_click: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (utils.isLegacyEnabled(options)) {
                ...
                return fromZigbee_1.default.command_emergency.convert(model, msg, publish, options, meta);
            }
        },
    },
    xiaomi_on_off_action: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (utils.isLegacyEnabled(options)) {
                ...
                return fromZigbee_1.default.xiaomi_on_off_action.convert(model, msg, publish, options, meta);
            }
        },
    },
    WXKG02LM_click: {
    ...
    WXKG02LM_click_multistate: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            if (fromZigbeeStore[msg.device.ieeeAddr + 'legacy'] === current)
                return;
    ...
    WXKG01LM_click: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (utils.isLegacyEnabled(options)) {
                ...
                const current = msg.meta.zclTransactionSequenceNumber;
                if (fromZigbeeStore[key].transaction === current)
                    return;
    ...
    RM01_on_click: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (utils.isLegacyEnabled(options)) {
                ...
                return fromZigbee_1.default.command_on.convert(model, msg, publish, options, meta);
            }
        },
    },
    RM01_off_click: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (utils.isLegacyEnabled(options)) {
                ...
                return fromZigbee_1.default.command_off.convert(model, msg, publish, options, meta);
            }
        },
    },
    RM01_down_hold: {
    ...
    RM01_stop: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (utils.isLegacyEnabled(options)) {
                ...
                return fromZigbee_1.default.command_stop.convert(model, msg, publish, options, meta);
            }
        },
    },
    xiaomi_multistate_action: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            if (utils.isLegacyEnabled(options)) {
                ...
                return fromZigbee_1.default.xiaomi_multistate_action.convert(model, msg, publish, options, meta);
            }
        },
    },
    E1744_play_pause: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            if (utils.isLegacyEnabled(options)) {
                ...
                return fromZigbee_1.default.command_toggle.convert(model, msg, publish, options, meta);
            }
        },
    },
    E1744_skip: {
    ...
    cmd_move: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            if (utils.isLegacyEnabled(options)) {
                ...
                return fromZigbee_1.default.command_move.convert(model, msg, publish, options, meta);
            }
        },
    },
    cmd_move_with_onoff: {
    ...
    cmd_move_to_level_with_onoff: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (utils.isLegacyEnabled(options)) {
                ...
                return fromZigbee_1.default.command_move_to_level.convert(model, msg, publish, options, meta);
            }
        },
    },
    immax_07046L_arm: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (utils.isLegacyEnabled(options)) {
                ...
                return fromZigbee_1.default.command_arm.convert(model, msg, publish, options, meta);
            }
        },
    },
    KEF1PA_arm: {
    ...
    osram_lightify_switch_cmdMoveHue: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (utils.isLegacyEnabled(options)) {
                ...
                return fromZigbee_1.default.command_move_hue.convert(model, msg, publish, options, meta);
            }
        },
    },
    osram_lightify_switch_cmdMoveToSaturation: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (utils.isLegacyEnabled(options)) {
                ...
                return fromZigbee_1.default.command_move_to_saturation.convert(model, msg, publish, options, meta);
            }
        },
    },
    ...
    osram_lightify_switch_cmdMoveToColorTemp: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (utils.isLegacyEnabled(options)) {
                ...
                return fromZigbee_1.default.command_move_to_color_temp.convert(model, msg, publish, options, meta);
            }
        },
    },
    ...
    osram_lightify_switch_AB371860355_cmdStepColorTemp: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (utils.isLegacyEnabled(options)) {
                ...
                return fromZigbee_1.default.command_step_color_temperature.convert(model, msg, publish, options, meta);
            }
        },
    },
    ...
    insta_scene_click: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (utils.isLegacyEnabled(options)) {
                ...
                return fromZigbee_1.default.command_recall.convert(model, msg, publish, options, meta);
            }
        },
    },
    insta_down_hold: {
    ...
    tint404011_move_to_color_temp: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (utils.isLegacyEnabled(options)) {
                ...
                return fromZigbee_1.default.tint404011_move_to_color_temp.convert(model, msg, publish, options, meta);
            }
        },
    },
    tint404011_move_to_color: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (utils.isLegacyEnabled(options)) {
                ...
                return fromZigbee_1.default.command_move_to_color.convert(model, msg, publish, options, meta);
            }
        },
    },
    ...
    ZYCT202_up_down: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (utils.isLegacyEnabled(options)) {
                ...
                let action = null;
                if (value === 0)
                    action = { 'action': 'up-press', 'action_group': msg.groupID };
                else if (value === 1)
                    action = { 'action': 'down-press', 'action_group': msg.groupID };
    ...
    STS_PRS_251_beeping: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (utils.isLegacyEnabled(options)) {
                ...
                return fromZigbee_1.default.identify.convert(model, msg, publish, options, meta);
            }
        },
    },
    ...
    thermostat_att_report: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            if (typeof state == 'number' && constants_1.default.thermostatRunningStates.hasOwnProperty(state)) {
                // @ts-ignore
                result[postfixWithEndpointName('running_state', msg, model)] = constants_1.default.thermostatRunningStates[state];
            }
    ...
    stelpro_thermostat: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (!utils.isLegacyEnabled(options)) {
                return fromZigbee_1.default.stelpro_thermostat.convert(model, msg, publish, options, meta);
            }
    ...
    viessmann_thermostat_att_report: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (!utils.isLegacyEnabled(options)) {
                return fromZigbee_1.default.viessmann_thermostat.convert(model, msg, publish, options, meta);
            }
            const result = fromZigbee.thermostat_att_report.convert(model, msg, publish, options, meta);
    ...
    eurotronic_thermostat: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (!utils.isLegacyEnabled(options)) {
                return fromZigbee_1.default.eurotronic_thermostat.convert(model, msg, publish, options, meta);
            }
            const result = fromZigbee.thermostat_att_report.convert(model, msg, publish, options, meta);
    ...
    hvac_user_interface: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (!utils.isLegacyEnabled(options)) {
                return fromZigbee_1.default.hvac_user_interface.convert(model, msg, publish, options, meta);
            }
            const result = {};
    ...
    thermostat_weekly_schedule_rsp: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (!utils.isLegacyEnabled(options)) {
                return fromZigbee_1.default.thermostat_weekly_schedule.convert(model, msg, publish, options, meta);
            }
            const result = {};
    ...
    terncy_knob: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (!utils.isLegacyEnabled(options)) {
                return fromZigbee_1.default.terncy_knob.convert(model, msg, publish, options, meta);
            }
        ...
        convert: (model, msg, publish, options, meta) => {
            if (!utils.isLegacyEnabled(options)) {
                if (msg.type === 'commandUpOpen') {
                    return fromZigbee_1.default.command_cover_open.convert(model, msg, publish, options, meta);
                }
                else if (msg.type === 'commandDownClose') {
                    return fromZigbee_1.default.command_cover_close.convert(model, msg, publish, options, meta);
                }
                else if (msg.type === 'commandStop') {
                    return fromZigbee_1.default.command_cover_stop.convert(model, msg, publish, options, meta);
                }
            }
            const lookup = {
                'commandUpOpen': 'open',
    ...
    hue_dimmer_switch: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (!utils.isLegacyEnabled(options)) {
                return fromZigbee_1.default.hue_dimmer_switch.convert(model, msg, publish, options, meta);
            }
            const multiplePressTimeout = options && options.hasOwnProperty('multiple_press_timeout') ?
                options.multiple_press_timeout : 0.25;
            const getPayload = function (button, pressType, pressDuration, pressCounter, brightnessSend, brightnessValue) {
                const payLoad = {};
            ...
            if (button && type) {
                ...
                if (type == 'press') {
                    ...
                    if (fromZigbeeStore[deviceID].delayedTimer && (fromZigbeeStore[deviceID].delayedButton != button)) {
                        ...
                        publish(getPayload(fromZigbeeStore[deviceID].delayedButton, fromZigbeeStore[deviceID].delayedType, 0, fromZigbeeStore[deviceID].delayedCounter, fromZigbeeStore[deviceID].delayedBrightnessSend, fromZigbeeStore[deviceID].brightnessValue));
                    }
                }
                else {
                    ...
                    if (fromZigbeeStore[deviceID].pressType == 'press') {
                        ...
                        const pressDuration = (fromZigbeeStore[deviceID].pressType == 'hold' || fromZigbeeStore[deviceID].pressType == 'hold-release') ?
                            Date.now() - fromZigbeeStore[deviceID].pressStart : 0;
                        return getPayload(button, fromZigbeeStore[deviceID].pressType, pressDuration, null, brightnessSend, fromZigbeeStore[deviceID].brightnessValue);
                    }
                }
            }
            return {};
    ...
    blitzwolf_occupancy_with_timeout: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            return fromZigbee_1.default.occupancy_with_timeout.convert(model, msg, publish, options, meta);
        },
    },
    moes_thermostat: {
        cluster: 'manuSpecificTuya',
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            switch (dp) {
                ...
                default: // DataPoint 17 is unknown
                    meta.logger.warn(`zigbee-herdsman-converters:Moes BHT-002: Unrecognized DP #${dp} with data ${JSON.stringify(dpValue)}`);
            }
        },
    },
    moesS_thermostat: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            switch (dp) {
                ...
                default:
                    meta.logger.debug(`zigbee-herdsman-converters:moesS_thermostat: NOT RECOGNIZED DP #${dp} with data ${JSON.stringify(dpValue)}`);
            }
        },
    },
    tuya_air_quality: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            switch (dp) {
                ...
                case dataPoints.tuyaSahkFormaldehyd:
                    return { formaldehyd: utils.calibrateAndPrecisionRoundOptions(value, options, 'formaldehyd') };
                default:
                    meta.logger.warn(`zigbee-herdsman-converters:TuyaSmartAirBox: Unrecognized DP #${dp} with data ${JSON.stringify(dpValue)}`);
            }
        },
    },
    tuya_CO: {
    ...
    connecte_thermostat: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            switch (dp) {
                ...
                default:
                    meta.logger.warn(`zigbee-herdsman-converters:connecte_thermostat: Unrecognized DP #${dp} with data ${JSON.stringify(dpValue)}`);
            }
        },
    },
    saswell_thermostat: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            switch (dp) {
                ...
                default:
                    meta.logger.warn(`zigbee-herdsman-converters:SaswellThermostat: Unrecognized DP #${dp} with data ${JSON.stringify(dpValue)}`);
            }
        },
    },
    evanell_thermostat: {
    ...
    etop_thermostat: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            const value = getDataValue(dpValue);
            if (dp >= 101 && dp <= 107)
                return; // handled by tuya_thermostat_weekly_schedule
            switch (dp) {
                ...
                case dataPoints.runningState:
                    return { running_state: value ? 'heat' : 'idle' };
                default:
                    meta.logger.warn(`zigbee-herdsman-converters:eTopThermostat: Unrecognized DP #${dp} with data ${JSON.stringify(dpValue)}`);
            }
        },
    },
    tuya_thermostat: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            switch (dp) {
                ...
                default: // The purpose of the dps 17 & 19 is still unknown
                    console.log(`zigbee-herdsman-converters:tuyaThermostat: Unrecognized DP #${dp} with data ${JSON.stringify(dpValue)}`);
            }
        },
    },
    tuya_dimmer: {
    ...
    tm081: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            const value = getDataValue(dpValue);
            if (dp === 1)
                return { contact: value === true ? false : true };
            if (dp === 2)
                return { battery: value };
            else {
            ...
            for (const dpValue of msg.data.dpValues) {
                ...
                switch (dp) {
                    ...
                    case dataPoints.lmsIlluminance:
                        ...
                        break;
                    default:
                        meta.logger.debug(`zigbee-herdsman-converters:ZG204ZL_lms: NOT RECOGNIZED DP #${dp} with data ${JSON.stringify(dpValue)}`);
                }
            }
            return result;
        },
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            switch (dp) {
                ...
                case dataPoints.tthHumidity:
                    return { humidity: utils.calibrateAndPrecisionRoundOptions((value / (['_TZE200_bjawzodf', '_TZE200_zl1kmjqx'].includes(meta.device.manufacturerName) ? 10 : 1)), options, 'humidity') };
        ...
        convert: (() => {
            ...
            return (model, msg, publish, options, meta) => {
                ...
                switch (dp) {
                    ...
                    default:
                        meta.logger.warn(`zigbee-herdsman-converters:tuya_illuminance_sensor: NOT RECOGNIZED ` +
                            `DP #${dp} with data ${JSON.stringify(dpValue)}`);
                }
            };
        })(),
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            switch (dp) {
                ...
                default: // The purpose of the codes 17 & 19 are still unknown
                    meta.logger.warn(`zigbee-herdsman-converters:hy_thermostat: Unrecognized DP #${dp} with data ${JSON.stringify(dpValue)}`);
            }
        },
    },
    neo_nas_pd07: {
                ...
                switch (dp) {
                    ...
                    case dataPoints.coverArrived:
                        { // Arrived at position
                            ...
                            // for a few seconds
                            clearTimeout(store_1.default.getValue(msg.endpoint, 'running_timer'));
                            if (running) {
                                const timer = setTimeout(() => publish({ running: false }), 3 * 1000);
                                store_1.default.putValue(msg.endpoint, 'running_timer', timer);
                            }
                            if (position > 0 && position <= 100) {
    ...
    moes_switch: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            switch (dp) {
                ...
                default:
                    meta.logger.debug(`fromZigbee:moes_switch: NOT RECOGNIZED DP #${dp} with data ${JSON.stringify(dpValue)}`);
                    break;
            }
        },
    },
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            if (dp >= firstDayDpId && dp < firstDayDpId + 7) {
                ...
                return {
                    ...
                    weekly_schedule: {
                        // @ts-ignore
                        days: [constants_1.default.thermostatDayOfWeek[dayOfWeek]],
    ...
    tuya_data_point_dump: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            fs_1.default.appendFile('data/tuya.dump.txt', dataStr, (err) => {
                if (err)
                    throw err;
            });
        },
...
const toZigbee2 = {
            ...
            switch (key) {
                ...
                case 'upper_temp':
                    if (value >= 35 && value <= 95) {
                        ...
                        const setpoint = store_1.default.getValue(entity, 'currentHeatingSetpoint', 20);
    ...
    zs_thermostat_preset_mode: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            if (value == 'boost') {
                ...
                if (value == 'manual') {
                    const temp = store_1.default.getValue(entity, 'current_heating_setpoint');
    ...
    giexWaterValve: {
        ...
        convertSet: async (entity, key, value, meta) => {
            var _a, _b, _c;
            const modelConverters = giexTzModelConverters[(_a = meta.mapped) === null || _a === void 0 ? void 0 : _a.model] || {};
            switch (key) {
                ...
                case giexWaterValve.irrigationTarget: {
                    const mode = (_b = meta.state) === null || _b === void 0 ? void 0 : _b[giexWaterValve.mode];
                    const sanitizedValue = ((_c = modelConverters.irrigationTarget) === null || _c === void 0 ? void 0 : _c.call(modelConverters, value, mode)) || value;
        ...
        convertSet: async (entity, key, value, meta) => {
            switch (key) {
                ...
                case 'current_heating_setpoint':
                    ...
                    break;
                case 'sensor':
                    await sendDataPointEnum(entity, dataPoints.connecteSensorType, 
                    // @ts-ignore
        ...
        convertSet: async (entity, key, value, meta) => {
            switch (key) {
                case 'power_on_behavior':
                    await sendDataPointEnum(entity, dataPoints.moesSwitchPowerOnBehavior, utils.getKey(moesSwitch.powerOnBehavior, value));
                    break;
                case 'indicate_light':
                    await sendDataPointEnum(entity, dataPoints.moesSwitchIndicateLight, utils.getKey(moesSwitch.indicateLight, value));
                    break;
                default:
    ...
    tuya_thermostat_schedule_programming_mode: {
        ...
        convertSet: async (entity, key, value, meta) => {
            const dpId = (key === 'workdays_schedule') ?
                dataPoints.scheduleWorkday :
                dataPoints.scheduleHoliday;
            const payload = [];
            const items = value.split(' ');
        ...
        convertSet: async (entity, key, value, meta) => {
            switch (key) {
                ...
                case 'melody':
                    ...
                    break;
                case 'volume':
                    await sendDataPointEnum(entity, dataPoints.neoVolume, 
                    // @ts-ignore
        ...
        convertSet: async (entity, key, value, meta) => {
            switch (key) {
                ...
                case 'melody':
                    ...
                    break;
                case 'volume':
                    await sendDataPointEnum(entity, dataPoints.neoAOVolume, 
                    // @ts-ignore
        ...
        convertSet: async (entity, key, value, meta) => {
            switch (key) {
                ...
                case 'current_heating_setpoint':
                    ...
                    break;
                case 'sensor_type':
                    await sendDataPointEnum(entity, dataPoints.hySensor, 
                    // @ts-ignore
                    { 'internal': 0, 'external': 1, 'both': 2 }[value]);
                    break;
                case 'power_on_behavior':
                    await sendDataPointEnum(entity, dataPoints.hyPowerOnBehavior, 
                    // @ts-ignore
                ...
                case 'week':
                    ...
                    break;
                case 'system_mode':
                    await sendDataPointEnum(entity, dataPoints.hyMode, 
                    // @ts-ignore
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            if (key == 'white_brightness' || (!separateWhite && (key == 'brightness'))) {
                ...
                if (typeof value === 'string' && isNaN(value)) {
                    ...
                    value = light_1.default.clampColorTemp(Number(value), colorTempMin, colorTempMax, meta.logger);
                }
