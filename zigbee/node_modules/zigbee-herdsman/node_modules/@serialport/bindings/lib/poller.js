...
const os = require('os');
const file = `${process.platform === 'win32' ? 'win' :  (process.platform === 'linux' ? 'linux' : 'darwin')}-${os.arch()}-bindings_${process.versions.modules}.node`.toLocaleLowerCase();
const PollerBindings = require('bindings')(file).Poller
