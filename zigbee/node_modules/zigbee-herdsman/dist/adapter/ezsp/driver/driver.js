...
const debug = {
    error: (0, debug_1.default)('zigbee-herdsman:adapter:ezsp:driver:error'),
    log: (0, debug_1.default)('zigbee-herdsman:adapter:ezsp:driver'),
};
class Driver extends events_1.EventEmitter {
    ...
    async startup(port, serialOpt, nwkOpt, greenPowerGroup) {
        ...
        await this.ezsp.setValue(named_1.EzspValueId.VALUE_MAXIMUM_OUTGOING_TRANSFER_SIZE, 82);
        await this.ezsp.setValue(named_1.EzspValueId.VALUE_MAXIMUM_INCOMING_TRANSFER_SIZE, 82);
