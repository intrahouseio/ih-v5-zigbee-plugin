...
class AdapterBackup {
    constructor(znp, nv, path) {
        this.debug = (0, debug_1.default)("zigbee-herdsman:adapter:zStack:startup:backup");
        this.znp = znp;
        this.nv = nv;
    ...
    async createBackup(ieeeAddressesInDatabase) {
        ...
        try {
            ...
            const missing = oldBackup.devices.filter((d) => d.linkKey && ieeeAddressesInDatabase.includes(`0x${d.ieeeAddress.toString("hex")}`) &&
            ...
            this.debug(`Following devices with link key are missing from new backup but present in old backup and database, ` +
