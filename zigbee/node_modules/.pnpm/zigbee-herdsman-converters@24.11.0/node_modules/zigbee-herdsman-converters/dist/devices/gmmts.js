...
const ticmeterOptionsFRTr = {
    0: {
        descEN: `Refresh rate for static values (those with refresh buttons). Default: ${DEFAULT_POLL_INTERVAL} s`,
...
const ticmeterCustomCluster = {
    ID: 0xff42,
    attributes: {
        contractType: { ID: 0x0000, type: zigbee_herdsman_1.Zcl.DataType.CHAR_STR },
        startEJP: { ID: 0x0001, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
        refreshRate: { ID: 0x0002, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
        tomorowColor: { ID: 0x0003, type: zigbee_herdsman_1.Zcl.DataType.CHAR_STR },
        //
        powerOverrun: { ID: 0x0004, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
        powerOverrunA: { ID: 0x0005, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
        powerOverrunB: { ID: 0x0006, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
        powerOverrunC: { ID: 0x0007, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
        //
        potentialPresence: { ID: 0x0008, type: zigbee_herdsman_1.Zcl.DataType.UINT32 },
        //
        hcHours: { ID: 0x0009, type: zigbee_herdsman_1.Zcl.DataType.CHAR_STR },
        motdetat: { ID: 0x000a, type: zigbee_herdsman_1.Zcl.DataType.CHAR_STR },
        //
        date: { ID: 0x000b, type: zigbee_herdsman_1.Zcl.DataType.UINT64 },
        //
        index1Dist: { ID: 0x000e, type: zigbee_herdsman_1.Zcl.DataType.UINT48 },
        index2Dist: { ID: 0x000f, type: zigbee_herdsman_1.Zcl.DataType.UINT48 },
        index3Dist: { ID: 0x0010, type: zigbee_herdsman_1.Zcl.DataType.UINT48 },
        index4Dist: { ID: 0x0011, type: zigbee_herdsman_1.Zcl.DataType.UINT48 },
        //
        powerMaxYesterday: { ID: 0x0012, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
        powerMaxYesterday1: { ID: 0x0013, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
        powerMaxYesterday2: { ID: 0x0014, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
        powerMaxYesterday3: { ID: 0x0015, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
        //
        powerInjected: { ID: 0x0016, type: zigbee_herdsman_1.Zcl.DataType.UINT32 },
        powerMaxInjected: { ID: 0x0017, type: zigbee_herdsman_1.Zcl.DataType.UINT32 },
        powerMaxInjectedYesterday: { ID: 0x0018, type: zigbee_herdsman_1.Zcl.DataType.UINT32 },
        //
        injectedLoadN: { ID: 0x0019, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
        // biome-ignore lint/style/useNamingConvention: ignored using `--suppress`
        injectedLoadN_1: { ID: 0x001a, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
        //
        startEJP1: { ID: 0x001c, type: zigbee_herdsman_1.Zcl.DataType.UINT64 },
        stopEJP1: { ID: 0x001d, type: zigbee_herdsman_1.Zcl.DataType.UINT64 },
        startEJP2: { ID: 0x001e, type: zigbee_herdsman_1.Zcl.DataType.UINT64 },
        stopEJP2: { ID: 0x001f, type: zigbee_herdsman_1.Zcl.DataType.UINT64 },
        startEJP3: { ID: 0x0020, type: zigbee_herdsman_1.Zcl.DataType.UINT64 },
        stopEJP3: { ID: 0x0021, type: zigbee_herdsman_1.Zcl.DataType.UINT64 },
        //
        shortMsg: { ID: 0x0022, type: zigbee_herdsman_1.Zcl.DataType.CHAR_STR },
        ultraShortMsg: { ID: 0x0023, type: zigbee_herdsman_1.Zcl.DataType.CHAR_STR },
        //
        relays: { ID: 0x0024, type: zigbee_herdsman_1.Zcl.DataType.CHAR_STR },
        //
        currentIndex: { ID: 0x0025, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
        //
        currentTarif: { ID: 0x0039, type: zigbee_herdsman_1.Zcl.DataType.CHAR_STR },
        calendarSupplierDay: { ID: 0x0026, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
        nextSupplierCalendarDay: { ID: 0x0027, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
        calendarDay: { ID: 0x0028, type: zigbee_herdsman_1.Zcl.DataType.CHAR_STR },
        calendarDayPointe: { ID: 0x0029, type: zigbee_herdsman_1.Zcl.DataType.CHAR_STR },
        //
        elecMode: { ID: 0x002a, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
        maxContractPower: { ID: 0x002b, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
        ticMode: { ID: 0x002c, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
        uptime: { ID: 0x002d, type: zigbee_herdsman_1.Zcl.DataType.UINT48 },
        ticVersion: { ID: 0x002e, type: zigbee_herdsman_1.Zcl.DataType.CHAR_STR },
        //
        powerMaxTodayTime: { ID: 0x002f, type: zigbee_herdsman_1.Zcl.DataType.UINT64 },
        powerMaxToday1Time: { ID: 0x0030, type: zigbee_herdsman_1.Zcl.DataType.UINT64 },
        powerMaxToday2Time: { ID: 0x0031, type: zigbee_herdsman_1.Zcl.DataType.UINT64 },
        powerMaxToday3Time: { ID: 0x0032, type: zigbee_herdsman_1.Zcl.DataType.UINT64 },
        //
        powerMaxYesterdayTime: { ID: 0x0033, type: zigbee_herdsman_1.Zcl.DataType.UINT64 },
        powerMaxYesterday1Time: { ID: 0x0034, type: zigbee_herdsman_1.Zcl.DataType.UINT64 },
        powerMaxYesterday2Time: { ID: 0x0035, type: zigbee_herdsman_1.Zcl.DataType.UINT64 },
        powerMaxYesterday3Time: { ID: 0x0036, type: zigbee_herdsman_1.Zcl.DataType.UINT64 },
        //
        powerMaxInjectedTime: { ID: 0x0037, type: zigbee_herdsman_1.Zcl.DataType.UINT64 },
        powerMaxInjectedYesterdayTime: { ID: 0x0038, type: zigbee_herdsman_1.Zcl.DataType.UINT64 },
    },
    commands: {
        refreshRate: {
            ID: 0,
            parameters: [{ name: "refreshRate", type: zigbee_herdsman_1.Zcl.DataType.UINT16 }],
        },
        reboot: {
            ID: 1,
            parameters: [{ name: "seq", type: zigbee_herdsman_1.Zcl.DataType.UINT16 }],
        },
    },
    commandsResponse: {
        refreshRate: {
...
function ticmeterConverter(msg) {
    const result = {};
    ...
    keys.forEach((key) => {
        ...
        if (found) {
            ...
            switch (found.type) {
                case STRING:
                    if (node_buffer_1.Buffer.isBuffer(msg.data[key])) {
            ...
            logger_1.logger.warning(`Key not found: ${key}`, "TICMeter");
        }
    });
    return result;
}
...
function genereateTzLocal() {
    ...
    for (const item of ticmeterDatas) {
        ...
        if (item.type === NUM_RW) {
            tz.convertSet = async (entity, key, value, meta) => {
...
async function poll(endpoint, device) {
    ...
    logger_1.logger.debug(`Polling: ${currentContract} ${currentElec} ${currentTIC} ${currentProducer}`, "TICMeter");
    ...
    const splited = Object.keys(groupedByCluster).map((cluster) => {
        return {
            cluster: cluster,
            attributes: splitTab(groupedByCluster[cluster].map((item) => item.attr), 3),
        };
    });
        ...
        for (const attr of item.attributes) {
            await endpoint
                ...
                if (e.message.includes(`Cannot read properties of undefined (reading 'manufacturerID')`)) {
                    ...
                    logger_1.logger.warning(`Polling Error: ${attr} ${e}`, "TICMeter");
                }
            })
                .then((result) => { });
        }
    ...
    const end = new Date();
    logger_1.logger.debug(`Polling Duration: ${end.getTime() - start.getTime()} ms`, "TICMeter");
}
function initConfig(device, name, value) {
...
exports.definitions = [
    {
        ...
        exposes: (device, options) => {
            ...
            try {
                ...
                logger_1.logger.warning("Exposes: No endpoint", "TICMeter");
            }
                ...
                if (endpoint.clusters[CLUSTER_TIC].attributes !== undefined && endpoint.clusters[CLUSTER_TIC].attributes !== undefined) {
                    ...
                    if (globalStore.getValue(device, "tic_mode") === undefined) {
                        if (attr.ticMode !== undefined && attr.ticMode != null) {
                            logger_1.logger.debug(`Load ticMode: ${attr.ticMode}`, "TICMeter");
                    ...
                    if (globalStore.getValue(device, "elec_mode") === undefined) {
                        if (attr.elecMode !== undefined && attr.elecMode != null) {
                            logger_1.logger.debug(`Load elecMode: ${attr.elecMode}`, "TICMeter");
                    ...
                    if (globalStore.getValue(device, "contract_type") === undefined) {
                        if (attr.contractType !== undefined && attr.contractType != null) {
                            ...
                            if (node_buffer_1.Buffer.isBuffer(string)) {
                                string = string.toString();
                            }
                            logger_1.logger.debug(`Load contractType: ${string}`, "TICMeter");
                            globalStore.putValue(device, "contract_type", string);
                        }
                    }
                    if (attr.powerInjected !== undefined && attr.powerInjected != null) {
                        logger_1.logger.debug(`Load powerInjected: ${attr.powerInjected}`, "TICMeter");
            ...
            ticmeterDatas.forEach((item) => {
                ...
                if (item.contract !== undefined) {
                    ...
                    logger_1.logger.warning(`No contract for ${item.name}`, "TICMeter");
                }
                if (item.elec !== undefined) {
                    ...
                    logger_1.logger.warning(`No elec for ${item.name}`, "TICMeter");
                }
                if (item.tic !== undefined) {
                    ...
                    logger_1.logger.warning(`No tic for ${item.name}`, "TICMeter");
                }
                if (item.prod !== undefined) {
                    ...
                    logger_1.logger.warning(`No producer for ${item.name}`, "TICMeter");
                }
                    ...
                    switch (item.type) {
                        ...
                        case NUM_RW:
                            exposes.push(e
                                ...
                                .withUnit(item.unit)
                                .withValueMin(item.min)
                                .withValueMax(item.max));
                            break;
                    }
                }
            });
            logger_1.logger.debug(`Exposes ${exposes.length} attributes`, "TICMeter");
            if (options.translation != null) {
                switch (options.translation) {
                    ...
                    case TRANSLATION_EN:
                        ...
                        break;
                    default:
                        logger_1.logger.warning(`Unknown translation: ${options.translation}`, "TICMeter");
                }
            }
            return exposes;
        },
        configure: async (device, coordinatorEndpoint) => {
            logger_1.logger.debug("TICMeter: Configure", "TICMeter");
            ...
            logger_1.logger.debug(`Configure: ${TICMode} ${contractType} ${elecMode} ${producer}`, "TICMeter");
            ...
            logger_1.logger.debug(`Configure wanted ${wanted.length}`, "TICMeter");
            ...
            for (const item of wanted) {
                const conf = {
                    attribute: item.attr,
                    change: 1,
                    min: constants_1.repInterval.SECONDS_10,
                    max: constants_1.repInterval.MINUTES_10,
                };
                logger_1.logger.debug(`Configure ${item.name} ${item.clust} ${item.attr} ${conf.min} ${conf.max} ${conf.change}`, "TICMeter");
            ...
            await Promise.allSettled(reportingConfig.map(async (config) => {
                try {
                    ...
                    if (error.message.includes("UNSUPPORTED_ATTRIBUTE")) {
                        ...
                        logger_1.logger.warning(`Configure failed: ${error}`, "TICMeter");
                    }
                }
            }));
        },
        ...
        onEvent: async (type, data, device, options) => {
            ...
            if (data.data) {
                ...
                if (data.data.contractType !== undefined) {
                    // biome-ignore lint/suspicious/noImplicitAnyLet: ignored using `--suppress`
                    let contractType;
                    if (node_buffer_1.Buffer.isBuffer(data.data.contractType)) {
            ...
            if (type === "stop") {
                ...
                const seconds = options?.refresh_rate ? Number(options.refresh_rate) : DEFAULT_POLL_INTERVAL;
